...
> Spec: Sanity System Expansion
> Created: 2025-11-13

## Overview

Define the gameplay, backend, and client features required to deliver the newly designed MythosMUD sanity mechanics, ensuring structured loss/recovery flows, hallucination feedback, and sanitarium failover while meeting security and compliance constraints.

## User Stories

### Investigator Sanity Management

As a MythosMUD player, I want my sanity to respond to encounters, environments, and rituals so that the horror gameplay feels reactive and meaningful.
...
As a player, I want hallucinations and command disruptions to manifest contextually so that low sanity feels immersive without being unfair.
...
1. **Sanity Tracking Service** - Implement authoritative SAN storage, tier thresholds, passive flux scheduler, and liability assignment.
