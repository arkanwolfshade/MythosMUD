...
- Analyze algorithm complexity (jCodemunch `get_symbol_complexity`, `find_hot_paths` are good starting points)
...
2. **Code Review**: Analyze code for performance issues (`find_hot_paths`, `get_symbol_complexity`)
...
- Ported from `.cursor/agents/performance-profiler.md`
