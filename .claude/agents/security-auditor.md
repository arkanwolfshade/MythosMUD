...
- Uses the `mythosmud-coppa-checklist` skill for compliance verification
- Uses the Codacy MCP server for security scanning when available
...
- Ported from `.cursor/agents/security-auditor.md`
- COPPA compliance is treated as critical priority
- Follows security-first development principles from AGENTS.md
