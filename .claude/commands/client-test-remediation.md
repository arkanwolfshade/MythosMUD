---
description: Systematically categorize and fix failing client (React/TypeScript) tests, critical issues first.
---
...
This command can leverage the **Test Suite Analyzer** agent for comprehensive test analysis:
- **Agent**: `.claude/agents/test-analyzer.md`
- **Purpose**: Test coverage analysis, test quality assessment, gap identification
- **When Used**: For client test suite analysis and coverage reporting
...
**AI ACTION**: Examine failing components, identify missing imports/props.

#### Hook Issues

**AI ACTION**: Search hook usage patterns, verify dependency arrays.

#### Testing Library Issues

**AI ACTION**: Examine test files, check query methods and async handling.
...
2. **ANALYZE** - Examine the specific failing test
...
*Ported from `.cursor/commands/client-test-remediation.md`.*
