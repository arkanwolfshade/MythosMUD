---
description: Systematically categorize and fix Python/Ruff and React/ESLint lint errors, critical issues first.
---
...
3. **FIX**: Apply targeted solution using the Edit tool
...
2. **ANALYZE** - Use search tools to find specific remaining errors
...
*Ported from `.cursor/commands/lint-remediation.md` (source file had its content accidentally duplicated top-to-bottom; deduped here).*
