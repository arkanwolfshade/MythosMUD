---
description: Systematically categorize and fix mypy type-checking errors, critical issues first.
---
...
1. **IDENTIFY**: Use jCodemunch (`search_symbols`, `search_text`) or grep to locate the exact issues
...
*Ported from `.cursor/commands/mypy-remediation.md`.*
