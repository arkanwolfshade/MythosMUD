...
- Full rule: [AGENTS.md](../../AGENTS.md) "Architecture guidelines" / "Implementation requirements"
- Terminology: [AGENTS.md](../../AGENTS.md) "Code quality and CI policy" / "Terminology"; user rules: coordinator/agent,
  not master/slave
