...
2. **VERIFY PORTS**: After stopping, verify ports are free with `netstat -an | findstr :54731` and `netstat -an |
...
- Always verify database design changes, and decisions on whether or not to use the database, with me before
...
**NEVER include**: Verbose closing paragraphs like "These changes reflect our commitment..." or "These modifications
