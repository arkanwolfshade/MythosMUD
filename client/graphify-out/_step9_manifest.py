...
_manifest_files = _stamped_manifest_files(_corpus, extract, Path(r"C:\projects\MythosMUD\client\src"))
...
print(
    f"All time: {cost['total_input_tokens']:,} input, {cost['total_output_tokens']:,} output ({len(cost['runs'])} runs)"
)
