...
export const ChatMessage: React.FC<ChatMessageProps> = ({ message, index }) => {
  return (
    <div
      className="message p-3 bg-mythos-terminal-surface border border-mythos-terminal-border rounded transition-all duration-300 hover:border-mythos-terminal-primary/30 hover:shadow-lg animate-fade-in"
