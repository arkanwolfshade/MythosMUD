...
export const TerminalInput = React.forwardRef<HTMLInputElement, TerminalInputProps>(
  (
    ...
    const baseClasses =
      'font-mono text-mythos-terminal-text placeholder-mythos-terminal-text-secondary bg-mythos-terminal-surface border border-mythos-terminal-border rounded transition-eldritch duration-eldritch ease-eldritch focus:outline-hidden focus:ring-2 focus:ring-mythos-terminal-primary focus:border-mythos-terminal-primary focus:animate-eldritch-border';
