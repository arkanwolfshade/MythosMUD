...
-- Generated on: 2025-12-17 15:51:37 UTC
...
\restrict fWKC9qepgd2tfPU5UV39hffZheUzvQrO1JXX9JxHy7Xlg71oCKj2X9OVq2NsfYw
...
ALTER TABLE IF EXISTS public.player_spells ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.lucidity_exposure_state ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.lucidity_cooldowns ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.lucidity_adjustment_log ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.player_spells_id_seq;
...
CREATE TABLE public.lucidity_adjustment_log (
    id integer CONSTRAINT sanity_adjustment_log_id_not_null NOT NULL,
    ...
    reason_code character varying(64) CONSTRAINT sanity_adjustment_log_reason_code_not_null NOT NULL,
...
CREATE TABLE public.lucidity_cooldowns (
    id integer CONSTRAINT sanity_cooldowns_id_not_null NOT NULL,
    player_id uuid CONSTRAINT sanity_cooldowns_player_id_not_null NOT NULL,
    action_code character varying(64) CONSTRAINT sanity_cooldowns_action_code_not_null NOT NULL,
...
CREATE TABLE public.lucidity_exposure_state (
    id integer CONSTRAINT sanity_exposure_state_id_not_null NOT NULL,
    player_id uuid CONSTRAINT sanity_exposure_state_player_id_not_null NOT NULL,
    entity_archetype character varying(128) CONSTRAINT sanity_exposure_state_entity_archetype_not_null NOT NULL,
...
COMMENT ON TABLE public.player_lucidity IS 'Authoritative lucidity state for a single investigator';
...
COMMENT ON COLUMN public.player_lucidity.current_tier IS 'Current lucidity tier (lucid/uneasy/fractured/deranged/catatonic)';
...
--
-- Name: player_spells_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.player_spells_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: player_spells_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.player_spells_id_seq OWNED BY public.player_spells.id;
...
ALTER SEQUENCE public.sanity_adjustment_log_id_seq OWNED BY public.lucidity_adjustment_log.id;
...
ALTER SEQUENCE public.sanity_cooldowns_id_seq OWNED BY public.lucidity_cooldowns.id;
...
ALTER SEQUENCE public.sanity_exposure_state_id_seq OWNED BY public.lucidity_exposure_state.id;
...
--
-- Name: lucidity_adjustment_log id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lucidity_adjustment_log ALTER COLUMN id SET DEFAULT nextval('public.sanity_adjustment_log_id_seq'::regclass);


--
-- Name: lucidity_cooldowns id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lucidity_cooldowns ALTER COLUMN id SET DEFAULT nextval('public.sanity_cooldowns_id_seq'::regclass);


--
-- Name: lucidity_exposure_state id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lucidity_exposure_state ALTER COLUMN id SET DEFAULT nextval('public.sanity_exposure_state_id_seq'::regclass);
...
--
-- Name: player_spells id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.player_spells ALTER COLUMN id SET DEFAULT nextval('public.player_spells_id_seq'::regclass);
...
\unrestrict fWKC9qepgd2tfPU5UV39hffZheUzvQrO1JXX9JxHy7Xlg71oCKj2X9OVq2NsfYw
