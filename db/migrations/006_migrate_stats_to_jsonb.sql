...
SET stats_jsonb = CASE
        WHEN stats IS NULL
        OR stats = '' THEN '{"strength": 50, "dexterity": 50, "constitution": 50, "intelligence": 50, "wisdom": 50, "charisma": 50, "sanity": 100, "occult_knowledge": 0, "fear": 0, "corruption": 0, "cult_affiliation": 0, "current_dp": 100, "position": "standing"}'::jsonb
        WHEN stats::text ~ '^\s*\{' THEN -- Valid JSON object - cast to JSONB
        stats::jsonb
        ELSE -- Invalid JSON - use default
        '{"strength": 50, "dexterity": 50, "constitution": 50, "intelligence": 50, "wisdom": 50, "charisma": 50, "sanity": 100, "occult_knowledge": 0, "fear": 0, "corruption": 0, "cult_affiliation": 0, "current_dp": 100, "position": "standing"}'::jsonb
    END;
...
SET NOT NULL,
    ALTER COLUMN stats_jsonb
SET DEFAULT '{"strength": 50, "dexterity": 50, "constitution": 50, "intelligence": 50, "wisdom": 50, "charisma": 50, "sanity": 100, "occult_knowledge": 0, "fear": 0, "corruption": 0, "cult_affiliation": 0, "current_dp": 100, "position": "standing"}'::jsonb;
