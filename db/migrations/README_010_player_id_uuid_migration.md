...
This migration converts `player_id` from `VARCHAR(255)` to `UUID` type across all tables in the database. This is a **clean cutover** with **no backward compatibility** - all code has been updated to use UUID types exclusively.
