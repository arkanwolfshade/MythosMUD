...
**Existing Tables (21)**:
- ✅ Static tables: calendar_holidays, calendar_npc_schedules, emotes, emote_aliases, zones, subzones, rooms, room_links, aliases
...
**Note**: Existing `players` table has different schema (UUID `id` primary key instead of VARCHAR `player_id`). This needs migration.
...
- ✅ All NPC tables
- ✅ All identity tables
- ✅ All runtime tables including: player_inventories, player_sanity, sanity_adjustment_log, sanity_exposure_state, sanity_cooldowns
- ✅ All item tables
...
- ❌ **MISSING**: players, player_inventories, player_sanity, sanity_adjustment_log, sanity_exposure_state, sanity_cooldowns
