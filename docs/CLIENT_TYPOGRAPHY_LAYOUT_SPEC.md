...
function calculateVerticalLayout(
  ...
  return {
    ...
    command: { x: centerX, y: topMargin + panelSizes.chat.height + panelSizes.gameLog.height + margin * 2,
    ...panelSizes.command },
    roomInfo: { x: centerX, y: topMargin + panelSizes.chat.height + panelSizes.gameLog.height + panelSizes.command.height +
    margin * 3, ...panelSizes.roomInfo },
