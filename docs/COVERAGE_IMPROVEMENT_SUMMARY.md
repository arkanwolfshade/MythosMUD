...
1. **Resolve bcrypt Limitation**:
   ...
   - Use lazy imports in models/__init__.py
...
**Remember**: The test files are high-quality and ready. They just need fresh Python interpreter sessions to run due to bcrypt's PyO3 limitation. This is a known Python ecosystem issue, not a problem with the tests themselves.
