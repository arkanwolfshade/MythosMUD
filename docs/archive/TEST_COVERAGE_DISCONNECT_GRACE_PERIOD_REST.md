...
This document summarizes the test coverage for the disconnect grace period and rest command implementation, ensuring we
meet the 70%/90% coverage targets (normal/critical).
