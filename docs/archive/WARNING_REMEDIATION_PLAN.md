...
1. ✅ `server/tests/test_combat_system.py` - 4 instances
2. ✅ `server/tests/test_player_combat_integration.py` - 1 instance
3. ✅ `server/tests/unit/services/test_player_combat_service.py` - 1 instance
4. ✅ `server/tests/unit/services/test_combat_service.py` - 2 instances
5. ✅ `server/tests/unit/test_combat_auto_progression_system.py` - 3 instances
6. ✅ `server/tests/unit/test_npc_passive_behavior_system.py` - 2 instances
7. ✅ `server/tests/unit/test_health_tracking_system.py` - 2 instances
8. ✅ `server/tests/unit/test_auto_progression_integration.py` - 2 instances
