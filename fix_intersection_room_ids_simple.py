#!/usr/bin/env python3
"""
Fix Intersection Room IDs - Simple Version
Corrects intersection room IDs to proper format: earth_arkham_city_{subzone}_intersection_{streets}
"""
...
def fix_intersection_room_ids():
    ...
    print("=== SIMPLE INTERSECTION ROOM ID FIXER ===\n")
    ...
    for f in rooms:
        try:
            ...
            if room_id.startswith("earth_arkham_city_intersection_"):
                ...
                if subzone_index < len(path_parts):
                    ...
                    # Extract the intersection part (remove the prefix)
