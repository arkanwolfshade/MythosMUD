# Graph Report - MythosMUD  (2026-09-14)

## Corpus Check
- 3406 files · ~3,583,149 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 56234 nodes · 105608 edges · 2376 communities (1817 shown, 559 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 6137 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0f1e30d6`
...
- passive_corruption_flux/config.py
- test_room_utils.py
...
- test_admin_setstat_command_context.py
...
- plane
- _ProfessionStatRequirementsSource
- .get_stat_requirements
- properties
- .get_combat_stats
- .stop_npc_thread
- _ConnectionManagerAPI
...
- test_soft_delete_character_lost_race_does_not_touch_online_players_roster
...
- test_soft_delete_character_already_deleted
...
- test_get_adjacent_rooms_no_exits
...
## Communities (2376 total, 559 thin omitted)

### Community 0 - "ValidationError"
Cohesion: 0.01
Nodes (536): get_10_active_invites(), main(), Get 10 active invite codes from the database., create_validator(), Shared schema validator for room definition files. This module provides JSON…, Check if a room ID follows the unified naming schema. Args: room_id: Room ID to…, Create a schema validator with the specified schema. Args: schema_name: Name of…, Validates room definitions against JSON schema. This validator can be used by… (+528 more)

### Community 1 - "StandardizedErrorResponse"
Cohesion: 0.04
Nodes (60): JSONResponse, post, Request, Receive and log alert webhooks, webhook(), Error handlers package for MythosMUD. This package provides specialized error…, _contains_file_path_in_exception(), _contains_sensitive_exception_pattern() (+52 more)
...
Cohesion: 0.02
Nodes (113): _audit_loot_all(), loot_all_items(), Any, APIRouter, Request, Container loot-all endpoint. Handles the convenience action to transfer all…, Register loot-all endpoint to the router., Loot all eligible items from a container. (+105 more)

### Community 4 - "models/player.py"
Cohesion: 0.01
Nodes (383): get_invite_manager(), InviteManager, AsyncSession, datetime, Request, UUID, Invite management system for MythosMUD. This module handles the invite-only…, Mark an invite as used by a specific user (atomic auth-and-capture). Uses the… (+375 more)

### Community 5 - "command.py"
Cohesion: 0.02
Nodes (136): AliasesCommand, Alias command models for MythosMUD. This module provides command models for…, Command for listing all aliases., CommandType, StrEnum, Valid command types for MythosMUD., ChannelCommand, Channel management command models for MythosMUD. This module provides command… (+128 more)

### Community 6 - "server/dependencies.py"
Cohesion: 0.06
Nodes (69): get_catatonia_registry(), get_chat_service(), get_combat_service(), get_connection_manager(), get_container(), get_exploration_service(), get_level_service(), get_magic_service() (+61 more)

### Community 7 - "NPCCombatIntegrationService"
Cohesion: 0.03
Nodes (87): NPCCombatIntegrationService, ConnectionManager, Return combat messaging integration for room broadcasts (e.g. aggro switches)., Return combat service dependency for integration collaborators., Return NPC data provider dependency for integration collaborators., Handle NPC death and related effects. Args: npc_id: ID of the dead NPC room_id:…, Get the last attacker for an NPC., Clear combat memory for an NPC. (+79 more)
...
Cohesion: 0.02
Nodes (218): AbstractContextManager, _equip_stack_from_inventory_index(), _find_equipped_by_item_id(), find_equipped_item_after_equip(), handle_wearable_container_on_equip(), handle_wearable_container_on_unequip(), normalize_equipped_items(), normalize_inventory_slots() (+210 more)

### Community 10 - "AggressiveMobNPC"
Cohesion: 0.03
Nodes (55): Any, Get list of player IDs currently in the room. Returns: List of player IDs in…, Get list of object IDs currently in the room. Returns: List of object IDs in…, Get list of NPC IDs currently in the room. Returns: List of NPC IDs in the room, Get the total number of occupants in the room. Returns: Total count of players,…, Check if the room has no occupants. Returns: True if the room is empty, False…, Get list of containers in this room. Returns: List of container data…, Convert the room to a dictionary representation. Returns: Dictionary containing… (+47 more)

### Community 11 - "NATSService"
Cohesion: 0.02
Nodes (155): NATSConfig, Any, BaseSettings, field_validator, NATS messaging configuration., Validate TLS file paths exist when TLS is enabled., Validate max payload is reasonable., Validate value is positive. (+147 more)

### Community 12 - "SpellEffects"
Cohesion: 0.02
Nodes (133): NpcIntegrationStringIdPort, NpcLifecycleManagerPort, PlayerPersistenceSpellPort, PlayerServiceHealPort, Protocol, UUID, Shared Protocol types for spell effect modules. Used by basedpyright to type…, Apply healing to a player by id. (+125 more)

### Community 13 - "NPCLifecycleManager"
Cohesion: 0.01
Nodes (258): nats_is_connected(), Return True when nats_service exposes is_connected() and it is true., _attach_combat_service(), _create_npc_services_on_app(), initialize_nats_and_combat_services(), initialize_npc_services(), _legacy_service_bindings(), _load_npc_definitions_and_rules() (+250 more)

### Community 14 - "test_security_validator.py"
Cohesion: 0.01
Nodes (205): Communication command models for MythosMUD. This module provides command models…, Validate mute reason for security using centralized validation., field_validator, Validate character name format., Unit tests for security validation utilities. Tests the security validator…, Test that comprehensive sanitization removes null bytes., Test that comprehensive sanitization removes control characters., Test that comprehensive sanitization normalizes newlines to spaces. (+197 more)

### Community 15 - "Profession"
Cohesion: 0.06
Nodes (43): CharacterNameScreenProps, CreateCharacterPayload, MechanicalEffect, Profession, ProfessionCard(), ProfessionCardProps, StatRequirement, ProfessionSelectionContentProps (+35 more)

### Community 16 - "CombatParticipant"
Cohesion: 0.02
Nodes (201): CombatAction, CombatParticipant, _get_default_damage(), Check if participant is mortally wounded (players only). For players: mortally…, Check if participant can perform voluntary combat actions. Unconscious (DP <=…, Apply damage to this participant and determine resulting death states.…, Get the default damage value from configuration., Represents a combat action. (+193 more)

### Community 17 - "test_websocket_handler_core.py"
Cohesion: 0.02
Nodes (169): ChatMessageHandler, ClientErrorReportMessageHandler, CommandMessageHandler, FollowResponseMessageHandler, MessageHandler, MessageHandlerFactory, PartyInviteResponseMessageHandler, PingMessageHandler (+161 more)
...
### Community 19 - "endpoints.py"
Cohesion: 0.02
Nodes (175): get_current_active_user, IntegrityError, Admin API module for MythosMUD. This module provides administrative API…, Container API endpoints for unified container system. As documented in the…, API module for MythosMUD. This module provides REST API endpoints for the…, Shared FastAPI APIRouter for player endpoints (avoids import cycles with route…, _apply_cors_env_overrides(), _configure_cors() (+167 more)

### Community 20 - "NPCDefinition"
Cohesion: 0.00
Nodes (597): _JSONDict, Random, NPCAttacked, NPCEnteredRoom, NPCListened, NPCTookDamage, Event fired when an NPC enters a room. This event is triggered when an NPC…, Event fired when an NPC attacks a target. This event is triggered when an NPC… (+589 more)

### Community 21 - "ContainerComponent"
Cohesion: 0.02
Nodes (121): ContainerComponent, ContainerFactoryOptions, Any, BaseModel, datetime, field_validator, TypedDict, UUID (+113 more)
...
Cohesion: 0.02
Nodes (164): AliasStorage, Manages player alias storage in JSON files. Each player's aliases are stored in…, List all alias files in the storage directory., handle_cast_command(), handle_learn_command(), handle_spell_command(), handle_spells_command(), handle_stop_command() (+156 more)

### Community 24 - "PlayerRespawnService"
Cohesion: 0.06
Nodes (39): _PlayerCombatClearing, PlayerRespawnService, AsyncSession, datetime, Player, Protocol, UUID, _RandomChoiceSource (+31 more)

### Community 25 - "api/character_creation.py"
Cohesion: 0.01
Nodes (232): _apply_stat_modifiers(), _as_float(), _as_int(), _check_shutdown_status(), _convert_stat_summary_to_stat_summary_model(), create_character_with_stats(), _dispatch_roll_stats(), _execute_create_character() (+224 more)

### Community 26 - "test_combat_event_publisher.py"
Cohesion: 0.03
Nodes (113): CombatEndedEvent, CombatStartedEvent, CombatTargetSwitchEvent, NPCAttackedEvent, NPCDiedEvent, NPCTookDamageEvent, PlayerAttackedEvent, Combat-specific events for the MUD. This module defines combat-related events… (+105 more)

### Community 27 - "HolidayService"
Cohesion: 0.02
Nodes (155): _check_holiday_coverage(), _get_calendar_paths(), _load_and_validate_holidays(), load_document_ids(), main(), parse_args(), _print_errors(), _print_success_message() (+147 more)

### Community 28 - "CombatService"
Cohesion: 0.02
Nodes (85): CombatResult, Result of a combat action., _effective_room_for_melee(), finalize_attack_result(), _melee_location_fail_reason(), process_attack(), UUID, queue_combat_action() (+77 more)

### Community 29 - "MemoryMonitor"
Cohesion: 0.16
Nodes (18): MemoryMonitor, Monitor memory usage and trigger cleanup when needed. This class provides…, Get detailed memory statistics. Returns: dict: Memory statistics including RSS,…, Force garbage collection to free memory., Unit tests for MemoryMonitor., test_force_garbage_collection_runtime_error(), test_get_memory_alerts(), test_get_memory_alerts_error_path() (+10 more)

### Community 30 - "LoggedHTTPException"
Cohesion: 0.01
Nodes (382): CharacterInfo, get_container, _apply_rate_limiting_for_stats_roll(), Apply rate limiting for stats roll operation., handle_container_service_error(), Handle ContainerServiceError with appropriate status codes. Args: e:…, _handle_delirium_respawn_validation_error(), _handle_respawn_validation_error() (+374 more)

### Community 31 - "EventBus"
Cohesion: 0.01
Nodes (203): EventBusMixinBase, Attribute stubs for EventBus mixins (mypy attr-defined). Mirrors…, Attrs/methods provided by EventBus when mixed in., Start the async consumer. Real impl is EventBusLifecycleMixin., Drain the event queue. Real impl is EventBusProcessingMixin., Drop tracked service handlers. Real impl is EventBus., EventBus, EventBusProcessingMixin (+195 more)
...
Cohesion: 0.14
Nodes (23): async_load_zone_configurations(), Async helper to load zone configurations from PostgreSQL database., _empty_zone_load_result(), asyncio, MonkeyPatch, Test process_zone_rows() parses JSON string fields., Test process_subzone_rows() handles empty result., Test async_load_zone_configurations() loads configurations successfully. (+15 more)

### Community 34 - "InventoryMutationGuard"
Cohesion: 0.03
Nodes (88): _AsyncPlayerGuardState, InventoryMutationGuard, _PlayerGuardState, Acquire sync mutation guard., Acquire async mutation guard., Get or create per-player guard state for sync contexts. Uses thread-safe…, Get or create per-player guard state for async contexts. Uses async lock to…, Clean up per-player guard state when no longer needed (sync context). Removes… (+80 more)

### Community 35 - "InventoryCommandFactory"
Cohesion: 0.02
Nodes (139): Unit tests for inventory command factory helper functions. Tests the helper…, Test create_equip_command() with item name and inferred slot., Test create_unequip_command() with slot., Test create_unequip_command() with item name., Test create_inventory_command() creates InventoryCommand., Test create_inventory_command() raises error with args., Test create_pickup_command() with numeric index., Test create_pickup_command() with quantity. (+131 more)
...
Cohesion: 0.01
Nodes (322): close_db(), get_test_database_url(), Get test override database URL., DatabaseManager, _dispose_engine_safely(), ensure_database_directory(), get_database_path(), get_database_url() (+314 more)

### Community 38 - "ConnectionManager"
Cohesion: 0.01
Nodes (128): cleanup_dead_connections_impl(), cleanup_ghost_players_impl(), cleanup_orphaned_data_impl(), force_cleanup_impl(), prune_stale_players_impl(), Any, UUID, Clean up dead connections for a specific player or all players. (+120 more)
...
### Community 40 - "_make_session_context"
Cohesion: 0.13
Nodes (23): _make_session_context(), asyncio, Test get_by_player_and_quest returns mapped instance when found., Test get_by_player_and_quest returns None when not found., Test get_by_player_and_quest accepts UUID for player_id., Test update_state_and_progress updates and commits., Test update_state_and_progress still calls procedure and commit when only…, Test list_active_by_player returns list of mapped active instances. (+15 more)
...
Cohesion: 0.03
Nodes (97): check_connection_health_impl(), ConnectionManager, convert_uuids_to_strings_impl(), get_active_connection_count_impl(), get_connection_count_impl(), get_connection_health_stats_impl(), get_connection_id_from_websocket_impl(), get_dual_connection_stats_impl() (+89 more)

### Community 43 - "AsyncPersistenceLayer"
Cohesion: 0.02
Nodes (125): AsyncPersistenceLayer, datetime, Player, Profession, Room, Unpack, UUID, Set the instance manager for instanced room lookup (instance-first). (+117 more)

### Community 44 - "lifespan_magic.py"
Cohesion: 0.07
Nodes (39): _initialize_magic_service(), initialize_magic_services(), _initialize_mp_regeneration_service(), _initialize_spell_effects(), _initialize_spell_learning_service(), _initialize_spell_registry(), _initialize_spell_repositories(), _initialize_spell_targeting_service() (+31 more)

### Community 45 - "eventHandlers/types.ts"
Cohesion: 0.04
Nodes (91): handleCombatDeath(), handleCombatEnded(), handleCombatStarted(), handleCombatTargetSwitch(), handleNpcAttacked(), handleNpcDied(), handlePlayerAttacked(), eventHandlers (+83 more)

### Community 46 - "test_lifespan_startup.py"
Cohesion: 0.05
Nodes (70): _get_item_prototype_count(), _get_item_prototype_entries(), initialize_chat_service(), initialize_combat_services(), initialize_container_and_legacy_services(), initialize_mythos_time_consumer(), initialize_npc_startup_spawning(), _log_npc_startup_errors() (+62 more)

### Community 47 - "TargetResolutionService"
Cohesion: 0.02
Nodes (112): BaseModel, Target metadata schema for MythosMUD. This module defines Pydantic models for…, Metadata about a target in target resolution. This model represents additional…, TargetMetadata, StrEnum, Target resolution schemas for MythosMUD. This module defines Pydantic models…, Enumeration of possible target types., TargetType (+104 more)

### Community 48 - "GameClientV2.tsx"
Cohesion: 0.04
Nodes (73): formatDelta(), HealthMeter, TIER_METADATA, TierMetadata, IncapacitatedBanner, computeLucidityBar(), formatChange(), LucidityChangeFooter() (+65 more)

### Community 49 - "test_corpse_lifecycle_service.py"
Cohesion: 0.02
Nodes (138): ContainerLockState, StrEnum, Lock state for container instances., CorpseLifecycleService, CorpseNotFoundError, CorpseServiceError, _filter_container_data(), _get_enum_value() (+130 more)

### Community 50 - "test_container_bundles.py"
Cohesion: 0.04
Nodes (89): ChatBundle, Chat bundle: chat service. Depends on Core (config, persistence), Game…, CombatBundle, Combat bundle: player combat, death, respawn, combat service, catatonia,…, Combat-related services., CoreBundle, Core bundle: config, database, tasks, event bus, persistence. First bundle in…, Shutdown core services. (+81 more)
...
Cohesion: 0.02
Nodes (102): Smoke test for command parser., Test basic command parsing., Test command parsing with arguments., Test command parsing with pipes., test_parse_command_basic(), test_parse_command_with_args(), test_parse_command_with_pipes(), command_parser() (+94 more)

### Community 54 - "test_websocket_helpers.py"
Cohesion: 0.04
Nodes (62): check_shutdown_and_reject(), is_client_disconnected_exception(), BaseException, WebSocket, True if the exception indicates the client disconnected (tab close, navigate…, Check if server is shutting down and reject connection if so. Returns True if…, asyncio, LogCaptureFixture (+54 more)

### Community 55 - "BaseCommand"
Cohesion: 0.01
Nodes (227): BaseCommand, BaseModel, Base class for all MythosMUD commands. Provides common validation and security…, Test BaseCommand can be instantiated (though it's abstract)., Test BaseCommand rejects unknown fields (extra='forbid')., Test BaseCommand has correct model configuration., test_base_command_instantiation(), test_base_command_model_config() (+219 more)

### Community 56 - "EldritchIcon.tsx"
Cohesion: 0.04
Nodes (54): EldritchEffectsDemo(), EldritchEffectsDemoProps, mockAlert, ALWAYS_ACTIVE_EFFECTS, effectClass(), EffectOption, ELDRITCH_EFFECT_OPTIONS, hasEffect() (+46 more)

### Community 57 - "server/schemas/__init__.py"
Cohesion: 0.01
Nodes (321): cleanup_admin_sessions(), get_admin_audit_log(), get_admin_sessions(), get, post, Request, Admin session and audit log endpoints under /admin/npc. Split out from…, Get active admin sessions. (+313 more)

### Community 58 - "look_container.py"
Cohesion: 0.03
Nodes (114): _as_map(), _as_map_list(), _as_uuid(), _container_name(), _ContainerPersistence, _extract_container_metadata(), _fetch_container(), _find_container_in_room() (+106 more)
...
Cohesion: 0.03
Nodes (118): Validate basic command requirements. Returns result dict if invalid, None if…, _validate_command_basics(), Test _validate_command_basics function., Test _validate_command_basics returns result for empty command., Test _validate_command_basics returns result for command too long., Test _validate_command_basics returns result for invalid command content., Test _validate_command_basics returns None for valid command., TestValidateCommandBasics (+110 more)

### Community 63 - "MythosTickScheduler"
Cohesion: 0.03
Nodes (87): HolidayResolver, Any, Initialize configuration and set environment variables for legacy compatibility., isolated_chronicle(), asyncio, fixture, Unit tests for TimeBundle container wiring., Calendar components and daypart helpers. (+79 more)

### Community 64 - "test_inventory_helpers.py"
Cohesion: 0.02
Nodes (143): build_container_metadata(), build_equipped_lines(), build_inventory_lines(), filter_non_equipped_inventory(), format_metadata(), get_equipped_item_identifiers(), Any, Display and rendering helpers for inventory commands. (+135 more)

### Community 65 - "SpellEffectType"
Cohesion: 0.05
Nodes (98): BaseModel, StrEnum, Valid target types for spells., Valid range types for spells., Valid effect types for spells., Material component required for casting a spell., SpellEffectType, SpellMaterial (+90 more)

### Community 66 - "test_command_communication.py"
Cohesion: 0.03
Nodes (97): EmoteCommand, LocalCommand, MeCommand, PoseCommand, field_validator, Command for whispering to a specific player., Validate target player name format using centralized validation., Validate message content for security using centralized validation. (+89 more)

### Community 67 - "ui-v2/types.ts"
Cohesion: 0.04
Nodes (87): PanelManager(), PanelManagerProps, minimapBackdropLayout(), MinimapPanelBackdrop(), MinimapInlineBody(), MinimapPanelSection(), MinimapPanelSectionProps, ExpandedPanelBody() (+79 more)

### Community 68 - "combat_service.py"
Cohesion: 0.02
Nodes (121): CombatParticipantType, CombatStatus, Enum, Combat system models for in-memory state management. This module defines the…, Status of a combat instance., Type of combat participant., clear_aggro_for_combat(), Clear all aggro state for this combat (call on combat end). (+113 more)

### Community 69 - ".initialize"
Cohesion: 0.07
...
### Community 72 - "AppConfig"
Cohesion: 0.03
Nodes (71): AppConfig, BaseSettings, model_validator, Composite application configuration model., Composite application configuration. This is the main configuration class that…, Set environment variables for legacy code that reads them directly., ChatConfig, BaseSettings (+63 more)

### Community 73 - "CombatInstance"
Cohesion: 0.03
Nodes (102): CombatInstance, UUID, Represents an active combat instance., Get the participant whose turn it is., Advance to the next round - all participants act each round. In round-based…, Check if combat should end. CRITICAL: Combat should NOT end when a player is…, Get all participants that are not dead (includes mortally wounded players at 0…, Update the last activity tick and datetime. (+94 more)

### Community 74 - "test_player_death_service.py"
Cohesion: 0.02
Nodes (135): PlayerDiedEvent, PlayerDPDecayEvent, Event fired when a mortally wounded player loses DP due to decay. This event is…, Event fired when a player dies (DP <= -10). This event is triggered when a…, PositionState, datetime, Game-related models for MythosMUD. This module contains models specific to the…, Permitted posture states for a character. (+127 more)
...
Cohesion: 0.00
Nodes (661): Managed Task Cleanup Service - Runtime Detection for Memory Threshold…, Memory Lifespan Coordinator - Centralized Periodic Auditing for Orphaned Task…, # TODO: Improve graceful shutdown with early cancellation # pylint:…, get_global_tracked_manager(), Global TrackedTaskManager for Memory Leak Prevention Infrastructure. This…, Access the singleton global TrackedTaskManager for usage across the server.…, Async persistence layer for MythosMUD. This module provides an async version of…, Room-cache loading and RoomCacheLoader test hooks for AsyncPersistenceLayer. (+653 more)
...
Cohesion: 0.03
Nodes (119): handle_admin_command(), _handle_admin_status_command(), _handle_admin_time_command(), Any, Administrative commands for MythosMUD. This module contains the main admin…, Expose current Mythos time metadata, active holidays, and freeze diagnostics., Entry point for general admin commands that expose subcommands like `admin…, Provide contextual status information about the caller's administrative… (+111 more)
...
Cohesion: 0.10
Nodes (35): PassiveLucidityFluxService, FluxServiceConfig, Optional configuration for PassiveLucidityFluxService. All fields have defaults., Passive lucidity flux service package., PassiveFluxContext, Data models for passive lucidity flux., Resolved environmental context for passive flux evaluation., Backward-compatible re-export of passive lucidity flux service. (+27 more)

### Community 82 - "PlayerRespawnEventHandler"
Cohesion: 0.01
Nodes (314): PlayerDPUpdated, PlayerXPAwardEvent, Event fired when a player's DP changes. This event is triggered when a player…, Event published when a player receives XP., PlayerEventHandler, ChatLogger, ConnectionManager, JsonMap (+306 more)
...
Cohesion: 0.04
Nodes (101): _async_callable(), cleanup_dead_websocket_impl(), _close_dead_websocket_if_open(), delegate_connection_cleaner(), delegate_connection_cleaner_sync(), delegate_game_state_provider_sync(), delegate_health_monitor_sync(), delegate_message_broadcaster() (+93 more)
...
### Community 87 - "test_command_factories_exploration.py"
Cohesion: 0.02
...
Cohesion: 0.04
Nodes (99): _begin_seated_rest_countdown(), cancel_rest_countdown(), check_player_in_combat(), _check_rest_location(), _delayed_disconnect_player_intentionally(), _disconnect_player_intentionally(), _execute_rest_flow(), _get_services_from_app() (+91 more)

### Community 89 - "NATSError"
Cohesion: 0.02
Nodes (110): NATSConnectionError, NATSError, NATSHealthCheckError, NATSPublishError, NATSSubscribeError, Exception, NATS-specific exception hierarchy for standardized error handling. This module…, Base exception for all NATS-related errors. (+102 more)
...
Cohesion: 0.04
Nodes (79): broadcast_connection_message_impl(), _build_player_info(), Player, Resolve canonical room ID from player's current_room_id. Args: player: The…, Track when a player connects. Args: player_id: The player's ID player: The…, Broadcast a connection message for a player who is already tracked as online., Populate `corruption_tier_cache` from the player's stored value on connect…, Build or update player info dictionary for connection tracking. Args:… (+71 more)
...
Cohesion: 0.03
Nodes (136): ContainerSourceType, Source type for container instances., ContainerService, Service for managing container operations. Orchestrates open/close, transfer…, MutationDecision, Result of attempting to acquire a guarded mutation context., Unit tests for container models. Tests the ContainerComponent model including…, Test is_unlocked returns False when lock_state is LOCKED. (+128 more)

### Community 95 - "chat_service.py"
Cohesion: 0.05
Nodes (53): ChatEmoteService, ChatLogger, ChatPlayerService, ChatRateLimiter, ChatUserManager, Protocol, Return True if command is a predefined emote alias., Return (self_message, other_message) for a predefined emote command. (+45 more)

### Community 96 - "system_monitoring.py"
Cohesion: 0.03
Nodes (86): AlertResolveResponse, AlertsResponse, CacheMetricsResponse, ConnectionHealthStatsResponse, IntegrityResponse, MemoryAlertsResponse, MemoryLeakMetricsResponse, MemoryStatsResponse (+78 more)

### Community 97 - "WebSocketMessageValidator"
Cohesion: 0.05
Nodes (66): MessageValidationError, Exception, WebSocketInboundMessage, WebSocket message validation for MythosMUD. This module provides comprehensive…, Calculate the maximum nesting depth of a JSON structure. Args: obj: Object to…, Validate that strings in the JSON structure don't exceed length limits. Args:…, Ensure a message carries a recognizable top-level shape. Returns: bool: True if…, Return the first string CSRF token from known keys, or None if absent. (+58 more)

### Community 98 - "CombatAttackHandler"
Cohesion: 0.04
Nodes (79): CombatAttackHandler, _CombatAttackService, UUID, Apply damage to target and check death states. Delegates domain logic to…, Check if room has no_death attribute (tutorial/safe zones)., Apply damage to target and update combat state. Args: combat: Combat instance…, Validate attack and retrieve combat participants. Args: attacker_id: ID of the…, CombatService surface required by CombatAttackHandler. (+71 more)

### Community 99 - "send_system_message"
Cohesion: 0.16
Nodes (17): Send a system message to a player. Args: websocket: The WebSocket connection…, send_system_message(), Test send_system_message sends system message., test_send_system_message(), mock_websocket(), asyncio, fixture, Unit tests for websocket handler system message functions. Tests the system… (+9 more)

### Community 100 - "test_chat_npc_system.py"
Cohesion: 0.03
Nodes (109): Initialize chat service., NPCSpoke, Event fired when an NPC speaks. This event is triggered when an NPC…, _ChatDeliveryService, deliver_fake_npc_whisper(), deliver_npc_room_speech(), deliver_personal_system(), npc_sender_id() (+101 more)

### Community 101 - "cleanse_command.py"
Cohesion: 0.06
Nodes (41): CleanseApp, CleanseAppState, CleanseContainer, CleansePersistence, CleanseRequest, CleanseTargetPlayer, _format_cooldown_message(), handle_cleanse_command() (+33 more)

### Community 102 - "test_movement_service.py"
Cohesion: 0.03
Nodes (89): mock_event_bus(), mock_persistence(), movement_service(), asyncio, fixture, Unit tests for movement service. Tests the MovementService class., Test add_player_to_room() when room is not found., Test add_player_to_room() when player is not found. (+81 more)
...
Cohesion: 0.04
Nodes (90): CombatDPSync, Any, Get persistence layer from application container. Args: player_id: Player ID…, Verify that player DP was successfully saved to database. Args: persistence:…, Log death threshold events based on DP changes. Args: current_dp: New current…, Update player DP and save to database. Args: persistence: Persistence layer…, Synchronously persist player DP to database. This is the actual persistence…, Handles DP synchronization for combat operations. (+82 more)

### Community 106 - "TestScheduleService"
Cohesion: 0.03
Nodes (47): Any, field_validator, Validate schedule entry days are standard English weekday names (Sunday,…, Validate slug-formatted list entries. Args: value: Sequence of strings to…, Ensure the schedule window moves time forward like the Chronology Tablets…, Validate tradition value. Args: value: The tradition string to validate…, Validate season value. Args: value: The season string to validate Returns: str:…, Validate bonus tags format. (+39 more)

### Community 107 - "test_argon2_utils.py"
Cohesion: 0.03
Nodes (89): PasswordHasher, E2eUserSpec, _ensure_player_for_user(), main(), Connection, datetime, UUID, Entry point: run E2E user seed via anyio. (+81 more)

### Community 108 - "ChatMessage"
Cohesion: 0.06
Nodes (64): ChatResult, _append_channel_history(), _authorize_global_sender(), _authorize_system_sender(), ChatPlayerView, ChatSendServices, _load_whisper_participants(), _log_and_store_system_message() (+56 more)

### Community 109 - "NATSSubjectManager"
Cohesion: 0.01
Nodes (189): get_subject_manager_dependency(), Dependency function to inject NATSSubjectManager. Returns: Global…, InvalidPatternError, MissingParameterError, NATSSubjectError, PatternNotFoundError, Exception, Custom exceptions for NATS Subject Manager. This module defines all exception… (+181 more)

### Community 110 - "test_npc_utils.py"
Cohesion: 0.12
Nodes (22): extract_room_id_from_lifecycle_record(), get_zone_key_from_room_id(), Extract zone key from room ID. Args: room_id: The room identifier (stable id or…, Return the latest non-unknown room_id from a lifecycle record's events, if any., Unit tests for NPC utility functions. Tests the utility functions in…, Test get_zone_key_from_room_id() extracts zone key from valid room ID., Test get_zone_key_from_room_id() handles room ID with description., Test get_zone_key_from_room_id() handles Innsmouth room ID. (+14 more)

### Community 111 - "Alias"
Cohesion: 0.03
Nodes (73): Get all aliases for a player., Save aliases for a player., Add or update an alias for a player., Remove an alias for a player., Get a specific alias for a player., Clear all aliases for a player., Get the number of aliases for a player., Validate alias name format. (+65 more)

### Community 112 - "test_inventory_commands.py"
Cohesion: 0.09
...
### Community 113 - "command_service.py"
Cohesion: 0.03
Nodes (141): Command service for MythosMUD. This module provides the main command processing…, handle_global_command(), handle_local_command(), handle_me_command(), handle_pose_command(), handle_reply_command(), handle_say_command(), handle_system_command() (+133 more)

### Community 114 - "is_player_in_login_grace_period"
Cohesion: 0.03
Nodes (123): _as_grace(), cancel_login_grace_period(), _EffectPersistence, get_login_grace_period_remaining(), _grace_period_task(), _GraceApp, _GraceAppState, _GraceContainer (+115 more)
...
### Community 118 - "TransferContainerRequest"
Cohesion: 0.03
Nodes (107): emit_close_container_event(), emit_container_opened_events(), emit_loot_all_event(), emit_transfer_event(), ConnectionManager, UUID, WebSocket event emission helpers for container API endpoints. This module…, Emit WebSocket event for container closing. Args: connection_manager:… (+99 more)

### Community 119 - "PlayerPositionService"
Cohesion: 0.03
Nodes (93): _get_position_command_services(), handle_lie_command(), _handle_position_change(), handle_sit_command(), handle_stand_command(), Request, Command handlers for posture adjustments within MythosMUD. According to…, Handle /stand command. (+85 more)

### Community 120 - "handle_transfer_items_exceptions"
Cohesion: 0.02
...
### Community 121 - "RoomService"
Cohesion: 0.02
Nodes (164): _apply_room_exit_to_memory(), _apply_room_properties_to_memory(), _build_exit_attributes(), create_room_exit(), _create_room_link_in_db(), delete_room_exit(), _delete_room_link_in_db(), _invalidate_room_cache() (+156 more)
...
### Community 123 - "npc_service/__init__.py"
Cohesion: 0.04
Nodes (52): NPCDefinitionCRUDMixin, Any, AsyncSession, NPC definition CRUD operations for NPCService., Execute create_npc_definition stored procedure and return the created…, Validate create_npc_definition parameters. Raises ValueError if invalid., Log successful NPC definition creation., Validate NPC update parameters. (+44 more)
...
Cohesion: 0.03
Nodes (105): ContainerLookArgs, _find_container_in_room_or_equipped(), _find_container_via_inner_container(), _get_container_description(), _handle_container_look(), CommandResponse, NamedTuple, Find container via inner_container_id from item. (+97 more)

### Community 128 - "test_look_player.py"
Cohesion: 0.03
Nodes (97): _apply_grace_period_labels(), _find_matching_players(), _format_player_look_display(), _get_players_in_room(), _handle_player_look(), _player_id_uuid(), Any, UUID (+89 more)

### Community 129 - "PlayerCombatService"
Cohesion: 0.02
Nodes (125): Set the player combat service for the connection manager., Initialize the combat service., PlayerCombatService, PlayerCombatState, UUID, Attach NPC combat integration for UUID/XP mapping (post-construction wiring)., Track a player's combat state. Args: player_id: ID of the player player_name:…, Get a player's combat state. Args: player_id: ID of the player Returns:… (+117 more)
...
Cohesion: 0.04
Nodes (33): asyncio, Test _check_grace_period_block returns None when no connection manager., Test _check_grace_period_block returns None when not in grace period., Test _prepare_command_for_processing returns rate limit result., Test _prepare_command_for_processing returns validation result., Test helper functions in command_handler_unified., Test _prepare_command_for_processing successfully prepares command., Test _check_casting_state allows stop, interrupt, status during casting. (+25 more)
...
Cohesion: 0.04
Nodes (111): add_damage_threat(), add_heal_threat(), _aggression_scale(), apply_stealth_wipe(), apply_taunt(), _corruption_scale(), _get_aggro_config(), get_npc_current_target() (+103 more)
...
Cohesion: 0.05
Nodes (60): asyncio, Unit tests for WebSocket handler validation, rate limiting, and error paths.…, _validate_message should pass expected token from connection metadata into…, When metadata.token is missing, validate JWT from message and restore metadata., Test _send_error_response handles WebSocket disconnect., Test _send_error_response handles RuntimeError with disconnect message., Test _send_error_response handles RuntimeError with close message., Test _send_error_response handles other RuntimeError. (+52 more)
...
Cohesion: 0.10
Nodes (32): FakeHallucinationService, Select which type of fake hallucination to trigger (50/50 chance). Returns:…, Service for generating fake NPC tells and room text overlays. These…, Initialize the fake hallucination service., Log a hallucination trigger for observability (#714). This never reaches the…, send_hallucination_event(), handle_fake_hallucination(), handle_hallucination_triggers() (+24 more)
...
Cohesion: 0.04
Nodes (84): broadcast_global_event_impl(), convert_uuids_to_strings(), mark_player_seen_impl(), _optimize_payload(), Any, _queue_message_if_needed(), Queue message for later delivery if no active connections. Args: player_id: The…, Update final delivery status based on connection results. Args:… (+76 more)

### Community 150 - "api/metrics.py"
Cohesion: 0.13
Nodes (25): _handle_replay_error(), Exception, Metrics API endpoint for monitoring NATS message delivery. Provides metrics…, Handle replay errors and return safe error response. Args: replay_error: The…, Metrics domain schemas: metrics API responses., DLQMessage, DLQReplayDetails, MetricsData (+17 more)
...
Cohesion: 0.08
Nodes (31): Return first set CORS origins env var to reduce CCN in _sanitize., Normalize environment variables so nested configs can parse them reliably., MonkeyPatch, parametrize, Unit tests for config module initialization., A CORS origins env var that already looks like JSON is left untouched., A CORS origins env var of only commas/whitespace parses to nothing and is left…, _sanitize_environment_for_nested_configs is a no-op when no CORS origin env var… (+23 more)
...
Cohesion: 0.06
Nodes (86): force_memory_cleanup(), get_cache_metrics(), get_connection_health_stats(), get_dual_connection_stats(), get_eventbus_metrics(), get_memory_alerts(), get_memory_leak_metrics(), get_memory_stats() (+78 more)

### Community 160 - "admin_teleport_commands.py"
Cohesion: 0.03
Nodes (121): Admin permission validation utilities for MythosMUD. This module provides…, Admin teleport command handlers for MythosMUD. This module provides handlers…, broadcast_teleport_effects(), create_teleport_effect_message(), get_online_player_by_display_name(), notify_player_of_teleport(), Any, Teleport utility functions for admin commands in MythosMUD. This module… (+113 more)

### Community 161 - "FollowService"
Cohesion: 0.01
Nodes (220): Event subscription setup for application startup. Extracted from…, Subscribe to RoomOccupantsRefreshRequested so Occupants panel updates after NPC…, Subscribe to room events for quest triggers and progress (start on enter,…, subscribe_quest_events(), subscribe_room_occupants_refresh(), QuestCompleted, Event requesting that room occupants be broadcast to clients. Used after NPC…, Event fired when a quest instance is completed (rewards applied, state set to… (+212 more)

### Community 162 - "player.ts"
Cohesion: 0.10
Nodes (27): locationIndicatesDeathVoid(), requiredAliveButDeadMessage(), assertLookVisibleInPanels(), lookAndStand(), prepAwForAdminSet(), prepNonAdminForSetAttempt(), runAdminSetWithRecovery(), ADMIN_SET_SUCCESS (+19 more)

### Community 163 - "admin_setstat_support.py"
Cohesion: 0.07
Nodes (37): _args_as_strings(), get_app_or_error(), _optional_str(), _optional_str_or_int(), parse_set_stat_args(), _parse_value_from_args(), Protocol, UUID (+29 more)
...
Cohesion: 0.06
Nodes (47): Persist player after spell mutations., _call_add_item_to_inventory(), _definition_completion_mode_error(), _goal_activity_target(), _goals_met(), _has_collect_n_goals(), _parse_definition(), Any (+39 more)

### Community 166 - "test_combat_schema.py"
Cohesion: 0.11
Nodes (29): Draft7Validator, CombatSchemaValidationError, Exception, Raised when combat data fails schema validation., Validate base_stats combat data against schema. Args: data: Base stats…, Validate behavior_config combat data against schema. Args: data: Behavior…, Validate combat message templates. Args: messages: Combat messages dictionary…, Validate that message templates contain required variables. Args: messages:… (+21 more)

### Community 167 - "errorHandler.ts"
Cohesion: 0.11
Nodes (37): errorMessageFromApiBody(), AuthSessionSetters, persistTokensAndApplySession(), SetBool, SetChars, SetStep, loginFailureMessage(), toCharacterInfoFromLogin() (+29 more)
...
Cohesion: 0.03
Nodes (64): MemoryLeakMetricsCollector, Any, Memory leak metrics collector for MythosMUD. This module provides comprehensive…, Collect event metrics from EventBus. Returns: Dictionary with event metrics, Collect cache metrics from CacheManager. Returns: Dictionary with cache metrics, Collect task metrics from TaskRegistry. Returns: Dictionary with task metrics, Collect NATS subscription metrics from NATSService. Returns: Dictionary with…, Unified metrics collector for memory leak detection. Aggregates metrics from… (+56 more)
...
### Community 175 - "test_nats_service.py"
Cohesion: 0.03
Nodes (96): NATSRequestError, Raised when request/response operations fail., NATSMetrics, Any, NATS-specific metrics collection for monitoring and alerting., Record publish operation metrics., Record subscribe operation metrics., Record batch flush operation metrics. (+88 more)
...
Cohesion: 0.04
Nodes (93): ExplorationService, Any, AsyncSession, UUID, Get room UUID by stable_id (hierarchical room ID). Args: stable_id:…, Mark room as explored using the provided session. Backed by…, Get list of room IDs that a player has explored. Args: player_id: UUID of the…, Check if a player has explored a specific room. Args: player_id: UUID of the… (+85 more)

### Community 179 - "logging_file_setup.py"
Cohesion: 0.03
Nodes (105): Formatter, Logger, Queue, QueueHandler, QueueListener, LoggingConfig, field_validator, Security and logging configuration models. (+97 more)

### Community 180 - "DialogueDefinitionRepository"
Cohesion: 0.05
Nodes (73): create_dialogue_definition(), delete_dialogue_definition(), get_dialogue_definition(), list_dialogue_definitions(), delete, get, post, put (+65 more)

### Community 181 - "item_instance_persistence.py"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (59): _collect_disconnect_keys(), Player, Collect all keys (UUID and string) that need to be removed for player…, mock_connection_manager(), mock_player(), asyncio, fixture, Unit tests for player disconnect handlers. Tests the player disconnect handling… (+51 more)

### Community 186 - "useGameConnectionRefactored.ts"
Cohesion: 0.09
Nodes (27): ADR-0018, ThrowingWebSocket, connectOpenAndRunPingInterval(), defaultOptions, latestWebSocketInstance, { mockResourceManager, fetchSpy, mockedSetInterval, mockedClearInterval }, MockWebSocket, wsConnectionAfterEach() (+19 more)
...
### Community 188 - "StatsGenerator"
Cohesion: 0.08
Nodes (34): generate_random_stats(), Stats, Roll character stats using the specified method. Args: method: Rolling method…, Roll Size using formula: (2D6+6)*5 (range 40-90)., Roll stats using 3d6 method (scaled to 15-90 range)., Roll stats using 4d6 drop lowest method (more generous, scaled to 15-90 range)., Generate stats using a point-buy system (balanced, scaled to 1-100 range)., Generate Stats with random attribute values. Factory function for creating… (+26 more)
...
Cohesion: 0.05
Nodes (52): __getattr__(), Any, Monitoring package for MythosMUD server., Lazy import for modules that require numpy., ExportMetrics, get_performance_monitor(), get_performance_stats(), measure_performance() (+44 more)

### Community 191 - "executeCommand"
Cohesion: 0.10
Nodes (44): prepCoLocatedContexts(), expectWhoListingOnPage(), primeBothForCoLocate(), waitForLookReflected(), executeUnmuteAndWaitForAck(), nudgeStandBothPlayers(), primeBothForCoLocate(), executeUnmuteAndWaitForAck() (+36 more)

### Community 192 - "test_logging_handlers.py"
Cohesion: 0.04
Nodes (68): _PlayerGuidFormatterType, _aggregator_handler_class_for_windows(), AsyncioConnLostWriteFilter, create_aggregator_handler(), _make_exec_for_aggregator(), Any, LogRecord, Path (+60 more)
...
### Community 199 - "PhantomHostileService"
Cohesion: 0.08
Nodes (23): PhantomData, PhantomHostileService, TypedDict, UUID, Return the full data dict for one phantom, or None if it's gone (#625)., Find one of the player's active phantoms by (case-insensitive) name, scoped to…, Remove a phantom hostile from tracking. Args: player_id: Player UUID…, Get list of active phantom IDs for a player. Args: player_id: Player UUID (or… (+15 more)

### Community 200 - "test_lucidity_event_dispatcher.py"
Cohesion: 0.04
Nodes (80): _dispatch_player_event(), _format_liabilities(), LucidityChangeEventExtras, LiabilityStackEntry, UUID, Helpers for broadcasting lucidity-related SSE events., Emit a catatonia state event to the affected player., Send rescue progress/status updates to either participant. (+72 more)
...
Cohesion: 0.05
Nodes (49): GameConfig, BaseSettings, field_validator, Game-specific configuration., Validate combat tick interval., Validate combat timeout., Validate combat XP multiplier., Validate combat alert threshold. (+41 more)
...
### Community 208 - "test_websocket_room_updates.py"
Cohesion: 0.04
Nodes (79): build_room_update_event(), ConnectionManager, Room, Build room update event with room data and occupants (players/npcs for…, get_player_occupants(), _looks_like_player_uuid(), Any, Resolve room by ID, optionally using player's current_room_id as fallback when… (+71 more)

### Community 209 - "AttributeError"
Cohesion: 0.03
Nodes (95): AttributeError, Any, Subscribe to room movement events for occupant broadcasting., Unsubscribe from room movement events., subscribe_to_room_events_impl(), unsubscribe_from_room_events_impl(), asyncio, Unit tests for connection event helpers. Tests the connection_event_helpers… (+87 more)

### Community 210 - "LogAggregator"
Cohesion: 0.07
Nodes (40): LogEntry, aggregate_log_entry(), LogAggregator, LogEntry, LogQueryFilter, Path, Initialize the log aggregator. Args: max_entries: Maximum number of log entries…, Add a log entry to the aggregation system. (+32 more)

### Community 211 - "admin_hallucinate_command.py"
Cohesion: 0.07
Nodes (47): deliver_forced_hallucination(), extract_args(), get_current_lcd_or_error(), HallucinateCommandError, _handle_admin_hallucinate_command(), _log_hallucinate_command(), Exception, Request (+39 more)
...
Cohesion: 0.03
Nodes (144): _DropResolved, _FloorPickupResolved, Protocol, Shared types for inventory command handlers (Lizard: keep main module small)., Narrows room managers for floor drop operations (pickup / get room)., RoomDropManager, add_pickup_to_inventory(), broadcast_room_event() (+136 more)
...
Cohesion: 0.04
Nodes (68): MythosValidationError, Test handle_transfer_items_exceptions returns 400 for ValidationError., Test _parse_command_string handles ValidationError., test_parse_command_string_validation_error(), Unit tests for communication command factories. Tests the…, Test create_me_command() creates MeCommand., Test create_me_command() raises error with no args., Test create_pose_command() creates PoseCommand. (+60 more)
...
### Community 228 - "RoomCacheLoader"
Cohesion: 0.06
Nodes (30): Initialize the async persistence layer. This facade delegates to focused async…, AsyncPersistenceRoomFacade, _AsyncPersistenceRoomFacadeBase, AsyncSession, Delegate to room loader; exposed for unit tests., Delegate to room loader; exposed for unit tests., Delegate to room loader; exposed for unit tests., Attrs provided by AsyncPersistenceLayer when mixed in. (+22 more)

### Community 229 - "CatatoniaRegistry"
Cohesion: 0.04
Nodes (35): Initialize combat services., CatatoniaRegistry, datetime, UUID, Return True if the player is currently registered as catatonic., Return a shallow copy of the current registry for diagnostics., Track players who have entered catatonia and coordinate failover hooks., Return True if we should trigger sanitarium failover for this player (not… (+27 more)
...
### Community 231 - "get_async_session"
Cohesion: 0.05
Nodes (48): add_flavor_text_column(), Add flavor_text column if missing., load_seed_data(), Load all seed data files., main(), Load seed data and verify., normalize_database_url(), Set test override database URL. (+40 more)

### Community 232 - "RoomMapViewer.tsx"
Cohesion: 0.09
Nodes (40): fetchSpy, useMapLayout(), buildRoomListRequest(), FetchRoomListConfig, fetchRoomListData(), parseRoomListResponse(), useRoomMapData(), MapControls() (+32 more)

### Community 233 - "PlayerRoomEventHandler"
Cohesion: 0.08
...
Cohesion: 0.04
Nodes (113): _assemble_health_response(), get_health_status(), Return aggregated health status for monitoring., ConnectionsComponent, DatabaseComponent, HealthComponents, HealthErrorResponse, HealthResponse (+105 more)

### Community 235 - "PlayerRepositoryProtocol"
Cohesion: 0.09
Nodes (23): PlayerRepositoryProtocol, datetime, Player, Protocol, Room, UUID, List all cached rooms., Protocol for player persistence operations. Defines the contract used by… (+15 more)

### Community 236 - "test_mp_regeneration_service.py"
Cohesion: 0.05
Nodes (50): asyncio, Unit tests for MP regeneration service. Tests the MPRegenerationService class…, Test process_tick_regeneration() accumulates fractional MP., Test _get_regen_multiplier() returns 1.0 for standing position., Test _get_regen_multiplier() returns REST multiplier for sitting., Test _get_regen_multiplier() returns enhanced REST multiplier for lying., Test _get_regen_multiplier() defaults to 1.0 when position not specified., Test restore_mp_from_rest() returns error when player not found. (+42 more)

### Community 237 - "ExceptionTracker"
Cohesion: 0.06
Nodes (39): ExceptionContextTrackInput, ExceptionRecord, ExceptionTracker, ExceptionTrackInput, get_exception_tracker(), Any, Exception, TypedDict (+31 more)

### Community 238 - "catalog_commands.py"
Cohesion: 0.06
Nodes (64): _append_admin_rows(), _append_catalog_footer(), _append_player_rows(), _as_catalog_request(), _CatalogApp, _CatalogAppState, _CatalogContainer, _CatalogPersistence (+56 more)

### Community 239 - "DeadLetterQueue"
Cohesion: 0.04
Nodes (70): DeadLetterMessage, DeadLetterQueue, Any, Path, Dead Letter Queue for failed NATS messages. Stores messages that fail after all…, Add failed message to dead letter queue (async version). Args: message: Dead…, Add failed message to dead letter queue (sync version). Args: message: Dead…, Retrieve and remove oldest message from DLQ (async version). Returns: Message… (+62 more)
...
### Community 245 - "asyncio"
Cohesion: 0.18
Nodes (11): asyncio, Test validate_player_name() with empty string., Test apply_lucidity_loss() when player not found., Test apply_corruption() when player not found., Test heal_player() when player not found., Test apply_fear() applies fear., test_apply_corruption_player_not_found(), test_apply_fear() (+3 more)
...
Cohesion: 0.03
Nodes (113): LucidityCooldown, LucidityExposureState, PlayerLucidity, Base, Lucidity tracking models drawn from the Pnakotic Manuscripts., Tracks repeated exposure to particular eldritch archetypes., Cooldown tracker for recovery rituals and hallucination timers., Authoritative lucidity state for a single investigator. (+105 more)

### Community 251 - "fixtures/auth.ts"
Cohesion: 0.06
Nodes (44): RoomSummary, STANDARD_DIRECTIONS, assertCommandChannelReady(), clickWithoutStability(), EnsurePlayableConnectionOptions, isPageConnected(), isPageUsable(), isUsernameLoginVisible() (+36 more)
...
Cohesion: 0.07
Nodes (24): PerformanceStats, Alert, MonitoringDashboard, Any, Get overall system health status. Returns: Current system health status, Get comprehensive monitoring summary. Returns: Complete monitoring summary with…, Evaluate thresholds and record new alerts., Record a custom alert emitted by subsystems. Args: alert_type: Identifier for… (+16 more)

### Community 254 - "combat_taunt.py"
Cohesion: 0.05
Nodes (56): AppWithState, Protocol, Shared Starlette/FastAPI-shaped protocols for combat command modules. Keeps…, Application object with a ``state`` namespace (dynamic attributes)., _apply_taunt_and_maybe_broadcast(), AppWithState, Protocol, UUID (+48 more)
...
### Community 256 - "types/mythosTime.ts"
Cohesion: 0.14
Nodes (23): daypartAccent(), FollowingTarget, formatRemaining(), HeaderBar(), HeaderBarProps, TRADITION_COLORS, useMythosTimeBootstrap(), UseMythosTimeBootstrapParams (+15 more)

### Community 257 - "ErrorType"
Cohesion: 0.03
Nodes (125): ErrorResponseDetailsInput, Pydantic error handler for consistent error processing. This module provides a…, create_standard_error_response(), create_websocket_error_response(), ErrorContextDetail, ErrorMessages, ErrorResponseDetails, ErrorSeverity (+117 more)
...
Cohesion: 0.05
Nodes (35): Wire exploration, movement, follow, and party services., Instance, InstanceManager, Room, UUID, Return template rooms matching instance_template_id., Clone template rooms into instance-scoped rooms with remapped exits., Extract stable_id from room - use room.id if it looks like a full path. (+27 more)

### Community 260 - "quest_service.py"
Cohesion: 0.06
Nodes (53): _apply_holdings(), collect_player_stacks(), _consume_from_equipped(), _consume_from_stack_list(), consume_prototype_from_player(), count_prototype_in_stacks(), _deepcopy_dict_stacks(), _deepcopy_equipped_map() (+45 more)
...
Cohesion: 0.05
Nodes (39): autoprefixer, devDependencies, autoprefixer, cross-env, esbuild, eslint-plugin-jsx-a11y, eslint-plugin-playwright, eslint-plugin-react-hooks (+31 more)
...
Cohesion: 0.08
Nodes (55): parseSelectCharacterResult(), pickString(), postSelectCharacter(), requestDeleteCharacter(), resolveSelectedId(), restoreCharactersOnMount(), CreationCompleteActions, runAfterCharacterCreatedFlow() (+47 more)
...
### Community 269 - "lifecycle_manager.py"
Cohesion: 0.02
Nodes (144): NPCMaintenanceConfig, Any, NPC Configuration for MythosMUD. This module defines configuration settings for…, Configuration for NPC lifecycle maintenance. This class centralizes all timing…, Get the respawn delay for a specific NPC type. Args: npc_type: Type of NPC…, Get a summary of all NPC configuration values. Returns: Dictionary containing…, NPCDied, NPCLeftRoom (+136 more)

### Community 270 - "test_item_catalog.py"
Cohesion: 0.06
Nodes (60): ge, le, Query, get_item_catalog(), Depends, get, Request, Item catalog API: GET /v1/api/item-catalog (+52 more)

### Community 271 - "_prepare_command_for_processing"
Cohesion: 0.04
Nodes (47): clean_command_input(), _is_predefined_emote(), normalize_command(), CommandExecutionRequest, Command Input Utilities for MythosMUD. This module provides utilities for…, Clean and normalize command input by collapsing multiple spaces and stripping…, Normalize command input by removing optional slash prefix. Supports both…, Check if a command is a predefined emote alias. Args: command: The command to… (+39 more)
...
Cohesion: 0.04
Nodes (70): Internal implementation for sending room occupants update. This method is used…, Send room occupants update to players in the room (public API). Preserves…, GameStateProvider, Any, Player, UUID, Get NPC names for multiple NPCs in a batch operation. Args: npc_ids: List of…, Get player name and add grace period indicators if applicable. (+62 more)
...
### Community 284 - "room_service.py"
Cohesion: 0.05
Nodes (60): RoomDictList, _append_room_with_fallback_coords_if_needed(), _apply_minimap_fallback_coordinates(), _ensure_current_room_in_minimap_rooms(), generate_minimap_html(), Any, AsyncSession, UUID (+52 more)
...
Cohesion: 0.06
Nodes (35): ActiveLucidityService, AsyncSession, datetime, Handle active lucidity adjustments such as encounters and recovery actions., Return lucidity dependency for integration collaborators., _EncounterCtx, NPCCombatLucidity, Any (+27 more)
...
### Community 292 - "combat_service_npc.py"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (64): Player, BaseModel, Represents a status effect applied to a character., Pydantic Player model for game logic and validation. This is separate from the…, Add an item to the player's inventory. Args: item_id: Unique identifier for the…, Remove an item from the player's inventory. Args: item_id: Unique identifier…, Add a status effect to the player. Args: effect: StatusEffect to add, Remove a status effect from the player. Args: effect_type: Type of effect to… (+56 more)

### Community 296 - "test_npc_combat_handlers.py"
Cohesion: 0.05
Nodes (49): CombatResultCtx, NPCCombatHandlers, Any, Handle NPC death when combat ends, with defensive exception handling. Args:…, Handle NPC death and related effects., Check if a string is a valid UUID., Bundle for handle_combat_result (lizard PARAM)., Handles combat result processing and NPC death operations. (+41 more)

### Community 297 - "asyncio"
Cohesion: 0.15
...
### Community 303 - "admin_summon_command.py"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (47): buildCreateCharacterPayload(), CharacterNameScreen(), getCreateCharacterErrorMessage(), OccupationSlotPayload, PersonalInterestPayload, SkillsPayload, CharacterCard(), CharacterCardDeleteState (+39 more)
...
Cohesion: 0.05
Nodes (65): Any, Convert alias to dictionary for JSON serialization., _AppStateForPlayerService, build_basic_player_data(), convert_schema_to_dict(), _ensure_player_in_room_occupancy(), _fetch_room_for_tracked_player(), get_player_and_room() (+57 more)
...
### Community 314 - "alias_storage.py"
Cohesion: 0.06
Nodes (32): AliasRecord, _AliasValidatorCache, _apply_alias_timestamps(), _as_alias_record(), _parse_alias_timestamp(), datetime, Alias storage utilities for MythosMUD. As noted in the restricted archives of…, Mutable cache for the lazy schema validator (avoids redefining module… (+24 more)
...
Cohesion: 0.01
Nodes (247): PlayerEnteredRoom, PlayerLeftRoom, Event fired when a player enters a room. This event is triggered when a player…, Event fired when a player leaves a room. This event is triggered when a player…, Move followers when the followed player moves., _entity_id_for_quest_offer(), _make_on_npc_died(), _make_on_player_entered() (+239 more)
...
Cohesion: 0.07
Nodes (31): lookup_profile(), Look up flux value from profile by period., _as_float(), _as_str_attr(), FluxRoom, LucidityFluxService, PlayerFluxCtx, _profile_map() (+23 more)
...
### Community 322 - "mock_connection_manager"
Cohesion: 0.67
Nodes (3): mock_connection_manager(), fixture, Create a mock ConnectionManager for testing.

### Community 323 - "event_serialization.py"
Cohesion: 0.05
Nodes (53): ModuleType, _convert_value_for_json(), _convert_value_from_json(), _copy_public_event_attrs(), deserialize_event(), _event_class_from_payload(), _extract_event_fields(), _init_kwargs_from_event_data() (+45 more)
...
Cohesion: 0.04
Nodes (62): command_request_app_state(), CommandExecutionRequest, HTTP Request or WebSocketRequestContext for unified command processing., Return app.state for HTTP Request or WebSocketRequestContext (duck-typed).…, _AppStateCommandGuards, _CastingStateManagerView, _CastingStateView, check_casting_state() (+54 more)
...
### Community 327 - "process_command_unified"
Cohesion: 0.04
Nodes (51): _as_user_dict(), _check_all_command_blocks(), _ensure_alias_storage(), _handle_special_command_routing(), _process_alias_expansion(), process_command(), process_command_unified(), CommandExecutionRequest (+43 more)
...
Cohesion: 0.07
Nodes (46): _process_damage_over_time_effect(), _process_heal_over_time_effect(), _process_single_effect(), Player, Process a single status effect. Returns: Tuple of (updated_effect_dict or None…, Process a damage over time effect. Returns: True if effect was applied, False…, Process a heal over time effect. Returns: True if effect was applied, False…, mock_app() (+38 more)

### Community 331 - "talk_command.py"
Cohesion: 0.05
Nodes (64): npc_definition_id(), Return NPC definition id as string for quest offers/triggers., _emit_prompt(), handle_talk_command(), UUID, talk / talk <n> command for NPC dialogue trees (#583)., Handle talk <npc> or talk <n> against same-room NPCs., Extract player UUID from player model. (+56 more)
...
Cohesion: 0.04
Nodes (58): PlayerOccupantProcessor, Any, UUID, Process players and convert to occupant information. Args: room_id: The room ID…, Processes player occupants for rooms., Initialize player occupant processor. Args: connection_manager:…, Ensure a player is included in the player ID strings list if specified. Args:…, Convert player ID strings to UUIDs for batch loading. Args: player_id_strings:… (+50 more)
...
Cohesion: 0.03
Nodes (77): CombatPersistenceHandler, Any, UUID, Combat persistence handling logic. Handles player DP persistence, verification,…, # NOTE: The game tick loop will also check for dead players, but this provides…, Synchronously persist player DP to database. This is the actual persistence…, Persist player DP to database in background (fire-and-forget). This method runs…, Handles combat-related persistence operations. (+69 more)
...
Cohesion: 0.10
Nodes (36): _handle_admin_set_stat_command(), Handle admin set <stat_name> <target_player> <value>., _assert_stat_write_path(), _async_session_gen(), _make_all_stat_types_harness(), asyncio, Unit tests for admin set stat command handler. Tests the admin set command…, Test successful setting of STR stat. (+28 more)
...
Cohesion: 0.29
Nodes (9): AuthenticatedMapProps, MapViewResolvedProps, renderAuthenticatedMapView(), renderMapPageState(), renderStatusGate(), resolveMapViewProps(), MapPageAuthRequiredView(), MapPageErrorView() (+1 more)

### Community 353 - "map/config.ts"
Cohesion: 0.15
Nodes (17): defaultReactFlowOptions, edgeTypes, getEdgeTypes(), getNodeTypes(), nodeTypes, ExitEdge, ExitEdgeBody(), ExitEdgeLabels() (+9 more)

### Community 354 - "rooms.py"
Cohesion: 0.07
Nodes (45): get_room(), list_rooms(), get, Request, Room management API endpoints for MythosMUD server. This module handles all…, Validate authentication and admin permissions for a room write action., Validate authentication and admin permissions for room position update., Update room position in database and verify the update succeeded. (+37 more)
...
### Community 356 - "test_goto_helpers.py"
Cohesion: 0.13
Nodes (38): log_goto_failure(), Any, Exception, Log failed goto action., Validate app context and get current player with admin permissions. Returns…, Resolve target player (online check and database lookup). Returns…, Validate goto command context and get current player., Resolve target player for goto command. (+30 more)

### Community 357 - "CombatCommandHandler"
Cohesion: 0.04
Nodes (33): CombatCommandHandler, Any, AppWithState, ConnectionManager, Combat service for command modules., Movement service for command modules., Player position service for command modules., Item prototype registry for command modules. (+25 more)
...
Cohesion: 0.09
Nodes (48): get_asyncpg_server_settings_for_database_url(), Build asyncpg ``server_settings`` so unqualified table names resolve like…, CorruptionOverride, A zone/subzone-level override for corruption flux rate and/or target (#815)., _async_load_corruption_overrides(), _CorruptionOverrideLoadResult, _extract_corruption_override(), load_corruption_overrides() (+40 more)
...
### Community 364 - "passive_corruption_flux/config.py"
Cohesion: 0.24
Nodes (8): Configuration for passive corruption flux (#815 PR-5). `period_label`,…, normalize_environment_config(), period_label(), Any, datetime, Configuration and normalization for passive lucidity flux., Return a coarse period label used for environment profiles., Normalize environment config to validated structure.

### Community 365 - "test_room_utils.py"
Cohesion: 0.07
Nodes (41): Unit tests for room_utils. Tests utility functions for room operations., Test get_subzone_local_channel_subject() generates subject., Test get_subzone_local_channel_subject() returns None for invalid room ID., Test extract_subzone_from_room_id() extracts subzone., Test extract_subzone_from_room_id() extracts different subzone., Test extract_subzone_from_room_id() returns None for invalid format., Test get_zone_from_room_id() extracts zone., Test get_zone_from_room_id() extracts different zone. (+33 more)
...
### Community 371 - "map/types.ts"
Cohesion: 0.08
Nodes (29): EdgeCreationModal(), EdgeCreationModalProps, EDGE_EXIT_FLAGS, EDGE_MODAL_MESSAGE_TONE_CLASSES, EdgeCreationModalView(), EdgeCreationModalViewProps, EdgeModalDirectionFieldsProps, EdgeModalValidationMessagesProps (+21 more)
...
### Community 379 - "MessageFilteringHelper"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (47): LucidityAdjustmentLog, Immutable ledger for every lucidity gain or loss event., Unit tests for lucidity models. Tests the PlayerLucidity,…, Test LucidityAdjustmentLog can have optional location_id., Test LucidityAdjustmentLog defaults metadata_payload to '{}'., Test LucidityAdjustmentLog has correct table name., Test LucidityAdjustmentLog __repr__ method., Test LucidityAdjustmentLog can have positive delta (gain). (+39 more)

### Community 381 - "test_websocket_handler_app_state_connection.py"
Cohesion: 0.04
Nodes (82): _cleanup_connection_and_clear_context(), handle_chat_message(), handle_websocket_connection(), UUID, WebSocket, Run connection cleanup and clear the bound logging context together., Handle a WebSocket connection for a player. Args: websocket: The WebSocket…, Handle a chat message from a player. Args: websocket: The WebSocket connection… (+74 more)
...
### Community 384 - "subject_controller.py"
Cohesion: 0.09
...
Cohesion: 0.05
Nodes (43): fixture, rate_limiter(), Unit tests for rate limiting utilities. Tests the simple in-memory rate limiter…, Test get_rate_limit_info returns correct info with requests., Test get_rate_limit_info calculates reset time correctly., Test get_rate_limit_info calculates retry_after correctly., Test get_rate_limit_info filters out old requests., Test enforce_rate_limit allows request within limit. (+35 more)
...
Cohesion: 0.06
Nodes (43): PlayerChannelPreferences, PlayerInventory, Base, Player channel preferences model for Advanced Chat Channels. Stores player…, Player inventory model for persistent storage of items. This matches the…, Unit tests for Player-related SQLAlchemy models. Tests…, Test PlayerInventory has correct table name., Test PlayerInventory __repr__ method. (+35 more)

### Community 391 - "asyncio"
Cohesion: 0.07
Nodes (32): broadcast_global_event_impl(), broadcast_global_impl(), broadcast_room_event_impl(), broadcast_to_room_impl(), disconnect_websocket_connection_impl(), handle_player_entered_room_impl(), Broadcast a message to all players in a room., Broadcast a message to all connected players. (+24 more)

### Community 392 - "CombatValidator"
Cohesion: 0.06
...
### Community 400 - "SecureBaseModel"
Cohesion: 0.02
Nodes (167): EffectHandler, apply_corruption(), apply_fear(), apply_lucidity_loss(), damage_player(), gain_occult_knowledge(), heal_player(), FastAPIRequest (+159 more)

### Community 401 - "SpellLearningService"
Cohesion: 0.10
Nodes (29): Initialize the magic command handler. Args: magic_service: Magic service for…, Any, UUID, Learn a spell for a player., Validate prerequisites for learning a spell. Args: player_id: Player ID spell:…, Service for handling spell learning from various sources. Manages spell…, Learn a spell from a spellbook item. Args: player_id: Player ID…, Learn a spell from an NPC teacher. Args: player_id: Player ID npc_id: ID of the… (+21 more)

### Community 402 - "player_presence_tracker.py"
Cohesion: 0.05
Nodes (72): build_catchup_message(), capture_grace_snapshot(), CatchupManager, CatchupPlayer, _dp_snapshot(), Protocol, UUID, Reconnect catch-up summary for disconnect-grace players (`#297`). While a… (+64 more)
...
Cohesion: 0.05
Nodes (47): NPCCombatDataProvider, Any, UUID, NPC Combat Data Provider. This module provides data retrieval and preparation…, Get player name for messaging. Args: player_id: ID of the player Returns:…, Get the current room ID for a player. Args: player_id: ID of the player (must…, Get player combat participant data from persistence. Args: player_id: ID of the…, Get NPC combat participant data from NPC instance. Args: npc_instance: NPC… (+39 more)

### Community 405 - "websocket_handler.py"
Cohesion: 0.05
Nodes (68): correct_request_context(), Demonstrate correct request context binding., add_request_context(), Background task for player update with enhanced logging., Add request context to all log entries using enhanced logging., update_player_background_task(), get_message_validator(), Get the global message validator instance. (+60 more)

### Community 406 - "_parse_env_list"
Cohesion: 0.06
Nodes (40): _apply_url_fallback(), _default_cors_origins(), _parse_env_list(), _parse_list_from_string(), Any, Parse non-empty string as JSON list or CSV. Used by _parse_env_list., Parse a string from the environment as JSON list or CSV., Derive default CORS origins with environment taking precedence. (+32 more)
...
Cohesion: 0.06
Nodes (28): K, LRUCache, Put an item into the cache. Args: key: The key to store value: The value to…, Delete an item from the cache. Args: key: The key to delete Returns: True if…, Clear all items from the cache., Get the current number of items in the cache., Check if the cache is at maximum capacity., Get cache statistics. Returns: Dictionary containing cache statistics (+20 more)
...
### Community 411 - "monitoring_dashboard.py"
Cohesion: 0.07
Nodes (35): ExceptionStats, Get exception tracking statistics. Returns: Current exception statistics, Reset all exception records., Statistics for exception tracking., Initialize the exception tracker. Args: max_records: Maximum number of…, MonitoringSummary, Comprehensive monitoring dashboard for MythosMUD server. This module provides a…, Represents overall system health status. (+27 more)

### Community 412 - "nats_message_handler.py"
Cohesion: 0.07
Nodes (29): Message filtering utilities for NATS message handler. This module handles room…, NATSMessageHandlerMixinBase, Attrs/methods provided by NATSMessageHandler when mixed in., _not_configured_async(), _ChatMessageFields, NATSMessageProcessingMixin, _optional_str(), TypedDict (+21 more)
...
Cohesion: 0.09
Nodes (30): CorruptionFluxServiceConfig, Optional configuration for PassiveCorruptionFluxService. All fields have…, Passive corruption flux service package (#815 PR-5)., PassiveCorruptionFluxContext, Data models for passive corruption flux (#815 PR-5)., Resolved environmental context for one player's passive corruption flux…, _as_float(), _as_str_attr() (+22 more)

### Community 424 - "quest_commands.py"
Cohesion: 0.11
Nodes (35): _active_npc_ids_in_room(), _emit_npc_lines_for_results(), _format_goal_line(), _format_one_quest_entry(), _format_quest_action_results(), _format_quest_log(), _get_container_and_persistence(), _get_quest_service() (+27 more)

### Community 425 - "NPCCombatMemory"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (30): Return rewards dependency for integration collaborators., NPCCombatRewards, Any, Check if a string is a valid UUID., Manages XP rewards for NPC combat., Initialize the rewards manager. Args: async_persistence: Async persistence…, Calculate XP reward from NPC definition. Args: npc_definition: NPC definition…, Check and log player connection state before operations. Args: player_id: ID of… (+22 more)

### Community 428 - "HealthService"
Cohesion: 0.08
...
Cohesion: 0.09
Nodes (23): Async Persistence Migration Tracker, Current Status, Decision Tree, Files Requiring Migration, Migration Pattern, Migration Strategy, Overview, Phase 1: High Priority (✅ COMPLETE) (+15 more)
...
### Community 450 - "test_magic_healing_events.py"
Cohesion: 0.09
...
Cohesion: 0.12
Nodes (27): _process_single_player_room_flux(), Process passive room corruption flux for a single online player. Args:…, broadcast_tick_event(), Build game_tick event payload (Mythos clock + calendar)., Broadcast game tick event to all connected players., _tick_broadcast_payload(), asyncio, Unit tests for game-tick death, corpse cleanup, broadcast, and loop. (+19 more)

### Community 457 - "test_game_tick_processing.py"
Cohesion: 0.08
Nodes (35): asyncio, Unit tests for game tick processing functions. Tests the game tick processing…, Test _validate_app_state_for_status_effects returns False when no…, Test _validate_app_state_for_status_effects returns True when all required…, Test _validate_app_state_for_status_effects returns False when container is…, Test _validate_app_state_for_status_effects returns False when…, Test get_tick_interval returns tick interval from config., Test _validate_app_state_for_status_effects returns False when no container. (+27 more)
...
Cohesion: 0.15
Nodes (21): ExperienceRepository, Player, UUID, Run update_player_stat_field stored procedure and log success., Update a specific numeric field in player stats atomically. Args: player_id:…, Repository for player experience and stats persistence operations. Handles XP…, Award experience points to a player atomically. Args: player: Player to award…, asyncio (+13 more)
...
### Community 462 - "RealtimeBundle"
Cohesion: 0.08
Nodes (30): Any, BaseException, Attach event publisher and message handler when NATS is available., Initialize real-time services. Requires CoreBundle attributes on container., Shutdown NATS-related services., Real-time communication: NATS, connection manager, event handler., Raise if any core dependency is missing., Raise RuntimeError when e2e requires live NATS; no-op for other environments. (+22 more)
...
Cohesion: 0.05
Nodes (42): Alternative Approaches Considered, Async Audit Executive Summary, Benefit, Break-Even, Contact, Cost, Cost-Benefit Analysis, Critical Findings (+34 more)
...
Cohesion: 0.08
Nodes (38): Shared schemas: base models, target resolution, inventory validation., _build_validator(), InventorySchemaValidationError, Any, Exception, Inventory JSON schema validation utilities. As recorded in the restricted…, Internal helper to construct a Draft7 validator instance., Validate a complete inventory payload against the canonical schema. Raises:… (+30 more)

### Community 480 - "GameMechanicsService"
Cohesion: 0.10
Nodes (26): GameMechanicsService, Gain occult knowledge (with lucidity loss)., Heal a player's health., Damage a player's health., Award experience points to a player. CRITICAL FIX: This method prevents XP…, Service class for game mechanics operations., Initialize the game mechanics service with a persistence layer., Apply lucidity loss to a player. (+18 more)
...
Cohesion: 0.17
Nodes (16): AsciiNoise(), AsciiNoiseProps, prefersReducedMotion(), ChatHistoryMessageBody(), ageBucket(), decayMessageText(), isProtectedToken(), MYTHOS_GLYPHS (+8 more)
...
Cohesion: 0.17
Nodes (28): _attempt_respawn_impl(), _cleanup_respawn_queue(), _process_respawn_queue_entry(), process_respawn_queue_impl(), Any, Respawn queue processing for NPC lifecycle. Extracted from lifecycle_manager to…, Process the respawn queue and spawn NPCs that are ready. Args: manager:…, Process a single respawn queue entry. Returns (should_remove, was_respawned). (+20 more)

### Community 488 - "admin_setstat_command.py"
Cohesion: 0.11
Nodes (35): _apply_corruption_via_service(), _apply_lucidity_via_service(), _apply_stat_change_and_build_result(), _execute_admin_set_stat(), _finish_occult_stat_change(), _get_catatonia_registry_from_app(), _maybe_attach_dp_posture_message(), _mutate_player_stat() (+27 more)
...
Cohesion: 0.08
Nodes (29): Initialize core services. No dependencies., DistributedEventBus, Any, EventBus that distributes domain events via NATS for horizontal scaling. When…, Initialize distributed EventBus. Args: nats_service: NATS service for…, Set NATS service and start the bridge (call after NATS connects)., Publish event locally and to NATS when bridge is active., Shutdown EventBus and stop NATS bridge. (+21 more)
...
Cohesion: 0.04
Nodes (132): _bind_accepted_websocket(), _cleanup_dead_connections(), _cleanup_failed_connection(), establish_websocket_connection(), _EstablishmentConnectionManager, _find_dead_connections(), Player, Protocol (+124 more)
...
Cohesion: 0.17
Nodes (15): parse_zone_special_rules(), Record, TypedDict, Zone Configuration Loader Module. This module handles loading zone and sub-zone…, Build and store one subzone configuration from a database row., Result of loading zone and sub-zone configs from PostgreSQL., Parse a zone special_rules field from the database., _store_subzone_row() (+7 more)
...
### Community 518 - "container_query_helpers_async.py"
Cohesion: 0.14
...
### Community 519 - "PlayerSavePreparer"
Cohesion: 0.13
...
### Community 526 - "PrototypeRegistryError"
Cohesion: 0.05
Nodes (64): _first_normalized_wear_slot(), infer_equip_slot_from_prototype(), _inventory_prototype_id(), prototype_from_registry(), prototype_registry_from_request(), Prototype registry access and equip-slot inference for inventory items., Resolve prototype registry from FastAPI-style request (agent-readable…, Return the prototype object for ``prototype_id``, or None if missing or invalid. (+56 more)

### Community 527 - "test_hallucination_services.py"
Cohesion: 0.08
Nodes (34): _mock_rng(), asyncio, Unit tests for hallucination-related services (fake tells, frequency, phantoms)., Expired cooldown allows roll; trigger sets new cooldown., Lucidity service errors are swallowed and return False., Room entry helper resolves tier and delegates., Time-based helper resolves tier and delegates., Fractured tier uses 15% spawn chance. (+26 more)
...
### Community 542 - "skills_commands.py"
Cohesion: 0.14
...
### Community 543 - "test_npc_combat_integration_service_npc_aggro.py"
Cohesion: 0.08
...
### Community 549 - "CatatoniaObserverProtocol"
Cohesion: 0.10
...
Cohesion: 0.05
Nodes (95): ConnectionMetadata, Data models for connection management. This module defines data structures used…, Metadata for tracking connection details in the WebSocket-only system. This…, _cleanup_old_session_tracking(), _cleanup_player_data_for_session(), _disconnect_all_connections_for_session(), _disconnect_connection_for_session(), handle_new_game_session_impl() (+87 more)

### Community 569 - "waitForMessage"
Cohesion: 0.11
Nodes (44): assertNpcSpawnVisible(), hasCombatMessage(), isInCombatStatus(), isInDeathVoid(), isWardBlockingCombat(), keepFirstCultistInstanceId(), resolveSpawnedCultistTarget(), retryUntilCombatStarted() (+36 more)
...
Cohesion: 0.20
Nodes (10): 1. Overview, 2. Architecture — Phase 1 (`/sleep`), 3. Key design decisions, 4. Constraints, 5. Roadmap — Phase 2: Dreamlands plane, 6. Roadmap — Phase 3: status-effect-driven waking dreams, 7. Related docs, 8. Changelog (+2 more)
...
Cohesion: 0.12
Nodes (24): PrototypeRegistry, Any, Path, ValidationError, Get all invalid entries that failed validation. Returns: list[dict]: List of…, In-memory registry for validated item prototypes., Load prototypes from a directory of JSON files., main() (+16 more)

### Community 580 - "player_effect_repository.py"
Cohesion: 0.11
Nodes (24): _add_effect_params(), AddEffectInput, _int_opt(), _opt_str(), PlayerEffectRepository, Any, TypedDict, UUID (+16 more)
...
### Community 582 - "test_admin_shutdown_command.py"
Cohesion: 0.06
...
### Community 596 - "ScheduleService"
Cohesion: 0.04
Nodes (41): MythosHourTickEvent, Initialize the event with proper type., Initialize the event with proper type., Initialize the event with proper type., Initialize the event with proper type., Initialize the event with proper type., Initialize the event with proper type., Initialize the event with proper type. (+33 more)

### Community 597 - "chat_message.py"
Cohesion: 0.13
Nodes (27): UUID, Chat message model for MythosMUD. This module provides the ChatMessage class…, clear_player_pose(), get_player_pose(), get_room_poses(), normalize_player_id(), Any, UUID (+19 more)
...
### Community 602 - "test_npc_combat_integration_service_player_attacks.py"
Cohesion: 0.09
...
### Community 604 - "format_message_content"
Cohesion: 0.10
Nodes (27): format_message_content(), Message formatting utilities for NATS message handler., Format message content based on channel type and sender name. Args: channel:…, Room broadcast / mute / dampening mixin for NATSMessageHandler. Extracted to…, Unit tests for message formatters. Tests the message_formatters module…, Test format_message_content() formats 'say' channel messages., Test format_message_content() formats 'local' channel messages., Test format_message_content() formats 'global' channel messages. (+19 more)
...
### Community 609 - "NPCOccupantProcessor"
Cohesion: 0.11
...
### Community 619 - "PickupTestWiring"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (27): description, minimum, type, description, minimum, type, type, minimum (+19 more)

### Community 626 - "domPurifyClient.ts"
Cohesion: 0.09
...
### Community 643 - "test_metrics_endpoints.py"
Cohesion: 0.19
Nodes (26): _load_dlq_message(), Load and validate DLQ message data from file (async version using aiofiles).…, Verify user has admin access to metrics. Args: _request: FastAPI request object…, verify_admin_access(), _admin_user(), _plain_user(), asyncio, Path (+18 more)
...
### Community 649 - "correct_patterns.py"
Cohesion: 0.09
...
### Community 659 - "PlayerSpell"
Cohesion: 0.06
Nodes (41): PlayerSpell, Base, Player spell learning and mastery models. This module contains SQLAlchemy…, Model for tracking player spell learning and mastery. This table tracks which…, String representation of PlayerSpell., Base, SQLAlchemy database model for spells table. This module contains the SQLAlchemy…, SQLAlchemy model for the spells table. This is the database representation of… (+33 more)
...
Cohesion: 0.07
Nodes (42): assert_auth_rate_limit_paths_registered(), _auth_bucket(), auth_client_key(), auth_rate_limit_response(), _collect_post_paths(), _HasPrefix, _HasRoutes, _IncludedRouterLike (+34 more)
...
Cohesion: 0.08
Nodes (25): asyncio, Test get_room() returns None when room not found in persistence., Test get_adjacent_rooms() skips null exits., Test get_adjacent_rooms() handles target room not found., Test get_local_chat_scope() returns empty list when source room not found., Test get_room_occupants() handles room dict., Test get_room_occupants() falls back to persistence., Test validate_player_in_room() returns False when player not in room. (+17 more)
...
### Community 698 - "test_npc_startup_service.py"
Cohesion: 0.08
...
Cohesion: 0.16
Nodes (18): can_perform_action(), get_misfire_message(), Check if a command should misfire based on tier and command type. Args:…, Get the misfire message for a failed command. Args: command_type: Type of…, Check if player should involuntarily flee. Args: tier: Current lucidity tier…, Check if player can perform actions (motor lock check). Args: tier: Current…, should_involuntary_flee(), should_misfire_command() (+10 more)

### Community 702 - "session_factory"
Cohesion: 0.25
Nodes (22): Provide an async session factory for integration tests. CRITICAL: This fixture…, session_factory(), player_row(), async_sessionmaker, asyncio, AsyncSession, fixture, UUID (+14 more)
...
### Community 705 - "ChatHistoryPanel.tsx"
Cohesion: 0.05
Nodes (61): ChatHistoryMessageRow(), ChatHistoryPanel(), ChatHistoryPanelProps, classFromTags(), filterChatHistoryMessages(), formatTimestamp(), getMessageClass(), isExcludedFromChatPanel() (+53 more)
...
Cohesion: 0.20
Nodes (10): properties, maximum, minimum, type, minLength, type, month, name (+2 more)
...
### Community 719 - "test_cancel_shutdown_countdown_no_active"
Cohesion: 0.21
...
### Community 723 - "test_combat_integration_base.py"
Cohesion: 0.13
...
### Community 724 - "LucidityRepository"
Cohesion: 0.06
...
### Community 725 - ".get_alias_file_path"
Cohesion: 0.13
Nodes (14): AliasPayload, _as_alias_payload(), _empty_alias_payload(), _get_alias_validator(), Path, Get the file path for a player's aliases. Human: reject path separators /…, Absolute str path for open(); re-checks containment at the open site. Human:…, Load alias data from JSON file. (+6 more)

### Community 726 - "test_lru_cache.py"
Cohesion: 0.10
Nodes (19): Unit tests for LRU cache expiration and eviction. Tests the LRUCache class,…, Test that expired entry count is tracked in cache stats., Test that expiration rate is calculated in stats., Test that cache size stays within bounds after expiration cleanup., Test that expired entries are removed efficiently in bulk., Test cache behavior with mix of expired and valid entries., Test that expired entries are removed before LRU eviction., Test that expired entries are removed before checking if cache is full. (+11 more)
...
### Community 728 - "edgeModalLogic.ts"
Cohesion: 0.21
...
### Community 733 - "CombatMessagingService"
Cohesion: 0.11
Nodes (13): CombatMessages, Any, Lazily resolve the connection manager from the application container., CombatMessagingService, Any, Generate combat start messages for all room occupants. Args: attacker_name:…, Generate combat end messages for all room occupants. Args: winner_name: Name of…, Generate thematic error messages for combat actions. Args: error_type: Type of… (+5 more)
...
Cohesion: 0.09
Nodes (22): minimum, type, additionalProperties, properties, type, maxLength, minLength, type (+14 more)

### Community 744 - "TestGetPlayerServiceForTesting"
Cohesion: 0.33
...
### Community 755 - "spell_effects_status.py"
Cohesion: 0.19
...
### Community 770 - "profession_repository.py"
Cohesion: 0.18
Nodes (20): _bool_or_default(), Any, Profession repository for async persistence operations. This module provides…, Return value as str or a default if falsy., Return text value or default if falsy., Return bool(value) when not None, otherwise default., Map procedure result row to Profession model., _row_to_profession() (+12 more)
...
Cohesion: 0.05
Nodes (88): get_current_tick(), Shared game tick counter. Kept in a leaf module so combat services can read the…, Get the current game tick., Set the current game tick (game tick loop)., Reset the current tick for testing., reset_current_tick(), set_current_tick(), _handle_player_death_threshold() (+80 more)

### Community 797 - "cached"
Cohesion: 0.36
...
Cohesion: 0.10
Nodes (16): CacheService, ProfessionCacheService, Cache service for MythosMUD server. This module provides caching services that…, Service for caching profession data., Invalidate all profession caches., Main cache service that coordinates all caching operations. This service…, Preload frequently accessed data into caches. This method loads commonly used…, Caching module for MythosMUD server. This module provides comprehensive caching… (+8 more)
...
### Community 802 - "stats_generator.py"
Cohesion: 0.11
Nodes (21): Stats Generator Service for MythosMUD. This module provides random stat…, _build_attribute_summary(), build_stat_summary(), _core_stat_values_by_field(), Stats, Stat summary helpers for StatsGenerator (keeps stats_generator under module…, Coerce optional stat ints for summary totals (matches legacy ``or 50``…, Map core stat field names to current values (typed access, no getattr). (+13 more)

### Community 803 - "PlayerSchemaConverter"
Cohesion: 0.17
Nodes (12): PlayerSchemaConverter, Any, Get stats, inventory, and status_effects from player, handling async methods., Compute derived stats fields (max_dp, max_magic_points, max_lucidity). Returns…, Get PositionState from position value, with fallback to STANDING., Create PlayerRead schema from player object., Create PlayerRead schema from player dictionary., Convert a player object to PlayerRead schema. Args: player: Player object or… (+4 more)
...
### Community 805 - "is_npc_attack_on_player_blocked_by_login_grace_period"
Cohesion: 0.10
Nodes (19): _connection_manager_from_config_app(), is_npc_attack_on_player_blocked_by_login_grace_period(), is_player_attack_blocked_by_login_grace_period(), ConnectionManager, UUID, Resolve connection_manager from the public config app accessor. Uses getattr on…, True if the player should not attack (in login grace period). Fail-open on…, True if NPC attack on this player should be blocked (player in login grace… (+11 more)
...
Cohesion: 0.04
Nodes (74): _make_mock_row(), mock_player(), asyncio, fixture, UUID, Unit tests for player repository. Tests the PlayerRepository class which…, Create a mock player for save operations., Test PlayerRepository initializes correctly. (+66 more)
...
### Community 835 - "magic_service.py"
Cohesion: 0.04
Nodes (55): _CombatTickState, MagicServiceOptionalDeps, _PlayerPersistence, Protocol, TypedDict, Core magic service for spellcasting. This module provides the main magic…, Initialize the magic service. Args: spell_registry: Registry for spell lookups…, Optional dependencies for MagicService. All keys optional; defaults applied in… (+47 more)
...
### Community 837 - "test_users_current_user_logging.py"
Cohesion: 0.17
...
### Community 838 - "test_dml_room_graph.py"
Cohesion: 0.17
Nodes (19): LinkRow, RoomRow, _dml_path(), _load(), _parse_copy_blocks(), Path, Guards the `rooms` / `room_links` seed data in…, Mirrors the DDL's own `UNIQUE (from_room_id, direction)` constraint at the text… (+11 more)

### Community 839 - "_format_npc_description"
Cohesion: 0.10
...
### Community 840 - "Player"
Cohesion: 0.02
Nodes (128): Remove or update item quantity in player inventory after transfer., remove_item_from_inventory(), handle_put_command(), _put_resolve_container_id(), _put_run_validated(), _put_transfer_finish(), PutCommandRuntime, PutValidatedWork (+120 more)

### Community 841 - "test_security_headers.py"
Cohesion: 0.05
Nodes (45): MutableHeaders, ASGIApp, Receive, Scope, Send, Add all security headers to the response., Pure ASGI middleware to add comprehensive security headers to all HTTP…, Initialize security headers middleware. Args: app: ASGI application instance (+37 more)

### Community 842 - "character_creation_service.py"
Cohesion: 0.13
Nodes (13): CharacterCreationService, Any, UUID, Character creation service for MythosMUD server. This module handles all…, Validate character stats against class prerequisites. Args: stats: The stats…, Create a new character with specific stats. Args: name: The character's name…, Get information about all available character classes and their prerequisites.…, Service class for character creation and stats generation business operations. (+5 more)
...
### Community 846 - ".connection_manager"
Cohesion: 0.05
Nodes (24): Check connection state before publishing combat ended event., _CombatServiceDeps, _ConnectionManagerLike, _NPCCombatIntegrationLike, Protocol, UUID, Best-effort connection diagnostics before publishing NPC death event., Resolve UUID participant id to canonical NPC string id when mapping exists. (+16 more)
...
### Community 851 - "collect_idle_memory_sample"
Cohesion: 0.11
Nodes (18): Return the live singleton without constructing one., collect_idle_memory_sample(), _container_instance(), _event_bus_queue_depth(), IdleMemorySample, _log_hour_key_count(), _npc_pending_key_count(), _perf_metric_counts() (+10 more)
...
### Community 857 - "HallucinationFrequencyService"
Cohesion: 0.16
Nodes (13): LucidityActionCode, StrEnum, Action codes used for lucidity cooldowns (debrief, hallucination timer, etc.)., HallucinationFrequencyService, Any, AsyncSession, UUID, Hallucination frequency service for MythosMUD. Implements tier-based… (+5 more)
...
Cohesion: 0.16
Nodes (12): Audit date, Code as Source of Truth, Documentation vs. Code Accuracy Audit Log, Summary, CONNECTION_MANAGER_ARCHITECTURE.md, ConnectionManager Modular Architecture, ENHANCED_LOGGING_GUIDE.md, Logging Quick Reference Pointer (+4 more)
...
### Community 876 - "ComprehensiveLoggingMiddleware"
Cohesion: 0.11
...
### Community 883 - "replay_dlq_message"
Cohesion: 0.16
Nodes (18): get_dlq_messages(), get_metrics(), get_metrics_summary(), _get_nats_handler(), Any, get, MetricsResponse, Path (+10 more)
...
### Community 893 - "test_container_persistence_sql_injection.py"
Cohesion: 0.17
...
### Community 916 - "test_admin_setstat_command_context.py"
Cohesion: 0.16
Nodes (17): asyncio, patch, Unit tests for admin setstat context failures, logging, and notify posture.…, Test handling when player service is not available., Test handling when persistence layer is not available., Test admin action logging., Admin DP notify attaches posture_message from emit_posture_change (M9)., Test case-insensitive stat name handling. (+9 more)

### Community 917 - "test_player_model.py"
Cohesion: 0.11
Nodes (17): Unit tests for Player SQLAlchemy model. Tests the Player model methods…, Test Player.get_status_effects() parses JSON status effects., Test Player.set_status_effects() serializes to JSON., Test Player.add_experience() increases experience points., Test Player.get_health_percentage() calculates percentage correctly., Test Player.get_combat_stats() returns combat-relevant stats., Test Player.apply_dp_decay caps DP at -10., Test Player.get_stats() returns default stats if not set. (+9 more)
...
### Community 925 - "test_connection_manager_api.py"
Cohesion: 0.16
Nodes (16): mock_manager(), asyncio, fixture, Unit tests for server.realtime.connection_manager_api., #784 follow-up: deleting a connected character must drop it from the tick…, Unlike _require_manager(), a missing manager must not raise: deletion has to…, test_broadcast_game_event(), test_remove_online_player_is_a_noop_for_an_absent_player() (+8 more)
...
### Community 927 - "test_message_filtering.py"
Cohesion: 0.04
...
### Community 934 - "extract_npc_metadata"
Cohesion: 0.12
Nodes (14): extract_npc_metadata(), Extract NPC type and required status from NPC instance. Args: npc_instance: The…, Update population statistics when an NPC is despawned. Args: room_id: Room ID…, Despawn an NPC instance. This method updates population statistics when an NPC…, Test extract_npc_metadata() returns defaults when missing., Test extract_npc_metadata() handles non-string npc_type., Test extract_npc_metadata() converts truthy is_required., Test extract_npc_metadata() handles None is_required. (+6 more)
...
### Community 953 - "extract_room_id_from_npc"
Cohesion: 0.12
...
### Community 967 - "persistence/container_helpers.py"
Cohesion: 0.18
...
### Community 968 - "test_database_config_helpers_asyncpg_settings.py"
Cohesion: 0.16
...
### Community 969 - "format_combat_status"
Cohesion: 0.16
...
Cohesion: 0.15
Nodes (13): asyncio, Test get_professions when no session is yielded., Test _load_room_cache_async logs sample room IDs when rooms are loaded…, Test _load_room_cache_async handles table not found error., Test _load_room_cache_async raises other errors., Test _query_rooms_with_exits_async handles table not found error., Test _query_rooms_with_exits_async raises other errors., test_get_professions_no_session() (+5 more)
...
### Community 978 - "mapPageState.ts"
Cohesion: 0.25
Nodes (9): MapPage(), fetchFallbackCurrentRoom(), MapPageState, parseMapRouteParams(), RoomData, useMapPageState(), publishTier(), readTier() (+1 more)
...
### Community 983 - "delegate_game_state_provider"
Cohesion: 0.12
Nodes (18): delegate_game_state_provider(), Generic delegate for game state provider methods. Args: game_state_provider:…, convert_room_players_uuids_to_names_impl(), get_player_impl(), get_players_batch_impl(), get_room_occupants_impl(), Player, Get a player from the persistence layer (async version). (+10 more)
...
### Community 986 - "._ensure_core_stats"
Cohesion: 0.09
Nodes (16): computed_field, _coerce_stat_int(), _merge_random_core_stats(), _needs_random_core_stats(), model_validator, Generate random core stats when missing or None. Callers may pass…, Convert persisted stat values to int with a safe fallback., Populate max_dp from (CON+SIZ)/5 when not provided (stored value takes… (+8 more)
...
### Community 1019 - "GameClientV2Dock.test.tsx"
Cohesion: 0.25
...
Cohesion: 0.21
Nodes (12): damage_expr_to_min_max(), Lossy damage_expr → (min_damage, max_damage) bridge for catalog generators.…, Drop trailing +DB / -flavor suffixes until none remain., Return (min, max) contribution for one signed term., Convert a dice expression to inclusive (min_damage, max_damage). Args: expr:…, _strip_trailing_alpha(), _term_minmax(), parametrize (+4 more)
...
### Community 1048 - "extract_definition_id_from_npc"
Cohesion: 0.14
...
### Community 1058 - "._run_idle_sampler"
Cohesion: 0.19
Nodes (11): _append_sample_jsonl(), idle_sampler_interval_seconds(), idle_sampler_path(), Path, Sample interval in seconds. Defaults to 60; values below 1 are raised to 1., JSONL output path for idle samples., Append one JSON object. Creates parent directories as needed., Return True when the opt-in sampler task is alive. (+3 more)
...
### Community 1096 - "useConnectionStateMachine.ts"
Cohesion: 0.23
Nodes (8): useConnectionState(), UseConnectionStateResult, ConnectionContext, ConnectionEvent, connectionMachine, ConnectionMachineInput, ConnectionState, ADR-0018
...
Cohesion: 0.15
Nodes (13): minimum, type, mythos_gain, sanity_loss_expr, spells, study_hours, maxLength, minLength (+5 more)
...
### Community 1140 - "game_tick_corpses.py"
Cohesion: 0.23
Nodes (12): cleanup_decayed_corpses(), _cleanup_single_decayed_corpse(), _CorpseLike, _create_corpse_lifecycle_service(), _log_cleanup_results(), FastAPI, Protocol, Decayed corpse cleanup for the game tick loop. (+4 more)
...
### Community 1146 - ".get_memory_status_report"
Cohesion: 0.15
Nodes (9): MemoryStatusReport, TypedDict, Generate status report for diagnostic monitoring. Returns: Dictionary…, Runtime detection and cleanup of orphaned tasks based on memory thresholds.…, Narrow psutil memory_info().rss for basedpyright (stubs disagree with mypy's…, Diagnostic payload from MemoryThresholdMonitor.get_memory_status_report., Get current memory usage in bytes for this process., Get count of active tasks in the current event loop. (+1 more)

### Community 1147 - "required"
Cohesion: 0.25
Nodes (8): description, exits, id, name, plane, sub_zone, zone, required

### Community 1148 - "PlayerCreationService"
Cohesion: 0.21
...
### Community 1149 - "npc_utils.py"
Cohesion: 0.17
Nodes (12): Any, NPC Utility Functions. This module provides utility functions for extracting…, Return stable room id for zone parsing; strip instance_<uuid>_ prefix if…, Spawn an NPC through `population_controller.spawn_npc` when one is configured…, Return usable room_id from a single lifecycle event, if present., _room_id_from_lifecycle_event(), spawn_npc_via_population_controller(), _stable_room_id_for_zone() (+4 more)
...
### Community 1174 - "delegate_health_monitor"
Cohesion: 0.17
Nodes (12): delegate_health_monitor(), Generic delegate for health monitor methods., check_all_connections_health_impl(), periodic_health_check_impl(), Check health of all connections and clean up stale/dead ones., Periodic health check task that runs continuously., Test delegate_health_monitor() successfully delegates to monitor., Test delegate_health_monitor() handles None monitor. (+4 more)
...
### Community 1207 - "test_spell_repository.py"
Cohesion: 0.29
Nodes (11): _mock_session(), asyncio, fixture, Unit tests for SpellRepository., repo(), _spell_row(), test_get_all_spells(), test_get_all_spells_db_error() (+3 more)

### Community 1208 - "CorruptionTier"
Cohesion: 0.08
Nodes (53): compute_tier(), CorruptionTier, StrEnum, Corruption bands over 0..100. `PURE` is reserved for exactly 0 (#815) --…, Derive a corruption tier from the raw stat value. Pure function, no I/O. Unlike…, corruption_hostility_scale(), _pick_greeting(), Threat multiplier from the corruption gap between an NPC and a player,… (+45 more)
...
Cohesion: 0.05
Nodes (39): AppRouter(), CatalogPage, DialogueEditorPage, MapPage, SkillsPage, AppCreationFlowViews(), creationShell(), renderNameStep() (+31 more)
...
### Community 1259 - "ProfessionRepository"
Cohesion: 0.20
Nodes (8): ProfessionRepository, Profession, Get a profession by ID. Args: profession_id: Profession ID Returns: Profession…, Repository for profession persistence operations. Handles profession queries…, Initialize the profession repository., Get all available professions. Returns: list[Profession]: List of all…, fixture, repo()

### Community 1260 - "combat/__init__.py"
Cohesion: 0.20
Nodes (10): add_default_combat_data_to_config(), get_combat_stats_summary(), Any, Add default combat data to behavior_config if not present. Args: config:…, Get a summary of combat stats for an NPC definition. Args: npc_definition:…, Combat domain schemas: combat JSON schema validation and defaults., Test add_default_combat_data_to_config() adds defaults., Test get_combat_stats_summary() returns summary. (+2 more)
...
### Community 1296 - "delete_dlq_message"
Cohesion: 0.22
Nodes (10): delete_dlq_message(), delete, post, Reset metrics counters. Clears all metrics counters. Use after maintenance or…, Manually reset circuit breaker to CLOSED state. Use this to force the circuit…, Delete a message from the Dead Letter Queue without replaying. Use this to…, reset_circuit_breaker(), reset_metrics() (+2 more)

### Community 1297 - "_check_rate_limit"
Cohesion: 0.18
Nodes (8): _check_rate_limit(), Check if player is rate limited. Returns result dict if blocked, None if…, Test _check_rate_limit returns None when allowed., Test _check_rate_limit returns result when blocked., Test _check_rate_limit function., Test _check_rate_limit returns None when allowed., Test _check_rate_limit returns result when blocked., TestCheckRateLimit
...
### Community 1306 - "container_endpoints_basic.py"
Cohesion: 0.02
Nodes (125): get_current_user(), Get current user with enhanced logging., get_connection_manager, _apply_inventory_stack_defaults(), _as_inventory_dicts(), _as_str_list(), _as_str_object_dict(), _as_str_object_mapping() (+117 more)
...
### Community 1311 - "idle_sampler_enabled"
Cohesion: 0.22
Nodes (10): idle_sampler_enabled(), Return True when the opt-in idle sampler env flag is set., asyncio, MonkeyPatch, Path, `task_qualnames` counts pending tasks by coroutine qualname, not `Task-N` names., test_collect_idle_sample_task_qualnames_attributes_by_coroutine(), test_idle_sampler_disabled_by_default() (+2 more)
...
### Community 1323 - "AsyncPersistenceRoomLookup"
Cohesion: 0.20
Nodes (7): AsyncPersistenceRoomLookup, PlayerDisconnectService, PlayerMuteCleanup, Protocol, Notify subsystems when a WebSocket session ends for a player., Narrow persistence surface for loading ``Room`` by id in the WS handler., Narrow UserManager surface for clearing a disconnected player's mute state.
...
### Community 1352 - "CombatDeathHandler"
Cohesion: 0.27
Nodes (6): CombatDeathHandler, Create corpse container when player dies., Handle mortally wounded and death state changes for target. Args: target:…, Handles combat death events and state changes., Return connection manager from CombatService getter when exposed., Handle player death events including mortally wounded, death, and corpse…
...
Cohesion: 0.05
Nodes (54): _as_event_data_dict(), _EventBusPublishPort, EventHandler, _npc_died_broadcast_and_bridge(), _npc_died_ids_or_warn(), _participant_key_strings(), _publish_npc_died_to_event_bus(), ConnectionManager (+46 more)
...
### Community 1378 - "test_player_service_mutations.py"
Cohesion: 0.20
Nodes (9): Unit tests for player service mutations. Covers delete, location update, mythos…, Test soft_delete_character() successfully soft deletes., #784 follow-up (#777 fallout): deleting a still-connected character must drop…, Test soft_delete_character() when the pre-check passed (is_deleted=False) but…, Test delete_player() when player not found., test_delete_player_not_found(), test_soft_delete_character_lost_race_returns_already_deleted(), test_soft_delete_character_prunes_online_players_roster() (+1 more)
...
### Community 1382 - "test_room_subscription_manager.py"
Cohesion: 0.20
...
### Community 1415 - "Chat Effect Accessibility Floor Design"
Cohesion: 0.22
...
### Community 1442 - "Entity Contact Subsystem Design"
Cohesion: 0.22
Nodes (9): 1. Overview, 2. Architecture, 3. Key design decisions, 4. Alternatives Considered, 5. Consequences, 6. Related docs, 7. Changelog, AI READING INSTRUCTION (+1 more)
...
### Community 1454 - "_PlayerIdCarrier"
Cohesion: 0.25
Nodes (8): _PlayerIdCarrier, Protocol, Minimal player shape for token validation., Persistence surface used by validate_token_impl., Look up a player by auth user id., ConnectionManager surface used by validate_token_impl., _TokenPersistence, _TokenValidateManager
...
Cohesion: 0.11
Nodes (17): namespace, additionalProperties, additionalProperties, required, type, definitions, catalogMetadata, tomeMetadata (+9 more)
...
### Community 1515 - "_task_qualname"
Cohesion: 0.22
Nodes (8): Task, Return the coroutine qualname a task was created from, for leak attribution.…, _task_qualname(), _FakeTask, Stand-in for asyncio.Task whose coroutine has no __qualname__ (e.g. a plain…, Return a coroutine-like value with no __qualname__ attribute., `_task_qualname` degrades to the coroutine's type name rather than raising., test_task_qualname_falls_back_when_coro_has_no_qualname()
...
### Community 1539 - "._compose_memory_stats"
Cohesion: 0.25
...
### Community 1549 - "TargetResolutionResult"
Cohesion: 0.06
Nodes (38): Resolve combat target using target resolution service. Public API., Validate target_result and resolve to a live NPC target_match., Resolve combat target using target resolution service., BaseModel, Result of target resolution operation. This model contains the complete result…, Get the single match if exactly one target was found., Get list of disambiguation options for multiple matches., TargetResolutionResult (+30 more)

### Community 1550 - ".optimize_payload"
Cohesion: 0.28
...
### Community 1551 - "player_event_handler_utils"
Cohesion: 0.22
...
Cohesion: 0.22
Nodes (7): CombatEventPublisherProtocol, NpcCombatServiceProtocol, Protocol, Publish a PlayerAttackedEvent to the combat event stream., Typed surface for npc_combat_service.handle_npc_attack_on_player., Handle an NPC attack against a player via the main combat service., Combat event publisher (avoids importing CombatEventPublisher).

### Community 1554 - "asyncio"
Cohesion: 0.22
...
### Community 1701 - ".get_memory_alerts"
Cohesion: 0.25
Nodes (5): _as_int(), Coerce a duck-typed counter to int without using typing.Any., Check if cleanup should be triggered. Returns: bool: True if cleanup should be…, Get current memory usage as percentage. Returns: float: Memory usage as a…, Get memory-related alerts based on current usage and connection statistics.…
...
### Community 1715 - "._build_connection_stats"
Cohesion: 0.25
...
### Community 1744 - "TestGetContainer"
Cohesion: 0.25
...
### Community 1760 - "_max_connection_age_seconds"
Cohesion: 0.29
Nodes (6): _max_connection_age_seconds(), Connection age threshold (seconds). Higher in e2e/local to avoid mid-run drops., Initialize the memory monitor with default settings., test_max_connection_age_default(), test_max_connection_age_e2e(), test_max_connection_age_local()

### Community 1761 - "quest_service"
Cohesion: 0.29
...
### Community 1762 - "message_broadcaster"
Cohesion: 0.29
...
### Community 1781 - "._background_audit_cycle"
Cohesion: 0.33
...
### Community 1783 - "_ProfessionStatRequirementsSource"
Cohesion: 0.33
Nodes (4): _ProfessionStatRequirementsSource, Protocol, Load stat requirements from the caller-supplied profession object., Minimal profession surface for stat rolling (avoids importing…

### Community 1784 - ".get_stat_requirements"
Cohesion: 0.33
...
### Community 1787 - ".get_combat_stats"
Cohesion: 0.33
...
### Community 1788 - ".stop_npc_thread"
Cohesion: 0.33
...
### Community 1789 - "_ConnectionManagerAPI"
Cohesion: 0.33
Nodes (3): _ConnectionManagerAPI, Protocol, Structural type for API helpers; avoids importing ConnectionManager.

### Community 1790 - "add_default_combat_data_to_stats"
Cohesion: 0.33
...
### Community 1792 - ".get_original_string_id"
Cohesion: 0.27
...
### Community 1809 - "TestGetRoomService"
Cohesion: 0.33
...
### Community 1811 - "TestGetPlayerRespawnService"
Cohesion: 0.33
...
### Community 1813 - "TestGetSpellRegistry"
Cohesion: 0.33
...
### Community 1815 - "TestGetNPCSpawningService"
Cohesion: 0.33
...
### Community 1816 - "TestGetStatsGenerator"
Cohesion: 0.33
...
### Community 1817 - "TestGetPlayerServiceForTesting"
Cohesion: 0.33
...
### Community 1829 - "process_subzone_rows"
Cohesion: 0.40
Nodes (5): process_subzone_rows(), Connection, Process subzone rows from database and populate subzone configurations. Args:…, Test process_subzone_rows() processes subzone rows., test_process_subzone_rows()

### Community 1830 - "add_hashed_password_column.py"
Cohesion: 0.50
...
### Community 1832 - "rename_invites_columns.py"
Cohesion: 0.50
...
### Community 1833 - "rename_used_to_is_active.py"
Cohesion: 0.50
...
### Community 1849 - "_warning_for_cap_stat"
Cohesion: 0.50
Nodes (4): _as_int(), Coerce stats JSON values to int without accepting bool as int., Return warning message if value exceeds DP or MP calculated maximum; else empty…, _warning_for_cap_stat()

### Community 1851 - "process_zone_rows"
Cohesion: 0.50
Nodes (4): process_zone_rows(), Process zone rows from database and populate zone configurations. Args: conn:…, Test process_zone_rows() handles empty result., test_process_zone_rows_empty()

### Community 1852 - "test_apply_corruption"
Cohesion: 0.50
Nodes (4): _async_session_gen(), Yield a single fake session -- mirrors get_async_session's shape for…, Test apply_corruption() applies corruption., test_apply_corruption()

### Community 1854 - "TestGetProfessionService"
Cohesion: 0.50
...
### Community 1859 - "tradition"
Cohesion: 0.67
Nodes (3): tradition, minLength, type
...
- **Why does `get_logger()` connect `get_logger` to `ValidationError`, `StandardizedErrorResponse`, `test_users.py`, `LootAllRequest`, `models/player.py`, `zone_config_loader.py`, `server/dependencies.py`, `container_query_helpers_async.py`, `Any`, `inventory_equip_command.py`, `SpellEffects`, `NPCLifecycleManager`, `PrototypeRegistryError`, `CombatParticipant`, `NATSConnectionStateMachine`, `test_websocket_handler_core.py`, `endpoints.py`, `NPCDefinition`, `ContainerComponent`, `PlayerPreferencesService`, `AliasStorage`, `test_rescue_service.py`, `api/character_creation.py`, `spell_effects_support.py`, `HolidayService`, `test_combat_event_publisher.py`, `CombatService`, `LoggedHTTPException`, `skills_commands.py`, `test_npc_admin_commands.py`, `EventBus`, `fixtures/integration/__init__.py`, `InventoryCommandFactory`, `test_combat_monitoring_service.py`, `DatabaseManager`, `CatatoniaObserverProtocol`, `PlayerNameExtractor`, `server/tests/conftest.py`, `test_communication_commands_flows.py`, `lifespan_magic.py`, `test_corpse_lifecycle_service.py`, `test_container_bundles.py`, `MetricsCollector`, `BaseCommand`, `test_connection_session_management.py`, `server/schemas/__init__.py`, `look_container.py`, `test_command_validator.py`, `MythosTickScheduler`, `test_inventory_helpers.py`, `handle_emote_command`, `test_chat_validator.py`, `PrototypeRegistry`, `combat_service.py`, `player_effect_repository.py`, `CombatConfiguration`, `magic_service_completion.py`, `AppConfig`, `CombatInstance`, `test_player_death_service.py`, `lucidity_migration.py`, `ContainerData`, `test_admin_commands.py`, `test_real_time_helpers.py`, `PlayerRespawnEventHandler`, `test_who_commands.py`, `test_connection_delegates.py`, `chat_message.py`, `test_look_room.py`, `test_rest_command.py`, `NATSError`, `AsciiMapRenderer`, `look_helpers.py`, `format_message_content`, `chat_service.py`, `system_monitoring.py`, `WebSocketMessageValidator`, `NPCOccupantProcessor`, `test_chat_npc_system.py`, `cleanse_command.py`, `maps.py`, `test_combat_service_modules.py`, `handle_teach_command`, `ChatMessage`, `lifespan.py`, `command_service.py`, `is_player_in_login_grace_period`, `game_tick_corpses.py`, `TransferContainerRequest`, `PlayerPositionService`, `handle_transfer_items_exceptions`, `npc_service/__init__.py`, `test_look_player.py`, `player_inventory_migration.py`, `PlayerCombatService`, `test_connection_disconnection.py`, `realtime/realtime.py`, `test_aggro_threat.py`, `websocket_handler_validation.py`, `look_command.py`, `apply_communication_dampening`, `FeatureFlagService`, `test_logout_commands.py`, `hallucinations.py`, `api/metrics.py`, `test_look_npc.py`, `test_status_commands.py`, `api/monitoring.py`, `real_time.py`, `FollowService`, `admin_teleport_commands.py`, `admin_setstat_support.py`, `ChatModeration`, `MPRegenerationService`, `test_go_command.py`, `test_wearable_container_service.py`, `TaskRegistry`, `MemoryLeakMetricsCollector`, `container_persistence.py`, `logging_file_setup.py`, `DialogueDefinitionRepository`, `item_instance_persistence.py`, `catatonia_check.py`, `test_shutdown_sequence.py`, `PerformanceMonitor`, `test_admin_setlucidity_command.py`, `test_error_handling_middleware.py`, `test_lucidity_recovery_commands.py`, `test_lucidity_event_dispatcher.py`, `CombatAuditLogger`, `test_alias_commands.py`, `NPCActionMessage`, `RoomRepository`, `admin_hallucinate_command.py`, `test_enhanced_logging_config.py`, `inventory_command_helpers.py`, `lifespan_protocols.py`, `RoomCacheLoader`, `test_email_utils.py`, `_ensure_connection_manager`, `HealthRepository`, `ProfessionRepository`, `ExceptionTracker`, `catalog_commands.py`, `DeadLetterQueue`, `HealthStatus`, `TargetMatch`, `spell_effects_status.py`, `test_level_service.py`, `NATSRetryHandler`, `LucidityService`, `test_container_persistence_async_helpers.py`, `ErrorType`, `profession_repository.py`, `InstanceManager`, `quest_service.py`, `get_username_from_user`, `test_command_processor.py`, `lifecycle_manager.py`, `test_item_catalog.py`, `_prepare_command_for_processing`, `test_rate_overrides.py`, `send_game_event`, `MovementService`, `combat_turn_participant_actions.py`, `container_endpoints_basic.py`, `room_service.py`, `game_tick_processing.py`, `test_cache_service.py`, `websocket_handler_commands.py`, `test_occupants.py`, `stats_generator.py`, `test_party_commands.py`, `add_hashed_password_column.py`, `add_used_by_user_id_column.py`, `rename_invites_columns.py`, `rescue_commands.py`, `rename_used_to_is_active.py`, `CoordinateValidator`, `test_magic_service.py`, `admin_summon_command.py`, `websocket_helpers.py`, `middleware`, `alias_storage.py`, `handle_read_command`, `PlayerEnteredRoom`, `retry.py`, `debrief_command.py`, `passive_lucidity_flux/service.py`, `magic_service.py`, `command_guards.py`, `combat_attack.py`, `Player`, `migrate_combat_data.py`, `character_creation_service.py`, `talk_command.py`, `CircuitBreaker`, `test_player_occupant_processor.py`, `CombatPersistenceHandler`, `Any`, `ContainerRepository`, `HallucinationFrequencyService`, `EventHandler`, `.async_persistence`, `test_chat_nats_publisher.py`, `rooms.py`, `test_map_helpers.py`, `test_container_websocket_events.py`, `test_passive_corruption_flux_rate_overrides.py`, `rest_countdown_task.py`, `channel_broadcasting_strategies.py`, `.__init__`, `optimized_security_validator.py`, `test_channel_commands.py`, `subject_controller.py`, `player_connection_setup.py`, `SecureBaseModel`, `player_presence_tracker.py`, `emit_posture_change`, `NPCCombatDataProvider`, `websocket_handler.py`, `resolve_weapon_attack_from_equipped`, `monitoring_dashboard.py`, `nats_message_handler.py`, `MessageBroadcaster`, `passive_corruption_flux/service.py`, `quest_commands.py`, `PayloadOptimizer`, `test_npc_event_handlers.py`, `ChatPoseManager`, `admin_shutdown_command.py`, `test_magic_healing_events.py`, `server/main.py`, `persistence/container_helpers.py`, `_find_item_in_equipped`, `ItemFactory`, `processing.py`, `MovementMonitor`, `PersonalMessageSender`, `CommandRateLimiter`, `test_lifecycle_respawn.py`, `admin_setstat_command.py`, `test_connection_establishment.py`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `EventBus` connect `EventBus` to `ValidationError`, `PlayerCombatService`, `InstanceManager`, `test_party_flow.py`, `EventBusLifecycleMixin`, `NPCCombatIntegrationService`, `NPCLifecycleManager`, `lifecycle_manager.py`, `NPCDefinition`, `MovementService`, `integration`, `CombatService`, `FollowService`, `ConnectionManager`, `AsyncPersistenceLayer`, `PartyService`, `NPCCombatIntegration`, `PlayerEnteredRoom`, `MythosTickScheduler`, `combat_service.py`, `get_logger`, `Any`, `test_combat_integration_base.py`, `ScheduleService`, `combat_loader.py`, `lifespan_protocols.py`, `RoomCacheLoader`, `CombatCommandHandler`, `test_chat_npc_system.py`, `DistributedEventBus`, `NPCCommunicationIntegration`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `ConnectionManager` connect `ConnectionManager` to `PlayerCombatService`, `server/dependencies.py`, `test_connection_disconnection.py`, `websocket_handler_validation.py`, `NPCDefinition`, `test_connection_helpers_impl.py`, `GameStateProvider`, `websocket_handler.py`, `NPCCombatDataProvider`, `canonical_room_id_impl`, `container_endpoints_basic.py`, `HolidayService`, `MemoryMonitor`, `nats_message_handler.py`, `api/monitoring.py`, `websocket_handler_commands.py`, `FollowService`, `EventPublisher`, `RateLimiter`, `MessageQueue`, `PartyService`, `test_container_bundles.py`, `test_connection_session_management.py`, `get_logger`, `RealtimeBundle`, `test_websocket_room_updates.py`, `PlayerRespawnEventHandler`, `inventory_command_helpers.py`, `EventHandler`, `combat_loader.py`, `lifespan_protocols.py`, `CombatCommandHandler`, `test_connection_statistics.py`, `TransferContainerRequest`?**
