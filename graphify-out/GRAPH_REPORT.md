# Graph Report - MythosMUD  (2026-08-17)

## Corpus Check
- 3316 files · ~2,837,583 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 53800 nodes · 101137 edges · 2214 communities (1718 shown, 496 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 7484 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9bbd245a`
...
- ._handle_npc_death_on_combat_end
...
- TestCheckRateLimit
- .test_broadcast_message_broadcast_stats_structure
...
- test_event_bus_subscribe_multiple
...
- test_event_bus_get_all_subscriber_counts
- Quest System Gap
...
- test_restore_mp_from_item_uses_magic_service
- .send_message
...
- test_memory_profiler_measure_model_instantiation_zero_iterations
- test_memory_profiler_print_model_memory_usage
- Executive Summary
- unit/infrastructure/__init__.py
- test_memory_profiler_print_model_memory_usage_error
...
## Communities (2214 total, 496 thin omitted)

### Community 0 - "EventBus"
Cohesion: 0.01
Nodes (275): _create_npc_services_on_app(), Create NPC spawning, lifecycle, population services and instance service.…, EventBus, AbstractEventLoop, Any, T, Task, Set the main event loop - now properly managed for async compatibility. (+267 more)

### Community 1 - "test_admin_auth_service.py"
Cohesion: 0.02
Nodes (112): AdminAuthService, AdminRole, AdminSession, Any, Request, Represents an admin session., Service for admin authentication and authorization., Initialize the admin auth service. (+104 more)

### Community 2 - "PlayerNameExtractor"
Cohesion: 0.02
...
### Community 3 - "lifespan_startup.py"
Cohesion: 0.04
Nodes (90): _ensure_room_cache_before_npc_startup(), _get_item_prototype_count(), _get_item_prototype_entries(), initialize_chat_service(), initialize_combat_services(), initialize_container_and_legacy_services(), initialize_mythos_time_consumer(), initialize_nats_and_combat_services() (+82 more)

### Community 4 - "test_movement_service.py"
Cohesion: 0.03
Nodes (90): check_combat_state(), check_player_posture(), extract_player_id(), Any, Room, UUID, Movement validation helpers for MovementService. Cohesive validation and room-…, Validate player is in the from_room, auto-adding if database matches. (+82 more)

### Community 5 - "loot_all_items"
Cohesion: 0.08
Nodes (27): _audit_loot_all(), loot_all_items(), Any, Request, Loot all eligible items from a container., asyncio, Test loot_all_items raises error when user validation fails., Test loot_all_items raises error when rate limit exceeded. (+19 more)

### Community 6 - "CommandFactory"
Cohesion: 0.01
...
Cohesion: 0.03
Nodes (119): _async_callable(), cleanup_dead_websocket_impl(), _close_dead_websocket_if_open(), delegate_connection_cleaner_sync(), delegate_game_state_provider(), delegate_game_state_provider_sync(), delegate_health_monitor(), delegate_health_monitor_sync() (+111 more)

### Community 9 - "test_npc_event_handlers_helpers.py"
Cohesion: 0.09
...
### Community 10 - "test_player_death_service.py"
Cohesion: 0.03
...
### Community 11 - "container_endpoints_basic.py"
Cohesion: 0.02
Nodes (118): get_current_user(), Get current user with enhanced logging., get_async_persistence, get_connection_manager, _apply_inventory_stack_defaults(), _as_inventory_dicts(), _as_str_list(), _as_str_object_dict() (+110 more)

### Community 12 - "CombatParticipant"
Cohesion: 0.02
Nodes (197): CombatAction, CombatParticipant, _get_default_damage(), Check if participant can perform voluntary combat actions. Unconscious (DP <=…, Apply damage to this participant and determine resulting death states.…, Get the default damage value from configuration., Represents a combat action., Represents a participant in combat. (+189 more)

### Community 13 - "DeadLetterQueue"
Cohesion: 0.04
...
### Community 14 - "LucidityService"
Cohesion: 0.02
Nodes (214): LucidityActionCode, LucidityAdjustmentLog, LucidityCooldown, LucidityExposureState, PlayerLucidity, Base, StrEnum, Lucidity tracking models drawn from the Pnakotic Manuscripts. (+206 more)
...
### Community 16 - "register_user"
Cohesion: 0.05
Nodes (71): BaseUserManager, ID, IntegrityError, _ensure_user_email(), _generate_jwt_token(), _handle_integrity_error(), LoginResponse, BaseModel (+63 more)

### Community 17 - "User"
Cohesion: 0.02
Nodes (171): DependsParam, auth_service(), Simulate auth service., _apply_rate_limiting_for_stats_roll(), _apply_stat_modifiers(), _as_float(), _as_int(), _check_shutdown_status() (+163 more)
...
Cohesion: 0.04
Nodes (82): ContainerData, ContainerDataCore, ContainerDataExtras, Container data class for persistence operations., Identity and placement fields for a container row., Optional payload and timestamps for a container row., Data class for container information., Convert container data to dictionary. Returns dictionary with model field names… (+74 more)

### Community 20 - "test_look_helpers.py"
Cohesion: 0.03
Nodes (78): _AppWithState, _async_persistence_from_app(), _ContainerWithPersistence, _EquippedPlayer, _get_health_label(), _get_wearable_container_service(), LookRequest, _parse_instance_number() (+70 more)
...
### Community 22 - "RateLimiter"
Cohesion: 0.03
Nodes (78): Any, RateLimiter, Clean up old rate limit attempts to prevent memory bloat. Args:…, Clean up large data structures to prevent memory bloat. Args: max_entries:…, Remove all rate limit data for a specific player. Args: player_id: The player's…, Rate limiter for connection attempts and other operations. This class provides…, Get rate limiter statistics. Returns: dict: Statistics about current rate…, Check if a connection has exceeded message rate limits. Args: connection_id:… (+70 more)

### Community 23 - "admin_shutdown_command.py"
Cohesion: 0.10
...
### Community 25 - "ExplorationService"
Cohesion: 0.06
Nodes (78): _MapRooms, MapZoneContext, NamedTuple, Plane, zone, and sub_zone grouped for map/minimap APIs to reduce parameter…, _apply_exploration_filter_if_needed(), _AsciiMapViewport, _build_ascii_map_response(), _build_ascii_minimap_response() (+70 more)

### Community 26 - "test_security_validator.py"
Cohesion: 0.01
Nodes (214): field_validator, Validate alias name format using centralized validation., Validate command content for security using centralized validation., Validate alias name format using centralized validation., field_validator, Validate combat target name format using centralized validation., Validate combat target name format using centralized validation., Validate combat target name format using centralized validation. (+206 more)

### Community 27 - "test_container_bundles.py"
Cohesion: 0.02
Nodes (121): ChatBundle, Chat bundle: chat service. Depends on Core (config, persistence), Game…, CombatBundle, Combat bundle: player combat, death, respawn, combat service, catatonia,…, Combat-related services., CoreBundle, Core bundle: config, database, tasks, event bus, persistence. First bundle in…, Core infrastructure: config, database, tasks, event bus, persistence. (+113 more)

### Community 28 - "field_validator"
Cohesion: 0.18
...
Cohesion: 0.02
Nodes (174): _CombatTickState, _MagicServiceCore, _PlayerPersistence, JsonMap, Protocol, UUID, Load player and return normalized stats (MP/max_MP). Returns (player, stats) or…, Return (False, message) if not enough MP, else (True, ''). (+166 more)

### Community 30 - "PerformanceTracker"
Cohesion: 0.04
Nodes (45): get_global_tracked_manager(), Access the singleton global TrackedTaskManager for usage across the server.…, HealthMonitor, Any, UUID, Health monitoring for connection management. This module provides comprehensive…, Find player_id for cleanup when metadata is missing., Check if connection is stale based on timeout. (+37 more)
...
### Community 36 - "test_monitoring_endpoints.py"
Cohesion: 0.07
...
### Community 38 - "test_exploration_service.py"
Cohesion: 0.04
...
### Community 40 - "websocket_initial_state.py"
Cohesion: 0.02
Nodes (205): get_async_persistence(), Get the global async persistence instance. DEPRECATED: Use…, Reset the global async persistence instance for testing. DEPRECATED: Use…, reset_async_persistence(), _append_unique_valid_occupant(), _ensure_respawned_player_in_lists(), _is_npc_occupant_row(), _occupant_str_field() (+197 more)

### Community 41 - "test_npc_utils.py"
Cohesion: 0.03
Nodes (79): Check if this NPC is required to spawn., extract_definition_id_from_npc(), extract_npc_metadata(), extract_room_id_from_lifecycle_record(), extract_room_id_from_npc(), get_zone_key_from_room_id(), Any, NPC Utility Functions. This module provides utility functions for extracting… (+71 more)
...
### Community 45 - "ContainerComponent"
Cohesion: 0.02
Nodes (186): ContainerComponent, ContainerFactoryOptions, ContainerLockState, ContainerSourceType, Any, BaseModel, datetime, field_validator (+178 more)

### Community 46 - "api/player_effects.py"
Cohesion: 0.04
...
### Community 47 - "NATSError"
Cohesion: 0.03
Nodes (102): Message formatting utilities for NATS message handler., NATSConnectionError, NATSError, NATSHealthCheckError, NATSPublishError, NATSRequestError, NATSSubscribeError, Exception (+94 more)
...
### Community 50 - "test_users.py"
Cohesion: 0.04
Nodes (73): Custom user manager for MythosMUD. Extends FastAPI Users BaseUserManager to…, Hash password using Argon2 instead of bcrypt., Verify password using Argon2 instead of bcrypt., UserManager, asyncio, Unit tests for user management., Test forgot password logic., Test verification request logic. (+65 more)

### Community 51 - "config/models/__init__.py"
Cohesion: 0.05
Nodes (43): Composite application configuration model., ChatConfig, BaseSettings, field_validator, Chat and time configuration models., Chat system configuration., Validate rate limits are reasonable., Temporal compression configuration for the MythosChronicle. (+35 more)

### Community 52 - "NATSRetryHandler"
Cohesion: 0.05
...
### Community 55 - "lifespan.py"
Cohesion: 0.03
Nodes (81): get_system_health(), get_system_monitoring_alerts(), get_system_monitoring_summary(), get, post, Request, Get comprehensive monitoring summary., Get system alerts from monitoring dashboard. (+73 more)

### Community 56 - "test_container_persistence_extended_crud.py"
Cohesion: 0.05
Nodes (58): create_container(), delete_container(), Persist a new container row, optionally seed contents, return hydrated data or…, Delete by id; True if a row was removed. Raises DatabaseError on failure., _build_container_data_from_row(), get_containers_by_entity_id(), get_containers_by_room_id(), get_decayed_containers() (+50 more)

### Community 57 - "test_user_schemas.py"
Cohesion: 0.13
...
### Community 58 - "Stats"
Cohesion: 0.02
Nodes (106): computed_field, generate_random_stats(), Any, Stats, Stats Generator Service for MythosMUD. This module provides random stat…, Roll Size using formula: (2D6+6)*5 (range 40-90)., Roll stats using 3d6 method (scaled to 15-90 range)., Roll stats using 4d6 drop lowest method (more generous, scaled to 15-90 range). (+98 more)

### Community 59 - "TestHelperFunctions"
Cohesion: 0.03
...
### Community 60 - "NPCDefinitionCRUDMixin"
Cohesion: 0.06
Nodes (36): NPCDefinitionCRUDMixin, Any, AsyncSession, Execute create_npc_definition stored procedure and return the created…, Validate create_npc_definition parameters. Raises ValueError if invalid., Log successful NPC definition creation., Validate NPC update parameters., Add a simple field to update_data if value is not None. (+28 more)

### Community 61 - "ContainerService"
Cohesion: 0.09
Nodes (58): ContainerService, Service for managing container operations. Orchestrates open/close, transfer…, MutationDecision, Result of attempting to acquire a guarded mutation context., _container(), _container_data(), asyncio, ContainerComponent (+50 more)
...
### Community 63 - "mythos_mud_mapbuilder.py"
Cohesion: 0.10
...
### Community 64 - "admin_teleport_commands.py"
Cohesion: 0.03
...
### Community 65 - "StandardizedErrorResponse"
Cohesion: 0.03
Nodes (82): MythosValidationError, Error handlers package for MythosMUD. This package provides specialized error…, convert_pydantic_error(), _ExtractedErrorInfo, _ExtractedFieldErrorInfo, handle_pydantic_error(), TypedDict, Unpack (+74 more)

### Community 66 - "test_auth_utils.py"
Cohesion: 0.03
...
### Community 67 - "test_config_models.py"
Cohesion: 0.06
Nodes (41): _default_cors_origins(), _parse_env_list(), _parse_list_from_string(), Parse non-empty string as JSON list or CSV. Used by _parse_env_list., Parse a string from the environment as JSON list or CSV., Derive default CORS origins with environment taking precedence., BaseSettings, Server network configuration. (+33 more)

### Community 68 - "test_command_validation.py"
Cohesion: 0.04
Nodes (47): check_catatonia_block(), _check_catatonia_registry(), _load_player_for_catatonia_check(), _PersistenceGetPlayerByName, CommandExecutionRequest, Protocol, Determine whether to block command execution due to catatonia. A catatonic…, Minimal persistence surface used by catatonia load path. (+39 more)

### Community 69 - "chat_service.py"
Cohesion: 0.04
Nodes (65): ChatLogger, ChatPlayerService, ChatRateLimiter, ChatUserManager, Protocol, Player lookup used by channel senders., Mute and admin checks used by channel senders., Return True if the player has admin chat privileges. (+57 more)

### Community 70 - "InstanceManager"
Cohesion: 0.05
Nodes (40): Instance, InstanceManager, Room, UUID, Return template rooms matching instance_template_id., Clone template rooms into instance-scoped rooms with remapped exits., Extract stable_id from room - use room.id if it looks like a full path., Remap exit targets: same-instance rooms use instance IDs, outside exits use… (+32 more)

### Community 71 - "test_population_stats.py"
Cohesion: 0.05
...
### Community 72 - "NATSService"
Cohesion: 0.02
Nodes (154): NATSConfig, Any, BaseSettings, field_validator, NATS messaging configuration., Validate TLS file paths exist when TLS is enabled., Validate max payload is reasonable., Validate value is positive. (+146 more)
...
### Community 74 - "api/monitoring.py"
Cohesion: 0.02
Nodes (167): _assemble_health_response(), AlertResolveResponse, AlertsResponse, CacheMetricsResponse, ConnectionHealthStatsResponse, DualConnectionStatsResponse, EventBusMetricsResponse, IntegrityResponse (+159 more)

### Community 75 - "test_logging_handlers.py"
Cohesion: 0.04
...
### Community 76 - "websocket_handler.py"
Cohesion: 0.05
Nodes (57): get_message_validator(), Get the global message validator instance., AsyncPersistenceRoomLookup, cleanup_websocket_connection(), PlayerDisconnectService, Protocol, UUID, WebSocket (+49 more)

### Community 77 - "combat_service_attack.py"
Cohesion: 0.06
Nodes (40): get_current_tick(), Shared game tick counter. Kept in a leaf module so combat services can read the…, Get the current game tick., CombatResult, Result of a combat action., apply_damage_and_check_involuntary_flee(), _effective_room_for_melee(), finalize_attack_result() (+32 more)
...
### Community 80 - "test_admin_commands.py"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (88): object, _coerce_transfer_quantity(), _ensure_item_instance_for_put(), _ensure_mutation_token(), _extract_items_dict_branch(), extract_items_from_container(), _extract_items_json_branch(), filter_valid_items() (+80 more)

### Community 85 - "test_spell_effects.py"
Cohesion: 0.04
Nodes (75): Optional deps for SpellEffects beyond player_service., Initialize the spell effects engine., SpellEffectsDeps, mock_player_service(), mock_spell(), mock_target_match(), asyncio, fixture (+67 more)

### Community 86 - "schemas/admin/__init__.py"
Cohesion: 0.11
...
### Community 87 - "EventHandler"
Cohesion: 0.05
Nodes (49): _as_event_data_dict(), EventHandler, _npc_died_broadcast_and_bridge(), _npc_died_ids_or_warn(), _participant_key_strings(), _publish_npc_died_to_event_bus(), ConnectionManager, Event handlers for NATS message handler. This module handles all event-type… (+41 more)

### Community 88 - "test_command_processor.py"
Cohesion: 0.03
...
### Community 89 - "logging_file_setup.py"
Cohesion: 0.05
Nodes (67): Formatter, Logger, _PlayerGuidFormatterType, Queue, _add_handler_to_loggers(), _CategoryHandlerConfig, _ConsoleHandlerConfig, _convert_max_size_to_bytes() (+59 more)

### Community 90 - "send_game_event"
Cohesion: 0.07
Nodes (42): broadcast_game_event(), _ConnectionManagerAPI, Protocol, UUID, Send a system notification to a player. Args: player_id: The player's ID…, Send a player status update to a player. Args: player_id: The player's ID…, Send room description to a player. Args: player_id: The player's ID room_data:…, Structural type for API helpers; avoids importing ConnectionManager. (+34 more)

### Community 91 - "test_websocket_handler_app_state_connection.py"
Cohesion: 0.06
...
### Community 92 - "login_user"
Cohesion: 0.06
Nodes (58): CharacterInfo, get_container, _authenticate_user_credentials(), _check_shutdown_status(), _check_username_exists(), _find_user_by_username(), _get_user_characters(), _invalid_credentials_exc() (+50 more)
...
### Community 94 - "NPCCombatIntegrationService"
Cohesion: 0.02
Nodes (153): Check if participant is alive enough to be in combat. For players: alive if DP…, NPCCombatIntegrationService, ConnectionManager, Return combat service dependency for integration collaborators., Return NPC data provider dependency for integration collaborators., Player attack path after login grace check passes., NPC attack path after login grace check passes., Handle a player attacking an NPC using auto-progression combat system. Args:… (+145 more)

### Community 95 - "CorpseOverlay.tsx"
Cohesion: 0.04
Nodes (72): BackpackTab(), ContainerSplitPane(), ContainerSplitPaneProps, ContainerInventoryPaneProps, ContainerItemRow(), ContainerSplitPaneView(), ContainerSplitPaneViewModel, ContainerSplitPaneViewProps (+64 more)
...
### Community 97 - "test_player_event_handlers_room.py"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (71): _find_dead_connections(), Find dead WebSocket connections for a player before acquiring lock. Args:…, _as_mgr(), _FakeEstablishmentManager, _make_manager(), _meta(), asyncio, ConnectionMetadata (+63 more)

### Community 99 - "test_logging_utilities.py"
Cohesion: 0.04
Nodes (70): detect_environment(), Detect the current environment based on various indicators. Returns:…, Path, Unit tests for logging utilities. Tests the logging utilities for directory…, Test resolve_log_base() returns absolute path as-is., Test resolve_log_base() resolves relative path using pyproject.toml., Test resolve_log_base() falls back to current directory if no pyproject.toml., Test resolve_log_base() finds pyproject.toml in parent directory. (+62 more)
...
Cohesion: 0.02
Nodes (176): _filter_other_players(), _format_containers_section(), _format_exits_list(), _format_items_section(), _format_npcs_section(), _format_players_section(), _get_room_description(), _get_room_id() (+168 more)

### Community 102 - "broadcast_message"
Cohesion: 0.16
Nodes (12): broadcast_message(), post, Broadcast a message to all connected players (admin only). Requires superuser…, asyncio, Test broadcast_message handles broadcast errors gracefully., Test broadcast_message handles missing successful_deliveries in stats., Test broadcast_message handles empty stats dictionary., Test broadcast_message logs info messages correctly. (+4 more)

### Community 103 - "NPCCombatUUIDMapping"
Cohesion: 0.03
Nodes (58): Shared spawn / respawn room identifiers used by gameplay and E2E seed scripts.…, Return UUID mapping dependency for integration collaborators., _coerce_xp_mapping_value(), _NPCCombatIntegrationValidationDeps, NPCCombatIntegrationValidationMixin, Protocol, UUID, Validation and UUID-mapping helpers for NPC combat integration (mixin). (+50 more)

### Community 104 - "test_container_websocket_events.py"
Cohesion: 0.08
...
Cohesion: 0.10
Nodes (46): expectWhoListingOnPage(), nudgeStandBothPlayers(), primeBothForCoLocate(), waitForLookReflected(), executeUnmuteAndWaitForAck(), nudgeStandBothPlayers(), primeBothForCoLocate(), executeUnmuteAndWaitForAck() (+38 more)

### Community 107 - "DatabaseManager"
Cohesion: 0.01
Nodes (326): close_db(), get_test_database_url(), Get test override database URL., Set test override database URL., set_test_database_url(), DatabaseManager, _dispose_engine_safely(), ensure_database_directory() (+318 more)

### Community 108 - "test_movement_monitor.py"
Cohesion: 0.04
Nodes (58): get_movement_monitor(), Get the global movement monitor instance., movement_monitor(), fixture, Unit tests for movement monitor. Tests the MovementMonitor class for monitoring…, Test record_integrity_check() records check without violation., Test record_integrity_check() records check with violation., Test validate_room_integrity() with valid room data. (+50 more)

### Community 109 - "NATSServicePoolMixin"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (44): Custom exceptions for NATS Subject Manager. This module defines all exception…, Exception raised when subject validation fails., SubjectValidationError, NATS Subject Manager for MythosMUD. This module provides centralized subject…, Predefined subject patterns for MythosMUD chat system. This module contains all…, get_chat_subscription_patterns(), get_event_subscription_patterns(), get_subscription_pattern() (+36 more)

### Community 111 - "npc_combat_integration_service.py"
Cohesion: 0.04
Nodes (74): AppWithState, Protocol, Shared Starlette/FastAPI-shaped protocols for combat command modules. Keeps…, Application object with a ``state`` namespace (dynamic attributes)., _NpcWithLife, Protocol, Combat command handler class and shared helpers. Extracted from combat.py to…, NPC instance shape for alive check before accepting an attack target. (+66 more)

### Community 112 - "test_npc_models.py"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (77): _begin_seated_rest_countdown(), cancel_rest_countdown(), _check_player_in_combat(), _check_rest_location(), _disconnect_player_intentionally(), _execute_rest_flow(), _get_services_from_app(), handle_rest_command() (+69 more)
...
### Community 117 - "test_container_persistence_async_helpers.py"
Cohesion: 0.08
...
### Community 119 - "CombatConfiguration"
Cohesion: 0.04
...
### Community 120 - "FollowService"
Cohesion: 0.08
Nodes (28): FollowService, Any, ConnectionManager, UserManager, UUID, Fire-and-forget; close coro if no running event loop (e.g. sync unit tests)., Send a command_response-style message to a single player., Send command_response with result message and optional player_update (e.g.… (+20 more)

### Community 121 - "test_npc_service.py"
Cohesion: 0.04
Nodes (91): Initialize NPC services and load definitions., NPCService, Comprehensive NPC management service. Handles CRUD operations for NPC…, Initialize the NPC service., _def_row(), _mock_result_mappings_all(), mock_session(), npc_service() (+83 more)
...
### Community 124 - "AliasStorage"
Cohesion: 0.01
Nodes (218): AliasPayload, AliasStorage, _as_alias_payload(), _empty_alias_payload(), Path, Manages player alias storage in JSON files. Each player's aliases are stored in…, Get the file path for a player's aliases. Human: reject path separators /…, Absolute str path for open(); re-checks containment at the open site. Human:… (+210 more)

### Community 125 - "useMythosAppActions.ts"
Cohesion: 0.07
Nodes (64): errorMessageFromApiBody(), parseSelectCharacterResult(), pickString(), postSelectCharacter(), requestDeleteCharacter(), resolveSelectedId(), runAfterCharacterCreatedFlow(), CreationRefreshResult (+56 more)
...
Cohesion: 0.04
Nodes (69): process_websocket_command(), Build request context, run process_command_unified, attach room_state when…, Run unified command pipeline for WebSocket; returns command_response dict., _websocket_unified_command_result(), handle_websocket_message(), WebSocket, Handle a WebSocket message from a player. Args: websocket: The WebSocket…, asyncio (+61 more)
...
Cohesion: 0.04
Nodes (83): _format_cooldown_message(), _format_recovery_success_message(), handle_folk_tonic_command(), handle_group_solace_command(), handle_meditate_command(), handle_pray_command(), handle_therapy_command(), _perform_recovery_action() (+75 more)

### Community 130 - "test_channel_broadcasting_strategies.py"
Cohesion: 0.06
Nodes (57): ChannelBroadcastingStrategy, ChannelBroadcastingStrategyFactory, GlobalChannelStrategy, PartyChannelStrategy, ABC, Channel Broadcasting Strategies for NATS Message Handler. This module…, Strategy for party channel broadcasting. Delivers only to current party members., Strategy for whisper channel broadcasting. (+49 more)

### Community 131 - "PlayerGuidFormatter"
Cohesion: 0.05
...
### Community 132 - "test_combat_handler.py"
Cohesion: 0.07
...
### Community 133 - "WebSocketRequestContext"
Cohesion: 0.06
Nodes (37): Any, Get the event bus from the request context., Get the alias storage from the request context., Creates FastAPI Request-like objects for WebSocket commands. This allows…, Initialize the WebSocket request context. Args: app_state: Real application…, Set the alias storage in the app state. Args: alias_storage: Alias storage…, Set the app state services in the request context. Note: This method is kept…, Get the persistence layer from the request context. (+29 more)

### Community 134 - "NPCDefinition"
Cohesion: 0.01
Nodes (414): Event bus for MythosMUD. This module provides the EventBus class that…, _default_timestamp(), NPCEnteredRoom, NPCLeftRoom, NPCListened, NPCSpoke, NPCTookDamage, ObjectAddedToRoom (+406 more)

### Community 135 - "test_websocket_handler_commands.py"
Cohesion: 0.10
Nodes (35): _attach_room_state_to_result(), _invoke_get_room_state_event(), parse_game_command_tokens(), Return get_room_state_event(player_id, room_id) coroutine factory, or None if…, Await get_room_state_event; log and return None on expected integration errors., Mutate result with room_state when player moved and handler supports it., Resolve ConnectionManager; fallback to app.state for backward compatibility.…, Validate player and persistence availability. (+27 more)

### Community 136 - "build_event"
Cohesion: 0.04
...
### Community 137 - ".state"
Cohesion: 0.05
Nodes (75): _app_state_container_service(), Resolve persistence and connection manager from request., resolve_state(), FastAPI/Starlette application (or duck-typed equivalent)., _apply_grounding_adjustment(), _complete_ground_command(), _get_ground_services(), handle_ground_command() (+67 more)
...
### Community 141 - "ChatService"
Cohesion: 0.02
Nodes (103): ChatService, UUID, Chat service for handling real-time communication between players. This service…, Normalize player identifiers to string form., Send a local message to players in the same sub-zone. This method publishes the…, Send a global message to all players. This method publishes the global message…, Send a party (ephemeral group) chat message. Only current party members receive…, Send a system message to all players. This method publishes the system message… (+95 more)

### Community 142 - "SpellEffectType"
Cohesion: 0.03
Nodes (139): Spell targeting service for resolving spell targets. This module handles target…, BaseModel, StrEnum, Spell data models for the magic system. This module contains Pydantic models…, Valid target types for spells., Valid range types for spells., Valid effect types for spells., Material component required for casting a spell. (+131 more)
...
### Community 144 - "test_quest_definition_repository.py"
Cohesion: 0.07
Nodes (39): QuestDefinition, Quest template: id (PK), definition JSONB, timestamps., Any, QuestDefinitionRepository, Return quest IDs offered by the given entity (npc or room)., Map procedure result row to QuestDefinition model., Repository for quest_definitions and quest_offers (read-only for offers)., Load a quest definition by id. Returns None if not found. (+31 more)
...
### Community 146 - "PhantomHostileService"
Cohesion: 0.09
Nodes (28): handle_fake_hallucination(), handle_hallucination_triggers(), handle_phantom_hostile_hallucination(), AsyncSession, UUID, Hallucination trigger handling for passive lucidity flux., Check and handle time-based hallucination triggers., Handle phantom hostile spawn hallucination. (+20 more)

### Community 147 - "persistence/container_persistence.py"
Cohesion: 0.06
Nodes (72): Composed, build_update_query(), _coerce_row_quantity(), fetch_container_items(), _item_dict_from_contents_row(), _metadata_dict_from_cell(), parse_jsonb_column(), datetime (+64 more)

### Community 148 - "test_room_class.py"
Cohesion: 0.05
Nodes (43): Unit tests for Room class. Tests the Room class methods for managing room…, Test Room.remove_player_silently() removes player without event., Test Room.player_left() removes player and triggers event., Test Room.object_added() adds object to room., Test Room.npc_entered() adds NPC to room., Test Room.npc_left() removes NPC from room., Test Room initialization with room data., Test Room.get_players() returns list of player IDs. (+35 more)

### Community 149 - "test_connection_session_management.py"
Cohesion: 0.04
Nodes (102): Handle a new game session by disconnecting existing connections., ConnectionMetadata, Data models for connection management. This module defines data structures used…, Metadata for tracking connection details in the WebSocket-only system. This…, _cleanup_old_session_tracking(), _cleanup_player_data_for_session(), _disconnect_all_connections_for_session(), _disconnect_connection_for_session() (+94 more)

### Community 150 - "PlayerCombatService"
Cohesion: 0.03
Nodes (93): Get base stats as dictionary., Attach or replace the player combat service (shared instance wiring)., PlayerCombatService, PlayerCombatState, UUID, Attach NPC combat integration for UUID/XP mapping (post-construction wiring)., Track a player's combat state. Args: player_id: ID of the player player_name:…, Get a player's combat state. Args: player_id: ID of the player Returns:… (+85 more)
...
### Community 152 - "test_connection_statistics.py"
Cohesion: 0.06
...
### Community 153 - "test_message_queue.py"
Cohesion: 0.05
Nodes (43): Unit tests for message queue. Tests the message_queue module classes and…, Test MessageQueue.get_messages() retrieves and clears messages., Test MessageQueue.get_messages() returns empty list for player with no messages., Test MessageQueue.__init__() with default values., Test MessageQueue.has_messages() returns True when player has messages., Test MessageQueue.has_messages() returns False when player has no messages., Test MessageQueue.get_message_count() returns correct count., Test MessageQueue.get_message_count() returns 0 for player with no messages. (+35 more)

### Community 154 - "test_websocket_handler_helpers_extended.py"
Cohesion: 0.05
Nodes (51): mock_connection_manager(), mock_validator(), mock_websocket(), asyncio, fixture, Extended unit tests for websocket handler helper functions. Tests additional…, Test _send_error_response() returns False for RuntimeError indicating…, Test _send_error_response() returns True for other errors. (+43 more)

### Community 155 - "quest_commands.py"
Cohesion: 0.07
Nodes (49): _active_npc_ids_in_room(), _emit_npc_lines_for_results(), _format_goal_line(), _format_one_quest_entry(), _format_quest_action_results(), _format_quest_log(), _get_container_and_persistence(), _get_quest_service() (+41 more)
...
### Community 158 - ".connection_manager"
Cohesion: 0.05
Nodes (25): Check connection state before publishing combat ended event., _CombatServiceDeps, _ConnectionManagerLike, _NPCCombatIntegrationLike, Protocol, UUID, Create corpse container when player dies., Best-effort connection diagnostics before publishing NPC death event. (+17 more)

### Community 159 - "test_command_helpers.py"
Cohesion: 0.05
...
### Community 160 - "ContainerTransferToMixin"
Cohesion: 0.09
Nodes (34): items_json_for_persist(), player_inventory_for_response(), InventoryStack, Narrow InventoryStack TypedDict rows for persistence dict[str, object] APIs., Read player.inventory (tests/mocks) as typed stacks; empty if missing., ContainerTransferFromMixin, ContainerComponent, InventoryStack (+26 more)
...
### Community 162 - "CombatCommandHandler"
Cohesion: 0.03
Nodes (118): CombatCommandHandler, CombatCommandHandlerExtras, Any, AppWithState, ConnectionManager, Combat service for command modules., Movement service for command modules., Player position service for command modules. (+110 more)
...
### Community 165 - "ConnectionManager"
Cohesion: 0.02
Nodes (101): ConnectionManager, Player, UUID, WebSocket, Check if a WebSocket is open., Check if a WebSocket ID is in the closed set., Mark a WebSocket ID as closed., Get the count of closed WebSocket IDs being tracked. (+93 more)

### Community 166 - "test_rest_and_grace_period.py"
Cohesion: 0.07
...
### Community 167 - "CorpseLifecycleService"
Cohesion: 0.08
...
### Community 169 - "TargetResolutionService"
Cohesion: 0.02
Nodes (138): Teach command handler for learning spells from NPC teachers. This module…, _resolve_npc_teacher(), Shared schemas: base models, target resolution, inventory validation., BaseModel, Target metadata schema for MythosMUD. This module defines Pydantic models for…, Metadata about a target in target resolution. This model represents additional…, TargetMetadata, BaseModel (+130 more)

### Community 170 - "PlayerRoomEventHandler"
Cohesion: 0.08
Nodes (27): OccupantSnap, _as_map(), _as_occupant_snap(), PlayerRoomEventHandler, JsonMap, UUID, Handles room-related player events (entered, left, occupants)., Initialize room event handler from a deps bundle. (+19 more)
...
### Community 174 - "lifespan_magic.py"
Cohesion: 0.03
Nodes (83): _initialize_magic_service(), initialize_magic_services(), _initialize_mp_regeneration_service(), _initialize_spell_effects(), _initialize_spell_learning_service(), _initialize_spell_registry(), _initialize_spell_repositories(), _initialize_spell_targeting_service() (+75 more)
...
Cohesion: 0.05
Nodes (53): PerformanceStats, ExceptionStats, Statistics for exception tracking., __getattr__(), Any, Monitoring package for MythosMUD server., Lazy import for modules that require numpy., Alert (+45 more)

### Community 177 - "test_websocket_handler_validation_errors.py"
Cohesion: 0.05
Nodes (52): handle_chat_message(), Handle a chat message from a player. Args: websocket: The WebSocket connection…, Test handle_chat_message handles chat message., test_handle_chat_message(), asyncio, Unit tests for WebSocket handler validation, rate limiting, and error paths.…, _validate_message should pass expected token from connection metadata into…, When metadata.token is missing, validate JWT from message and restore metadata. (+44 more)

### Community 178 - "CastingStateManager"
Cohesion: 0.06
Nodes (41): CastingStateManager, Any, UUID, Casting state manager for tracking active spell castings. This module manages…, Check if a player is currently casting. Args: player_id: Player ID to check…, Get the casting state for a player. Args: player_id: Player ID Returns:…, Complete and remove a casting state. Args: player_id: Player ID Returns:…, Interrupt and remove a casting state. Args: player_id: Player ID Returns:… (+33 more)

### Community 179 - "._damage_player_inner"
Cohesion: 0.12
...
### Community 180 - "test_admin_teleport_commands.py"
Cohesion: 0.16
...
Cohesion: 0.03
Nodes (71): party_service(), asyncio, fixture, Unit tests for PartyService. Covers: create_party, disband_party, add_member,…, Accepting a party invite adds the player to the party., Declining removes pending invite and does not add to party., Request fails if target is already in a party., Member can leave; party remains. (+63 more)
...
### Community 183 - "LootAllRequest"
Cohesion: 0.10
Nodes (27): get_container_and_player_for_loot_all(), ContainerComponent, InventoryStack, Get container and player data for loot_all operation., Transfer all items from container to player, returning updated container and…, transfer_all_items_from_container(), LootAllRequest, Request model for looting all items from a container. (+19 more)

### Community 184 - "test_hallucination_services.py"
Cohesion: 0.08
Nodes (37): HallucinationFrequencyService, Any, AsyncSession, UUID, Check if hallucination should trigger on room entry (Uneasy tier). Args:…, Check if hallucination should trigger based on time (Fractured/Deranged tiers).…, Service for managing hallucination frequency checks based on player tier., Initialize the hallucination frequency service. (+29 more)

### Community 185 - "MovementService"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (43): E2E_PROJECT_ROOT, assertCommandChannelReady(), EnsurePlayableConnectionOptions, getLivePageForUsername(), isPageUsable(), isUsernameLoginVisible(), livePagesByUsername, loginPlayer() (+35 more)

### Community 189 - "NATSMessageSubscriptionMixin"
Cohesion: 0.06
Nodes (23): NATSMessageSubscriptionMixin, Any, Mixin: room, subzone, and event NATS subscription lifecycle., Subscribe to chat messages for a specific room. Args: room_id: Room ID to…, Subscribe to all event-related NATS subjects using standardized patterns.…, Unsubscribe from all event-related NATS subjects using standardized patterns.…, Get mapping of event types to their handler methods., Validate that event message has required fields. (+15 more)

### Community 190 - "test_active_lucidity_service.py"
Cohesion: 0.03
Nodes (122): _check_debrief_availability(), _complete_debrief(), _generate_narrative_recap(), _get_catatonia_registry_from_app(), _get_persistence_from_app(), handle_debrief_command(), _perform_therapy_if_requested(), Any (+114 more)

### Community 191 - "test_player_disconnect_handlers.py"
Cohesion: 0.05
Nodes (66): Disconnect grace period management for MythosMUD. This module handles the…, _cleanup_player_references(), _collect_disconnect_keys(), _get_session_maps_for_age_off(), handle_player_disconnect_broadcast(), _purge_expired_sessions_from_maps(), Player, UUID (+58 more)
...
Cohesion: 0.04
Nodes (39): Event subscription setup for application startup. Extracted from…, Subscribe to RoomOccupantsRefreshRequested so Occupants panel updates after NPC…, Subscribe to room events for quest triggers and progress (start on enter,…, subscribe_quest_events(), subscribe_room_occupants_refresh(), PlayerMortallyWoundedEvent, QuestCompleted, Initialize the event with proper type. (+31 more)

### Community 194 - "test_websocket_handler_coverage_gaps.py"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (37): ExceptionRecord, ExceptionTracker, ExceptionTrackInput, get_exception_tracker(), Any, Exception, Track an exception with full context information. Args: exception: The…, Get an exception record by ID. Args: exception_id: Unique exception ID Returns:… (+29 more)

### Community 197 - "test_combat_messaging_integration.py"
Cohesion: 0.04
Nodes (65): messaging_integration(), mock_connection_manager(), asyncio, fixture, Unit tests for combat messaging integration. Tests the…, Test broadcast_combat_attack handles personal message errors gracefully., Test broadcast_combat_death broadcasts death event., Test broadcast_combat_ended broadcasts combat ended event. (+57 more)

### Community 198 - "test_party_commands.py"
Cohesion: 0.08
...
### Community 201 - "test_communication_commands_flows.py"
Cohesion: 0.03
...
### Community 203 - "test_character_creation_service.py"
Cohesion: 0.03
...
### Community 205 - "test_lucidity_event_dispatcher.py"
Cohesion: 0.04
Nodes (108): _dispatch_player_event(), _format_liabilities(), LucidityChangeEventExtras, LiabilityStackEntry, UUID, Helpers for broadcasting lucidity-related SSE events., Emit a catatonia state event to the affected player., Send rescue progress/status updates to either participant. (+100 more)

### Community 206 - "test_connection_helpers_impl.py"
Cohesion: 0.10
Nodes (29): broadcast_room_event_impl(), Broadcast a room-specific event to all players in the room., Send event to all active websockets for a player. Args: player_id: The player's…, _send_to_websockets(), mock_manager(), asyncio, fixture, Unit tests for connection helpers implementation functions. Tests the… (+21 more)

### Community 207 - "test_metrics_endpoints.py"
Cohesion: 0.06
...
### Community 209 - "ValidationError"
Cohesion: 0.00
Nodes (1230): Data validation errors (e.g. empty local/whisper message). Log at warning, not…, ValidationError, GotoCommand, NPCCommand, field_validator, Admin command models for MythosMUD. This module provides command models for…, Command for shutting down the server (admin only). Args can be: - Empty:…, Command for NPC administrative utilities with subcommands. (+1222 more)

### Community 210 - "ChatMessage"
Cohesion: 0.11
Nodes (38): ChatMessage, Any, Represents a chat message with metadata., Convert message to dictionary for serialization., Log this chat message to the communications log., _attr(), _ctx(), _player() (+30 more)

### Community 211 - "TestCombatConfigurationService"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (57): PlayerOccupantProcessor, Any, UUID, Player occupant processing utilities. This module handles querying and…, Process players and convert to occupant information. Args: room_id: The room ID…, Processes player occupants for rooms., Initialize player occupant processor. Args: connection_manager:…, Ensure a player is included in the player ID strings list if specified. Args:… (+49 more)
...
### Community 214 - "asyncio"
Cohesion: 0.09
Nodes (23): asyncio, Test restore_mp_from_rest() returns message when MP already at max., Test restore_mp_from_rest() restores MP., Test restore_mp_from_rest() calculates max_mp from power if not present., Test restore_mp_from_meditation() returns error when player not found., Test restore_mp_from_meditation() returns message when MP already at max., Test restore_mp_from_item() restores MP., Test restore_mp_from_item() respects max_mp limit. (+15 more)

### Community 215 - "_handle_admin_set_stat_command"
Cohesion: 0.05
...
### Community 216 - "GameClientV2.tsx"
Cohesion: 0.04
Nodes (89): GameTerminalProps, computeLucidityBar(), formatChange(), LucidityChangeFooter(), LucidityMeter, LucidityMeterBody(), LucidityMeterProps, TIER_DESCRIPTIONS (+81 more)

### Community 217 - "NATSMessageBroker"
Cohesion: 0.07
...
### Community 219 - "player_combat_service_support.py"
Cohesion: 0.07
...
### Community 220 - "test_level_service.py"
Cohesion: 0.05
...
### Community 221 - "AdminActionsLogger"
Cohesion: 0.07
...
### Community 225 - "_run_set_map_origin"
Cohesion: 0.09
Nodes (35): _persist_map_origin(), AsyncSession, BaseModel, post, Request, Admin-only coordinate regenerate + validate for a zone., Trigger coordinate recalculation for a zone/subzone (admin only)., Request model for setting map origin. (+27 more)

### Community 226 - "test_map_helpers.py"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (41): devDependencies, cross-env, eslint-plugin-playwright, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals, jsdom, knip (+33 more)

### Community 229 - "GameClientV2ContainerView.tsx"
Cohesion: 0.04
Nodes (72): DeathInterstitial(), DeathInterstitialProps, DeliriumInterstitial(), DeliriumInterstitialProps, MainMenuModal(), MainMenuModalProps, MapView(), MapViewBody() (+64 more)

### Community 230 - "MemoryMonitor"
Cohesion: 0.08
...
### Community 231 - "WearableContainerService"
Cohesion: 0.11
...
### Community 233 - "test_passive_lucidity_flux_service.py"
Cohesion: 0.13
Nodes (32): PassiveLucidityFluxService, FluxServiceConfig, Optional configuration for PassiveLucidityFluxService. All fields have defaults., PassiveFluxContext, Resolved environmental context for passive flux evaluation., _make_service(), asyncio, Unit tests for PassiveLucidityFluxService. (+24 more)

### Community 234 - "is_player_in_login_grace_period"
Cohesion: 0.04
Nodes (97): Get login grace period status for player., cancel_login_grace_period(), get_login_grace_period_remaining(), is_player_in_login_grace_period(), Start LOGIN_WARDED via effects (ADR-009) or a legacy asyncio timeout task., Cancel login grace period for a player (if needed). For effect-based grace…, Check if a player is currently in login grace period. Args: player_id: The…, Get the remaining time in seconds for a player's login grace period. Args:… (+89 more)

### Community 235 - "test_goto_helpers.py"
Cohesion: 0.12
...
### Community 236 - "MessageQueue"
Cohesion: 0.01
Nodes (210): _apply_disconnect_side_effects(), _cleanup_connection_tracking(), _cleanup_fully_disconnected_player(), _cleanup_player_data(), _cleanup_room_subscriptions(), cleanup_websocket_disconnect(), _close_and_untrack_websockets(), disconnect_all_websockets_impl() (+202 more)
...
### Community 239 - "npc_config_parsing.py"
Cohesion: 0.06
...
Cohesion: 0.09
Nodes (38): fetchSpy, useMapLayout(), buildRoomListRequest(), FetchRoomListConfig, fetchRoomListData(), parseRoomListResponse(), useRoomMapData(), UseRoomMapDataResult (+30 more)

### Community 241 - "canonical_room_id_impl"
Cohesion: 0.10
Nodes (28): canonical_room_id_impl(), prune_player_from_all_rooms_impl(), Any, Resolve a room id to the canonical Room.id value. Args: room_id: The room ID to…, Ensure room_occupants only contains currently online players., Remove a player from all room subscriptions and occupant lists., reconcile_room_presence_impl(), Unit tests for connection room utils. Tests the connection_room_utils module… (+20 more)
...
### Community 243 - "server/dependencies.py"
Cohesion: 0.01
Nodes (205): LevelUpHook, Wire player/room/user, container, skill, level, and quest services., get_async_persistence(), get_catatonia_registry(), get_chat_service(), get_combat_service(), get_connection_manager(), get_container() (+197 more)

### Community 244 - "look_command.py"
Cohesion: 0.05
Nodes (80): _app_from_request(), _as_response(), _connection_manager_from_app(), _container_from_app(), _get_app_and_persistence(), _get_room_drops(), _handle_implicit_target_lookup(), handle_look_command() (+72 more)

### Community 245 - "PrototypeRegistryError"
Cohesion: 0.08
Nodes (31): ItemInstance, Item system package. This module exposes the prototype schema and registry…, ItemFactory, ItemFactoryError, Any, Exception, PrototypeRegistry, Item factory for creating item instances from prototypes. This module provides… (+23 more)
...
Cohesion: 0.04
Nodes (66): IdleMovementHandler, Core gating for idle movement (interval handled by scheduler)., Check if NPC is in combat via UUID lookup. Args: npc_id: NPC ID (string or…, Check if NPC is in combat via string ID mapping. Args: npc_id: NPC ID as string…, Check if an NPC is currently in combat. Args: npc_instance: The NPC instance to…, Handler for NPC idle movement logic. This class manages the decision-making and…, patch, Unit tests for idle movement. Tests the IdleMovementHandler class. (+58 more)
...
### Community 249 - "start_grace_period"
Cohesion: 0.09
...
### Community 251 - "MythosTickScheduler"
Cohesion: 0.04
Nodes (59): HolidayResolver, mock_chronicle(), mock_event_bus(), mock_task_registry(), asyncio, fixture, Unit tests for MythosTickScheduler., scheduler() (+51 more)
...
### Community 254 - "connection_establishment.py"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (32): Party, PartyService, Any, ConnectionManager, UUID, Party service for MythosMUD. In-memory ephemeral party state: parties exist…, Create a new party with the given player as leader. Returns dict with success…, Disband a party. If by_player_id is given, only the leader may disband. If… (+24 more)

### Community 256 - "DistributedEventBus"
Cohesion: 0.11
Nodes (25): DistributedEventBus, EventBus that distributes domain events via NATS for horizontal scaling. When…, Publish event locally and to NATS when bridge is active., Shutdown EventBus and stop NATS bridge., distributed_bus(), asyncio, fixture, Unit tests for DistributedEventBus. (+17 more)
...
### Community 259 - "test_message_handlers.py"
Cohesion: 0.08
...
### Community 260 - "test_connection_error_methods.py"
Cohesion: 0.10
...
### Community 261 - "PersonalMessageSender"
Cohesion: 0.21
Nodes (18): PersonalMessageSender, Sends personal messages to individual players. This class provides: - Personal…, asyncio, fixture, LogCaptureFixture, Unit tests for PersonalMessageSender., E2E teardown: send after client drop must not warn., Occupancy/who/chat ride the full player_websockets list (#610). (+10 more)
...
### Community 263 - "PlayerRespawnService"
Cohesion: 0.06
Nodes (34): Small types shared by CombatService wiring., _PlayerCombatClearing, PlayerRespawnService, AsyncSession, Player, Protocol, UUID, _RandomChoiceSource (+26 more)

### Community 264 - "npc_database.py"
Cohesion: 0.03
Nodes (101): configure_pool_settings(), get_asyncpg_server_settings_for_database_url(), get_postgres_connect_args(), normalize_database_url(), Database configuration helper functions. This module provides utility functions…, Build connect_args for asyncpg when POSTGRES_SEARCH_PATH is set. Used so unit…, Build asyncpg ``server_settings`` so unqualified table names resolve like…, Configure pool settings based on database URL and config. When full config is… (+93 more)

### Community 265 - "test_player_repository.py"
Cohesion: 0.04
...
### Community 268 - "NPCOccupantProcessor"
Cohesion: 0.11
...
### Community 270 - "MessageFilteringHelper"
Cohesion: 0.08
...
### Community 271 - "MemoryLeakMetricsCollector"
Cohesion: 0.11
Nodes (19): Get or create MemoryLeakMetricsCollector instance. Returns:…, _resolve_memory_leak_collector(), MemoryLeakMetricsCollector, Any, Collect event metrics from EventBus. Returns: Dictionary with event metrics, Collect cache metrics from CacheManager. Returns: Dictionary with cache metrics, Collect task metrics from TaskRegistry. Returns: Dictionary with task metrics, Collect NATS subscription metrics from NATSService. Returns: Dictionary with… (+11 more)
...
### Community 276 - "NPCStartupService"
Cohesion: 0.14
...
### Community 278 - "deque"
Cohesion: 0.07
Nodes (23): deque, Initialize the memory leak metrics collector., Any, Clean up old messages to prevent memory bloat. Args: max_age_seconds: Maximum…, Clean up large data structures to prevent memory bloat. Args: max_entries:…, Check if a message is recent (within the specified age limit). Args: msg:…, Get message queue statistics. Returns: Dict[str, Any]: Statistics about the…, Add a message to a player's pending message queue. Args: player_id: The… (+15 more)

### Community 279 - "test_combat_attack_handler.py"
Cohesion: 0.04
...
### Community 280 - "GameTerminal.tsx"
Cohesion: 0.04
Nodes (47): buildHealthStatus(), ChatMessage, formatPosture(), GameTerminal(), Player, Room, IncapacitatedBanner, IncapacitatedBannerProps (+39 more)

### Community 281 - "JsonMap"
Cohesion: 0.07
...
### Community 283 - "get_session_maker"
Cohesion: 0.02
Nodes (159): get_10_active_invites(), main(), Get 10 active invite codes from the database., F, Initialize the async persistence layer. This facade delegates to focused async…, get_session_maker(), Get the async session maker from DatabaseManager. Returns: async_sessionmaker:…, Gain occult knowledge (with lucidity loss). (+151 more)
...
### Community 285 - "establish_websocket_connection"
Cohesion: 0.17
Nodes (28): establish_websocket_connection(), Establish a new WebSocket connection. Args: websocket: The WebSocket connection…, _as_ws(), _FakeWebSocket, WebSocket, _player_with_room(), asyncio, Unit tests for establish_websocket_connection. Split from… (+20 more)

### Community 286 - "test_endpoints_invites.py"
Cohesion: 0.10
Nodes (29): get_current_active_user, create_invite(), CurrentUserInfo, get_current_user_info(), list_invites(), Depends, get, post (+21 more)

### Community 287 - "WebSocketMessageValidator"
Cohesion: 0.06
Nodes (50): MessageValidationError, BaseModel, Exception, Calculate the maximum nesting depth of a JSON structure. Args: obj: Object to…, Validate that strings in the JSON structure don't exceed length limits. Args:…, Validate message against Pydantic schema. Args: message: Parsed JSON message…, Raised when message validation fails., Return the first string CSRF token from known keys, or None if absent. (+42 more)
...
### Community 290 - "generate_invites.py"
Cohesion: 0.38
...
### Community 291 - "admin_summon_command.py"
Cohesion: 0.08
...
### Community 295 - "InventoryService"
Cohesion: 0.06
Nodes (41): InventoryService, InventorySplitError, InventoryValidationError, Any, Split a stack into two, inserting the new stack immediately after the source…, Extract required fields from stack. Returns: Tuple of (item_instance_id,…, Validate and clone optional fields (metadata, flags, origin, etc.). Args:…, Raised when item payloads are malformed or incomplete. (+33 more)

### Community 296 - "test_message_filtering_helpers.py"
Cohesion: 0.12
...
### Community 299 - "SubjectManagerMetrics"
Cohesion: 0.07
Nodes (22): Any, Performance metrics for NATS Subject Manager operations. This module provides…, Get current metrics summary. Returns: Dictionary containing all metrics, Calculate percentile from list of times. Args: times: List of time measurements…, Reset all metrics to zero., Performance metrics for NATS Subject Manager operations. Tracks validation…, Initialize metrics collection., Record a validation operation. Args: duration: Time taken in seconds success:… (+14 more)

### Community 300 - "player_event_handlers.py"
Cohesion: 0.01
Nodes (329): PlayerDiedEvent, PlayerDPDecayEvent, PlayerDPUpdated, Event fired when a player's DP changes. This event is triggered when a player…, Event fired when a mortally wounded player loses DP due to decay. This event is…, Event fired when a player dies (DP <= -10). This event is triggered when a…, Any, UUID (+321 more)
...
### Community 302 - "test_combat_schema.py"
Cohesion: 0.13
...
### Community 303 - "command_service.py"
Cohesion: 0.03
Nodes (109): _create_alias(), _extract_alias_params(), handle_alias_command(), handle_aliases_command(), handle_unalias_command(), Any, Alias management commands for MythosMUD. This module contains handlers for…, Handle the aliases command for listing all aliases. Args: command_data: Command… (+101 more)

### Community 304 - "InventorySchemaValidationError"
Cohesion: 0.06
Nodes (47): _parse_equipped_raw(), _parse_inventory_raw(), PlayerSavePreparer, Any, datetime, Player, Player save/upsert helpers for PlayerRepository. Handles inventory validation,…, Validate and serialize inventory payload. Returns (inventory_json,… (+39 more)

### Community 305 - "test_npc_combat_handlers.py"
Cohesion: 0.06
Nodes (46): CombatResultCtx, NPCCombatHandlers, NPC Combat Event Handlers. This module handles combat result processing and NPC…, Handle NPC death and related effects., Bundle for handle_combat_result (lizard PARAM)., Handles combat result processing and NPC death operations., Handle combat result, broadcast, and NPC death., mock_combat_memory() (+38 more)
...
Cohesion: 0.05
Nodes (64): NPCCombatIntegration, Integrates NPCs with the existing combat and game mechanics systems. Extends…, Handle NPC death and related effects. Args: npc_id: ID of the dead NPC room_id:…, Get NPC stats or use defaults., integration(), mock_persistence(), asyncio, fixture (+56 more)
...
### Community 311 - "session_factory"
Cohesion: 0.07
Nodes (41): FixtureRequest, Database fixtures for integration tests. This module provides database…, _assert_allowed_integration_test_db(), db_cleanup(), _delete_mutable_integration_test_rows(), _get_db_name_from_url(), integration_db_url(), integration_engine() (+33 more)

### Community 312 - "HolidayService"
Cohesion: 0.02
Nodes (87): Wire holiday/schedule services and Mythos tick scheduler., MythosHourTickEvent, Event fired when the accelerated Mythos clock rolls over to a new hour., _ensure_utc(), _HolidayLoadResult, HolidayService, datetime, TypedDict (+79 more)

### Community 313 - "health_service"
Cohesion: 0.40
Nodes (5): health_service(), mock_connection_manager(), fixture, Create a mock connection manager., Create a HealthService instance.

### Community 314 - "parse_shutdown_parameters"
Cohesion: 0.14
...
### Community 315 - "get_username_from_user"
Cohesion: 0.06
Nodes (66): _get_container(), handle_follow_command(), handle_following_command(), handle_unfollow_command(), _load_follow_context(), Any, Follow commands for MythosMUD. Handlers for /follow, /unfollow, and /following.…, Handle /following - show who you follow and who follows you. (+58 more)

### Community 316 - "quest_service.py"
Cohesion: 0.06
Nodes (52): _apply_holdings(), collect_player_stacks(), _consume_from_equipped(), _consume_from_stack_list(), consume_prototype_from_player(), count_prototype_in_stacks(), _deepcopy_dict_stacks(), _deepcopy_equipped_map() (+44 more)

### Community 317 - "get_admin_auth_service"
Cohesion: 0.03
Nodes (155): cleanup_admin_sessions(), get_admin_audit_log(), get_admin_sessions(), get, post, Request, Get active admin sessions., Clean up expired admin sessions. (+147 more)
...
### Community 323 - "realtime/realtime.py"
Cohesion: 0.13
...
### Community 326 - "game_tick_processing.py"
Cohesion: 0.06
Nodes (70): _handle_player_death_threshold(), _player_in_active_combat(), _process_dead_players(), process_dp_decay_and_death(), _process_mortally_wounded_player(), _process_mortally_wounded_players(), _process_mp_regeneration(), _process_passive_lucidity_flux() (+62 more)

### Community 327 - "request_with_app_container"
Cohesion: 0.04
Nodes (86): handle_me_command(), handle_reply_command(), handle_whisper_command(), Reply to last whisper sender., Shared mock wiring for communication command unit tests., Return (request, container) with request.app.state.container wired. Typed…, request_with_app_container(), asyncio (+78 more)
...
### Community 330 - "TransferContainerRequest"
Cohesion: 0.03
Nodes (85): emit_close_container_event(), emit_container_opened_events(), emit_transfer_event(), ConnectionManager, UUID, Emit WebSocket event for container closing. Args: connection_manager:…, Emit WebSocket events for container opening. Args: connection_manager:…, Emit WebSocket event for transfer operation. Args: connection_manager:… (+77 more)

### Community 331 - "test_chat_npc_system.py"
Cohesion: 0.04
Nodes (88): Initialize chat service., _ChatDeliveryService, deliver_npc_room_speech(), deliver_personal_system(), npc_sender_id(), _on_npc_spoke(), Protocol, UUID (+80 more)
...
Cohesion: 0.08
Nodes (34): Unit tests for room_utils. Tests utility functions for room operations., Test get_subzone_local_channel_subject() generates subject., Test get_subzone_local_channel_subject() returns None for invalid room ID., Test extract_subzone_from_room_id() extracts subzone., Test extract_subzone_from_room_id() extracts different subzone., Test extract_subzone_from_room_id() returns None for invalid format., Test get_zone_from_room_id() extracts zone., Test get_zone_from_room_id() extracts different zone. (+26 more)

### Community 334 - "MovementMonitor"
Cohesion: 0.11
...
### Community 335 - "TestNPCCombatRewards"
Cohesion: 0.08
...
### Community 337 - "PlayerDeathService"
Cohesion: 0.11
...
### Community 339 - "NATSMessageProcessingMixin"
Cohesion: 0.10
...
### Community 341 - "test_lru_cache.py"
Cohesion: 0.07
...
### Community 342 - "test_quest_service_collect.py"
Cohesion: 0.13
...
Cohesion: 0.08
Nodes (44): HolidayBanner(), HolidayBannerProps, MythosTimeHud(), MythosTimeHudProps, TRADITION_COLORS, mythosState, appendDaypartChange(), appendHourChime() (+36 more)
...
### Community 345 - "server/persistence/__init__.py"
Cohesion: 0.13
...
### Community 346 - "TestSanitization"
Cohesion: 0.07
Nodes (15): Test sanitization functions., Test is_safe_detail_key with safe keys., Test is_safe_detail_key with unsafe keys., Test sanitize_detail_value with string., Test sanitize_detail_value with long string., Test sanitize_detail_value with traceback-like string., Test sanitize_detail_value with integer., Test sanitize_detail_value with dictionary. (+7 more)

### Community 347 - "extract_player_name"
Cohesion: 0.13
...
### Community 349 - "test_quest_instance_repository.py"
Cohesion: 0.06
Nodes (55): Base, QuestInstance, QuestOffer, Quest subsystem models: quest_definitions, quest_instances, quest_offers. Maps…, Per-character quest state: one row per player per quest., Junction: links a quest to an NPC or room that offers it., Any, datetime (+47 more)
...
### Community 353 - "AttributeError"
Cohesion: 0.04
Nodes (87): AttributeError, broadcast_room_update(), build_room_update_event(), get_npc_occupants_fallback(), get_npc_occupants_from_lifecycle_manager(), get_player_occupants(), Any, WebSocket room update and broadcast functions for MythosMUD real-time… (+79 more)

### Community 354 - "connection_manager_health_cleanup.py"
Cohesion: 0.05
Nodes (76): check_and_cleanup_impl(), cleanup_dead_connections_impl(), cleanup_ghost_players_impl(), cleanup_orphaned_data_impl(), force_cleanup_impl(), prune_stale_players_impl(), Any, UUID (+68 more)
...
### Community 358 - "test_profession_repository.py"
Cohesion: 0.13
...
### Community 360 - "inventory_get_command.py"
Cohesion: 0.13
...
### Community 361 - "handle_time_command"
Cohesion: 0.20
...
Cohesion: 0.06
Nodes (46): CharacterNameScreenProps, CreateCharacterPayload, MechanicalEffect, Profession, ProfessionCard(), ProfessionCardProps, StatRequirement, ProfessionSelectionContentProps (+38 more)
...
### Community 365 - "multiplayer-colocated.ts"
Cohesion: 0.12
Nodes (26): ensureIthaquaInFoyer(), leaveEasternHallwayWest(), pageShowsEasternHallway(), prepareLocalIsolationPair(), primeBothForCoLocate(), returnAwToFoyerIfInHallway(), softCommand(), waitForLookReflected() (+18 more)
...
### Community 370 - "format_message_content"
Cohesion: 0.11
...
### Community 371 - "get_cached_player"
Cohesion: 0.13
...
### Community 372 - "security.ts"
Cohesion: 0.06
Nodes (40): SafeHtml(), SafeHtmlProps, fetchSpy, mockLogoutHandler, fetchSpy, mockLogoutHandler, collectWindowCandidates(), COMMAND_PROBE_CONFIG (+32 more)
...
### Community 374 - "test_user_manager.py"
Cohesion: 0.08
...
### Community 375 - "test_look_player.py"
Cohesion: 0.03
Nodes (111): _get_lucidity_label(), _get_visible_equipment(), Get descriptive lucidity label based on lucidity percentage. Args: stats:…, Get visible equipment from player, excluding internal/hidden slots. Visible…, _apply_grace_period_labels(), _find_matching_players(), _format_player_look_display(), _get_players_in_room() (+103 more)
...
### Community 382 - "NATSSubjectManager"
Cohesion: 0.03
Nodes (88): get_patterns(), get_subject_manager_dependency(), get_subject_statistics(), PatternsResponse, BaseModel, get, post, NATS Subject Management API Controller for MythosMUD. This module provides REST… (+80 more)

### Community 383 - "NPCCombatLucidity"
Cohesion: 0.06
...
### Community 387 - "TestCombatInitializer"
Cohesion: 0.08
...
### Community 388 - "convert_uuids_to_strings"
Cohesion: 0.11
...
### Community 392 - "test_calendar.py"
Cohesion: 0.10
...
Cohesion: 0.05
Nodes (56): CharacterCardProps, CharacterSelectionScreenProps, AuthSlice, authSliceReducer(), creationSliceReducer(), INITIAL_AUTH_SLICE, INITIAL_CREATION_SLICE, PendingSkillsPayload (+48 more)

### Community 397 - "TestCombatMessagingService"
Cohesion: 0.08
Nodes (19): asyncio, Test get_death_message with custom template., Test get_combat_start_messages generates messages for all occupants., Test get_combat_start_messages with single occupant., Test get_combat_end_messages generates messages for all occupants., Test suite for CombatMessagingService class., Test get_combat_end_messages from winner perspective., Test get_combat_end_messages from loser perspective. (+11 more)
...
### Community 401 - "test_combat_integration_base.py"
Cohesion: 0.13
...
### Community 403 - "PrototypeRegistry"
Cohesion: 0.13
Nodes (21): PrototypeRegistry, Any, Path, ValidationError, Get all prototypes in the registry. Returns: Iterable[ItemPrototypeModel]: An…, Get all invalid entries that failed validation. Returns: list[dict]: List of…, In-memory registry for validated item prototypes., Load prototypes from a directory of JSON files. (+13 more)

### Community 404 - "bundles/game.py"
Cohesion: 0.02
Nodes (129): _check_holiday_coverage(), _get_calendar_paths(), _load_and_validate_holidays(), load_document_ids(), main(), parse_args(), _print_errors(), _print_success_message() (+121 more)
...
### Community 406 - "._build_player_attacked_event"
Cohesion: 0.11
...
### Community 407 - "ConnectionCleaner"
Cohesion: 0.15
...
### Community 408 - "CombatBroadcastMixin"
Cohesion: 0.13
...
### Community 409 - "EnvironmentalContainerLoader"
Cohesion: 0.12
...
### Community 414 - "test_combat_persistence_handler_events.py"
Cohesion: 0.06
...
### Community 417 - "test_logging_file_setup.py"
Cohesion: 0.14
...
### Community 418 - "CombatPersistenceHandler"
Cohesion: 0.05
...
### Community 424 - "edgeModalLogic.ts"
Cohesion: 0.21
...
### Community 434 - "test_game_tick_processing.py"
Cohesion: 0.04
Nodes (79): cleanup_decayed_corpses(), _cleanup_single_decayed_corpse(), _CorpseLike, _create_corpse_lifecycle_service(), _log_cleanup_results(), FastAPI, Protocol, Decayed corpse cleanup for the game tick loop. (+71 more)

### Community 435 - "StatisticsAggregator"
Cohesion: 0.12
...
### Community 436 - "test_inventory_mutation_guard.py"
Cohesion: 0.07
...
### Community 438 - "test_memory_profiler.py"
Cohesion: 0.09
Nodes (21): Unit tests for memory profiler utilities. Tests the MemoryProfiler class…, Test MemoryProfiler.get_memory_usage_summary() returns summary., Test MemoryProfiler.print_memory_summary() doesn't raise., Test MemoryProfiler.measure_model_deserialization() returns stats., Test MemoryProfiler.compare_models_memory_usage() aggregates stats., Test MemoryProfiler.print_comparison_results() prints stats block., Test MemoryProfiler.start_profiling() sets baseline., Test MemoryProfiler.stop_profiling() stops tracemalloc. (+13 more)
...
### Community 440 - "bind_request_context"
Cohesion: 0.07
Nodes (34): correct_request_context(), Demonstrate correct request context binding., add_request_context(), process_websocket_message(), websocket, WebSocket endpoint with enhanced logging., Background task for player update with enhanced logging., Add request context to all log entries using enhanced logging. (+26 more)
...
### Community 442 - "test_inventory_mutation_guard_async.py"
Cohesion: 0.17
...
### Community 445 - "InventoryCommandFactory"
Cohesion: 0.03
Nodes (100): Unit tests for inventory command factory helper functions. Tests the helper…, Test create_equip_command() with item name and inferred slot., Test create_unequip_command() with slot., Test create_unequip_command() with item name., Test create_inventory_command() creates InventoryCommand., Test create_inventory_command() raises error with args., Test create_pickup_command() with numeric index., Test create_pickup_command() with quantity. (+92 more)
...
### Community 447 - "chat_channel_message_senders.py"
Cohesion: 0.13
...
### Community 448 - "NPCThreadManager"
Cohesion: 0.04
...
### Community 451 - "get_user_manager"
Cohesion: 0.11
Nodes (18): get_user_db(), get_user_manager(), AsyncSession, Depends, get_async_session, Response, UUID, Get user database dependency. (+10 more)
...
### Community 456 - "handle_game_command"
Cohesion: 0.10
Nodes (21): _broadcast_command_room_if_needed(), handle_game_command(), WebSocket, Handle a game command from a player. Args: websocket: The WebSocket connection…, Broadcast command_response to room when result requests it., _send_invalid_command_empty(), test_handle_game_command_empty_sends_invalid_error(), Test handle_game_command processes game command. (+13 more)

### Community 457 - "dialogue_definitions_api.py"
Cohesion: 0.06
Nodes (55): create_dialogue_definition(), delete_dialogue_definition(), get_dialogue_definition(), list_dialogue_definitions(), delete, get, post, put (+47 more)

### Community 458 - "HealthService"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (40): UseCommandHandlersParams, ThrowingWebSocket, connectOpenAndRunPingInterval(), defaultOptions, latestWebSocketInstance, { mockResourceManager, fetchSpy, mockedSetInterval, mockedClearInterval }, MockWebSocket, wsConnectionAfterEach() (+32 more)
...
### Community 469 - "ChatChannelLoggerMixin"
Cohesion: 0.10
...
### Community 470 - "Player"
Cohesion: 0.06
Nodes (39): Player, Pydantic Player model for game logic and validation. This is separate from the…, Add an item to the player's inventory. Args: item_id: Unique identifier for the…, Remove an item from the player's inventory. Args: item_id: Unique identifier…, Add a status effect to the player. Args: effect: StatusEffect to add, Get all currently active status effects. Args: current_tick: Current game tick…, Update the last_active timestamp to current time., Check if the player can carry additional weight. Args: weight: Weight in pounds… (+31 more)

### Community 471 - "ui-v2/types.ts"
Cohesion: 0.04
Nodes (104): PanelManager(), PanelManagerProps, GameClientV2AuxiliaryPanels(), renderCharacterInfoPanel(), renderCommandHistoryPanel(), renderCommandInputPanel(), renderMinimapPanel(), minimapBackdropLayout() (+96 more)

### Community 472 - "test_message_builders.py"
Cohesion: 0.14
...
### Community 474 - "seed_e2e_users.py"
Cohesion: 0.29
...
### Community 475 - "CombatService"
Cohesion: 0.01
Nodes (230): get_config(), Get application configuration (singleton in production, fresh in tests). In…, CombatStartedEvent, NPCAttackedEvent, NPCDiedEvent, NPCTookDamageEvent, PlayerAttackedEvent, Combat-specific events for the MUD. This module defines combat-related events… (+222 more)

### Community 476 - "e2e-bootstrap.ts"
Cohesion: 0.17
Nodes (25): appendBootstrapFailureLog(), countProfessionsPayload(), __dirname, E2E_BOOTSTRAP_ERRORS_LOG, E2E_BOOTSTRAP_LOG_DIR, E2E_CLIENT_URL, E2E_ENV_DEFAULTS, E2E_SERVER_URL (+17 more)
...
### Community 481 - "test_config_model_helpers.py"
Cohesion: 0.12
...
### Community 483 - "test_cache_service.py"
Cohesion: 0.18
Nodes (10): ProfessionCacheService, Service for caching profession data., Invalidate all profession caches., Reset the global cache manager (for testing)., reset_cache_manager(), _Profession, fixture, Unit tests for server.caching.cache_service. (+2 more)
...
### Community 488 - "test_metadata.py"
Cohesion: 0.11
...
### Community 489 - "test_mp_regeneration_service.py"
Cohesion: 0.11
Nodes (17): Unit tests for MP regeneration service. Tests the MPRegenerationService class…, Test _get_regen_multiplier() returns 1.0 for standing position., Test _get_regen_multiplier() returns REST multiplier for sitting., Test _get_regen_multiplier() returns enhanced REST multiplier for lying., Test _get_regen_multiplier() defaults to 1.0 when position not specified., Test restore_mp_from_meditation() restores MP., Test restore_mp_from_meditation() restores more MP than rest., Test MPRegenerationService initialization. (+9 more)
...
### Community 494 - "quality_fragmentation_ai_guardrails.py"
Cohesion: 0.10
...
### Community 496 - "GameLogPanel.tsx"
Cohesion: 0.04
Nodes (56): GameTerminalPresentation(), GameTerminalPresentationProps, ChatPanel(), GameLogListMessage, GameLogMessagesList(), GameLogMessagesListProps, GameLogPanel(), GameLogPanelProps (+48 more)
...
### Community 498 - "InventoryMutationGuard"
Cohesion: 0.09
Nodes (20): _AsyncPlayerGuardState, InventoryMutationGuard, _PlayerGuardState, Acquire sync mutation guard., Acquire async mutation guard., Get or create per-player guard state for sync contexts. Uses thread-safe…, Get or create per-player guard state for async contexts. Uses async lock to…, Clean up per-player guard state when no longer needed (sync context). Removes… (+12 more)

### Community 499 - "test_shutdown_process_termination.py"
Cohesion: 0.08
...
### Community 500 - "command_result_text"
Cohesion: 0.05
Nodes (87): Remove or update item quantity in player inventory after transfer., remove_item_from_inventory(), handle_pickup_command(), Move an item stack from room drops into the player's inventory., handle_put_command(), _put_resolve_container_id(), _put_run_validated(), _put_transfer_finish() (+79 more)

### Community 501 - "coerce_int"
Cohesion: 0.03
Nodes (61): Parse numeric fields from object-typed JSON command payloads., Get player stats as dictionary. Returns a MutableDict instance that…, Set player stats from dictionary. Accepts both plain dict and MutableDict…, Check if player is alive (DP > 0)., Check if player is mortally wounded (0 >= DP > -10). Returns: True if player…, Check if player is dead (DP <= -10). Returns: True if player has -10 DP or below, Get player's current health state. Returns: "alive" if DP > 0…, Get stats used for combat participant creation. Returns current_dp, max_dp, and… (+53 more)
...
### Community 504 - "test_email_utils.py"
Cohesion: 0.19
...
### Community 507 - "ContainerRepository"
Cohesion: 0.10
...
### Community 511 - "combat_service_npc.py"
Cohesion: 0.05
...
### Community 512 - "ansiToHtml.ts"
Cohesion: 0.13
Nodes (21): ChatMessage(), ChatMessageProps, formatTimestamp(), getFontSizeClass(), getMessageClass(), ChatHistoryMessageBody(), chatMessageVisibleInGameInfo(), GAME_INFO_CHAT_CHANNELS (+13 more)

### Community 513 - "CoordinateValidator"
Cohesion: 0.14
...
### Community 517 - "BaseEvent"
Cohesion: 0.04
Nodes (67): ModuleType, Distributed EventBus that uses NATS for cross-instance event distribution.…, Get the number of subscribers for a specific event type. Args: event_type: The…, _convert_value_for_json(), _convert_value_from_json(), _copy_public_event_attrs(), deserialize_event(), _event_class_from_payload() (+59 more)
...
### Community 519 - "MessageBroadcaster"
Cohesion: 0.10
...
### Community 520 - "test_combat_grace_period.py"
Cohesion: 0.14
...
### Community 527 - "get_npc_name_from_instance"
Cohesion: 0.17
...
### Community 528 - "waitForMessage"
Cohesion: 0.24
Nodes (19): despawnArmitage(), DIALOGUE, ensureArmitagePresent(), listArmitageIds(), loginAdminPlayable(), executeCommandWithoutRecovery(), waitForMessage(), abandonCollectNQuest() (+11 more)
...
Cohesion: 0.09
Nodes (20): LucidityFluxService, PlayerFluxCtx, AsyncSession, datetime, Player, Build room cache for all players., Process a single player's passive flux., Evaluate passive LCD flux for the current tick. (+12 more)
...
### Community 539 - "handle_skills_command"
Cohesion: 0.12
Nodes (23): _format_skills_output(), _get_container_services(), handle_skills_command(), Any, UUID, Get container, persistence, and skill_service from request, or None if…, Extract and validate player_id from player object, returning UUID or None., Resolve user_id from current_user (auth user) or fallback to player.user_id. (+15 more)

### Community 540 - "test_inventory_helpers.py"
Cohesion: 0.03
Nodes (93): build_drop_candidates(), build_equipped_candidates(), build_inventory_candidates(), clean_item_value(), extract_item_identifier(), match_equipped_item_by_name(), match_exact_drop(), match_inventory_item_by_name() (+85 more)
...
### Community 542 - "validate_secure_path"
Cohesion: 0.08
...
### Community 543 - "create_hasher_with_params"
Cohesion: 0.12
...
### Community 549 - "test_message_filtering.py"
Cohesion: 0.04
...
### Community 550 - "pytest.md"
Cohesion: 0.01
Nodes (405): Base, DeclarativeBase, Shared SQLAlchemy DeclarativeBase for all models. This module provides a single…, Shared declarative base for all MythosMUD models. All models (User, Player,…, NPCScheduleModel, SQLAlchemy models for calendar data (holidays and NPC schedules)., Dialogue subsystem model: dialogue_definitions (NPC talk trees, #583)., EmoteAlias (+397 more)

### Community 551 - "ContainerLockMixin"
Cohesion: 0.20
...
### Community 555 - "test_rate_limiter.py"
Cohesion: 0.04
...
### Community 559 - "test_room_subscription_manager_helpers.py"
Cohesion: 0.05
...
### Community 563 - "test_command_parser_helpers.py"
Cohesion: 0.05
...
### Community 564 - "MagicServiceHealingMixin"
Cohesion: 0.23
...
### Community 565 - "test_game_tick_processing_async.py"
Cohesion: 0.07
...
### Community 566 - "test_occupants.py"
Cohesion: 0.18
...
### Community 568 - "inventory_equip_command.py"
Cohesion: 0.06
Nodes (80): _equip_stack_from_inventory_index(), _find_equipped_by_item_id(), find_equipped_item_after_equip(), handle_wearable_container_on_equip(), normalize_equipped_items(), normalize_inventory_slots(), InventoryStack, Player (+72 more)

### Community 569 - "handle_command"
Cohesion: 0.10
Nodes (19): CommandRequest, handle_command(), BaseModel, post, Request, Handle incoming HTTP command requests., Request model for command processing., asyncio (+11 more)

### Community 570 - ".to_dict"
Cohesion: 0.12
...
### Community 571 - "RoomCacheService"
Cohesion: 0.15
...
### Community 573 - "send_personal_message_old_impl"
Cohesion: 0.12
Nodes (16): broadcast_global_event_impl(), Any, _queue_message_if_needed(), Queue message for later delivery if no active connections. Args: player_id: The…, Send a personal message to a player via WebSocket (deprecated implementation).…, Broadcast a global event to all connected players., send_personal_message_old_impl(), Send a personal message to a player via WebSocket (deprecated). (+8 more)

### Community 574 - "UUID"
Cohesion: 0.05
Nodes (20): UUID, Publish an npc_took_damage event for non-combat damage., Publish an npc_died event when non-combat damage kills an NPC., Return combat_id if this NPC is in combat, else None., End combat if the given NPC is in combat (e.g. steal-life kill)., Return the active combat for combat_id, or None if not found., Return combat_id if a participant is in combat, else None., Return combat_id if an NPC UUID is in combat, else None. (+12 more)

### Community 575 - "test_player_repository_room.py"
Cohesion: 0.20
...
Cohesion: 0.06
Nodes (42): check_alias_safety(), handle_expanded_command(), Any, CommandExecutionRequest, Alias Expansion Logic for MythosMUD. This module handles alias resolution,…, Handle command processing with alias expansion and loop detection. This…, Check if an alias is safe to expand. Builds an alias dependency graph and…, Validate an expanded command for length and content. Args: expanded_command:… (+34 more)

### Community 577 - "NPCCombatLifecycle"
Cohesion: 0.07
Nodes (21): NPCCombatLifecycle, Any, Manages NPC lifecycle operations during combat., Initialize the lifecycle manager. Args: async_persistence: Async persistence…, Despawn NPC with defensive error handling. Args: npc_id: ID of the NPC to…, Despawn an NPC. Args: npc_id: ID of the NPC to despawn _room_id: ID of the room…, Return lifecycle manager (sync); may be wrapped by asyncio.to_thread., asyncio (+13 more)
...
### Community 583 - "test_look_item.py"
Cohesion: 0.02
...
### Community 584 - "._build_connection_stats"
Cohesion: 0.15
Nodes (9): UUID, Count active connections not tied to any online player., Build the connections subsection of memory stats., Build the sessions subsection of memory stats., Return numerator/denominator, or 0 when denominator is empty., Count how many sessions have each connection-count size., Return (avg, max, min) connection ages; zeros when the list is empty., Compose connection statistics payload (extracted to keep get_connection_stats… (+1 more)

### Community 585 - "test_follow_flow.py"
Cohesion: 0.17
...
### Community 590 - "test_room_sync_service.py"
Cohesion: 0.04
...
### Community 595 - "CombatMessagingService"
Cohesion: 0.08
Nodes (19): CombatMessages, CombatMessagingBase, Any, Base class with connection manager setup. Used by CombatMessagingIntegration., Lazily resolve the connection manager from the application container., CombatMessagingService, Any, Generate combat start messages for all room occupants. Args: attacker_name:… (+11 more)
...
### Community 597 - "NPCCombatDataProvider"
Cohesion: 0.10
Nodes (26): NPCCombatDataProvider, Any, UUID, Get player name for messaging. Args: player_id: ID of the player Returns:…, Get the current room ID for a player. Args: player_id: ID of the player (must…, Get player combat participant data from persistence. Args: player_id: ID of the…, Get NPC combat participant data from NPC instance. Args: npc_instance: NPC…, Provides data retrieval and preparation for NPC combat. (+18 more)
...
### Community 603 - "TestPostgresConnectionPool"
Cohesion: 0.15
...
### Community 606 - "SpellTargetingService"
Cohesion: 0.17
Nodes (12): Player, UUID, Resolve the target for a spell cast. Args: player_id: ID of the player casting…, Get player from persistence., Build a TargetMatch for a combat opponent, or None if unresolved., Get the combat target for a player if they are in combat. Args: player_id:…, Service for resolving spell targets. Handles target resolution based on spell…, Initialize the spell targeting service. Args: target_resolution_service:… (+4 more)
...
### Community 612 - "rest_countdown_task.py"
Cohesion: 0.24
...
### Community 613 - ".create_unequip_command"
Cohesion: 0.11
Nodes (17): Test create_unequip_command() raises error with empty args., Test create_unequip_command() raises error with whitespace only., Test create_unequip_command() handles known slot., Test create_unequip_command() handles unknown slot as search term., Test create_unequip_command() handles multi-word search term., Test create_unequip_command() handles all known slots., Test create_unequip_command() creates UnequipCommand., Test create_unequip_command() raises error with no args. (+9 more)
...
Cohesion: 0.08
Nodes (33): buildCreateCharacterPayload(), CharacterNameScreen(), getCreateCharacterErrorMessage(), OccupationSlotPayload, PersonalInterestPayload, SkillsPayload, MotdContent(), MOTD_BUTTON_STYLE (+25 more)

### Community 618 - ".create_get_command"
Cohesion: 0.12
Nodes (15): Test create_get_command() raises error with no args., Test create_get_command() with single arg returns get-from-room…, Test create_get_command() handles 'from' keyword., Test create_get_command() raises error when quantity is zero., Test create_get_command() raises error when quantity is negative., Test create_get_command() handles multi-word container., Test create_get_command() handles multi-word container without quantity., test_create_get_command_multi_word_container() (+7 more)

### Community 619 - "combat_schema.py"
Cohesion: 0.23
...
### Community 622 - "get_mythos_time"
Cohesion: 0.17
Nodes (10): get_mythos_time(), Return the current Mythos calendar metadata for HUD initialization. In-memory…, Test get_mythos_time endpoint., Test get_mythos_time returns time data., Test get_mythos_time handles missing holiday service., Test get_mythos_time handles holiday service errors gracefully., Test get_mythos_time includes holiday data when available., Test get_mythos_time handles None container. (+2 more)

### Community 623 - "SpellMaterialsService"
Cohesion: 0.18
...
### Community 625 - "test_get_subscriber_stats"
Cohesion: 0.14
Nodes (8): Test subscribe() raises error for invalid event type., Test EventBus.unsubscribe_all_for_service() only removes tracked handlers., Test EventBus.get_subscriber_stats() returns subscriber statistics., Test EventBus.unsubscribe() removes subscriber., test_event_bus_unsubscribe(), test_get_subscriber_stats(), test_subscribe_invalid_event_type(), test_unsubscribe_all_for_service_partial_cleanup()
...
### Community 628 - "test_invite_schemas.py"
Cohesion: 0.17
...
### Community 629 - "AggressiveMobNPC"
Cohesion: 0.05
...
### Community 630 - "generate_invites_db.py"
Cohesion: 0.19
...
### Community 635 - "DialogueEditorPage.tsx"
Cohesion: 0.16
...
### Community 648 - "LoggedHTTPException"
Cohesion: 0.04
Nodes (102): Validate current_user for loot_all operation., validate_user_for_loot_all(), _handle_delirium_respawn_validation_error(), _handle_respawn_validation_error(), Any, post, Request, ValidationError (+94 more)

### Community 649 - "test_postgres_adapter.py"
Cohesion: 0.14
...
### Community 651 - "test_rescue_service.py"
Cohesion: 0.04
...
### Community 652 - "resolve_weapon_attack_from_equipped"
Cohesion: 0.08
...
### Community 653 - "test_rooms_api.py"
Cohesion: 0.07
Nodes (46): RoomDictList, _apply_exploration_filter_if_needed(), get_room(), _invalidate_room_cache(), list_rooms(), Any, AsyncSession, BaseModel (+38 more)
...
### Community 657 - "emit_loot_all_event"
Cohesion: 0.10
Nodes (24): emit_loot_all_event(), ContainerComponent, Emit WebSocket event for loot_all operation. Args: connection_manager:…, _assert_warning_once(), _diff_items_from_emit(), mock_connection_manager(), asyncio, ConnectionManager (+16 more)

### Community 658 - "test_combat_event_publisher.py"
Cohesion: 0.03
Nodes (90): CombatEndedEvent, CombatTimeoutEvent, CombatTurnAdvancedEvent, Event fired when combat times out., Event fired when combat ends., Event fired when combat turn advances., CombatEventPublisher, _CombatPublishJob (+82 more)

### Community 659 - "include"
Cohesion: 0.11
...
### Community 664 - "_resolve_npc_target"
Cohesion: 0.14
Nodes (15): UUID, Resolve target via aggro (ADR-016), then fallback to _select_npc_target., Select target for NPC attack. Prefers participants that are not dead (includes…, _resolve_npc_target(), _select_npc_target(), asyncio, MonkeyPatch, Happy path: living NPC resolves target and combat_service.process_attack runs. (+7 more)
...
### Community 674 - "useGameTerminal.ts"
Cohesion: 0.06
...
### Community 675 - ".measure_model_deserialization"
Cohesion: 0.20
...
### Community 676 - "NATSMessageHandlerMixinBase"
Cohesion: 0.19
Nodes (11): QueueListener, NATSMessageHandlerMixinBase, Attrs/methods provided by NATSMessageHandler when mixed in., Set up async logging queue listener for non-blocking file I/O. Uses…, _setup_async_logging_queue(), _Handler, asyncio, Unit tests for NATSMessageHandlerMixinBase stubs. (+3 more)
...
### Community 678 - "test_time_bundle.py"
Cohesion: 0.07
Nodes (29): Mythos time consumer service., Initialize Mythos time event consumer., TimeBundle, isolated_chronicle(), asyncio, fixture, Unit tests for TimeBundle container wiring., Advance and freeze update persisted state. (+21 more)

### Community 679 - "is_safe_filename"
Cohesion: 0.12
...
### Community 682 - "UUID"
Cohesion: 0.21
Nodes (5): AsyncSession, Player, UUID, _TickCombatService, _TickDeathService
...
### Community 684 - "catatonia_check.py"
Cohesion: 0.22
Nodes (13): _check_catatonia_database(), _convert_player_id_to_uuid(), _fetch_lucidity_record(), _is_catatonic(), AsyncSession, UUID, _query_lucidity_record(), Catatonia Checking Logic for MythosMUD. This module handles checking whether a… (+5 more)

### Community 685 - "_get_npc_room_id"
Cohesion: 0.14
Nodes (14): _get_npc_room_id(), Get the room ID from an NPC instance, checking both current_room and…, Test _get_npc_room_id() returns current_room_id when available., Test _get_npc_room_id() returns current_room when current_room_id is None., Test _get_npc_room_id() returns None when both are None., test_get_npc_room_id_from_current_room(), test_get_npc_room_id_from_current_room_id(), test_get_npc_room_id_none() (+6 more)

### Community 686 - "NPCActionMessage"
Cohesion: 0.09
...
### Community 690 - "_should_include_npc"
Cohesion: 0.14
...
### Community 691 - "bench_cache_professions.py"
Cohesion: 0.31
...
### Community 693 - "CommunicationIntegrationProtocol"
Cohesion: 0.14
...
### Community 700 - "command_handler_unified.py"
Cohesion: 0.04
Nodes (58): command_request_app_state(), CommandExecutionRequest, Return app.state for HTTP Request or WebSocketRequestContext (duck-typed).…, _check_all_command_blocks(), _check_casting_state(), _check_rate_limit(), _ensure_alias_storage(), _get_casting_block_result() (+50 more)

### Community 701 - "._async_load_from_database"
Cohesion: 0.16
Nodes (10): _DatabaseLoadResult, TypedDict, Async helper to load schedules from PostgreSQL database., Return asyncpg-compatible DATABASE_URL from the environment., _resolve_asyncpg_database_url(), asyncio, MonkeyPatch, DATABASE_URL is converted to asyncpg-compatible form. (+2 more)
...
### Community 704 - "update_container"
Cohesion: 0.10
...
### Community 705 - "RoomEventHandler"
Cohesion: 0.12
...
### Community 706 - "MPRegenerationService"
Cohesion: 0.15
...
### Community 707 - "test_websocket_handler_validation.py"
Cohesion: 0.20
...
### Community 708 - "get_game_status"
Cohesion: 0.17
Nodes (10): get_game_status(), get, Get current game status and connection information., Test logger calls in get_game_status., Test get_game_status logs debug messages., Test get_game_status endpoint., Test get_game_status returns game status data., Test get_game_status handles empty connections. (+2 more)
...
### Community 710 - "inventory_command_helpers.py"
Cohesion: 0.03
Nodes (139): _DropResolved, _FloorPickupResolved, Protocol, Shared types for inventory command handlers (Lizard: keep main module small)., Narrows room managers for floor drop operations (pickup / get room)., RoomDropManager, add_pickup_to_inventory(), broadcast_room_event() (+131 more)

### Community 711 - "PlayerCreationService"
Cohesion: 0.21
...
### Community 713 - "combat_integration.py"
Cohesion: 0.18
Nodes (9): CombatEventPublisherProtocol, NpcCombatServiceProtocol, Protocol, Protocols for NPC combat integration (shared by base and facade modules)., Publish a PlayerAttackedEvent to the combat event stream., Typed surface for npc_combat_service.handle_npc_attack_on_player., Handle an NPC attack against a player via the main combat service., Combat event publisher (avoids importing CombatEventPublisher). (+1 more)

### Community 714 - "talk_command.py"
Cohesion: 0.07
Nodes (47): _emit_prompt(), handle_talk_command(), UUID, talk / talk <n> command for NPC dialogue trees (#583)., Handle talk <npc> or talk <n> against same-room NPCs., Extract player UUID from player model., Join talk args into a single remainder string., Send personal system message for a node; return short command result. (+39 more)
...
### Community 716 - "test_room_service.py"
Cohesion: 0.03
...
### Community 733 - "test_async_persistence_room_cache.py"
Cohesion: 0.04
Nodes (58): asyncio, Unit tests for async persistence layer: load_room_cache_async, query_rooms,…, Test get_user_by_username_case_insensitive when no session is yielded., Test get_professions when no session is yielded., Test get_players_batch with empty list., Test _generate_room_id_from_zone_data when stable_id already has full path., Test _generate_room_id_from_zone_data when room ID needs generation., Test _generate_room_id_from_zone_data with None values. (+50 more)
...
### Community 742 - "game/game.py"
Cohesion: 0.24
Nodes (11): BroadcastMessageResponse, BroadcastStats, GameStatusResponse, MythosTimeResponse, BaseModel, Game API response schemas for MythosMUD server. This module provides Pydantic…, Response model for game status endpoint., Statistics for a broadcast operation. (+3 more)
...
### Community 752 - "verify_npc_occupants.py"
Cohesion: 0.23
...
### Community 766 - "test_player_event_handlers_room_left.py"
Cohesion: 0.10
...
### Community 775 - "handle_system_command"
Cohesion: 0.24
...
### Community 777 - "monitoring_service"
Cohesion: 0.25
...
### Community 780 - "NPCAttacked"
Cohesion: 0.15
Nodes (8): NPCAttacked, Event fired when an NPC attacks a target. This event is triggered when an NPC…, Resolve attack_damage from behavior config with robust typing., Try to handle the attack via combat integration. Returns: True/False if…, Internal implementation for attacking a target., Attack a specific target., Handle attacking target action., Publish NPC attack event to event bus.
...
### Community 785 - "initialize_components"
Cohesion: 0.36
...
### Community 794 - "test_player_event_handlers_respawn.py"
Cohesion: 0.17
...
### Community 795 - "MemoryProfiler"
Cohesion: 0.18
Nodes (9): Test MemoryProfiler initialization., Test MemoryProfiler.get_memory_delta() calculates difference., test_memory_profiler_get_memory_delta(), test_memory_profiler_init(), MemoryProfiler, Memory profiler for analyzing model memory usage., Get a summary of current memory usage., Initialize the memory profiler. (+1 more)

### Community 796 - "alias_storage.py"
Cohesion: 0.04
Nodes (46): AliasRecord, create_validator(), Any, Path, Shared schema validator for room definition files. This module provides JSON…, Validate a room file against the schema. Args: file_path: Path to the room JSON…, Validate all rooms in a database against the schema. Args: room_database:…, Validate a serialized alias bundle against the alias schema. Args: alias_data:… (+38 more)

### Community 797 - "PlayerPositionService"
Cohesion: 0.04
...
### Community 798 - "EldritchIcon.tsx"
Cohesion: 0.02
Nodes (135): ChatMessage, ChatMessageType, ChatPanelTest(), mockClick, mockCreateObjectURL, mockRevokeObjectURL, BackpackTabProps, DraggablePanelResizeHandles() (+127 more)
...
### Community 812 - "get_auth_backend"
Cohesion: 0.18
Nodes (11): AuthenticationBackend, get_auth_backend(), Get authentication backend configuration., Test getting authentication backend., Test that get_auth_backend returns an AuthenticationBackend instance., Test that get_auth_backend uses environment variable for JWT secret., Test that get_auth_backend fails when JWT secret env var is missing., test_get_auth_backend() (+3 more)
...
### Community 819 - "test_inventory_mutation_guard_internal.py"
Cohesion: 0.09
...
### Community 822 - "_JSONDict"
Cohesion: 0.06
Nodes (19): _JSONDict, _loads_json_dict(), Set base stats from dictionary., Get behavior configuration as dictionary., Set behavior configuration from dictionary., Get AI integration stub configuration as dictionary., Set AI integration stub configuration from dictionary., Get spawn conditions as dictionary. (+11 more)

### Community 823 - "GameClientV2Dock.test.tsx"
Cohesion: 0.25
...
### Community 824 - "apply_stat_modifications"
Cohesion: 0.29
...
### Community 826 - "is_transient_error"
Cohesion: 0.18
Nodes (11): Test is_transient_error() identifies transient errors., DatabaseError wrapping asyncpg closed-connection must still retry (e2e…, test_is_transient_error_transient(), test_is_transient_error_wrapped_connection_closed(), _is_asyncpg_transient(), is_transient_error(), _iter_exception_chain(), BaseException (+3 more)

### Community 827 - "memory_profiler.py"
Cohesion: 0.20
Nodes (7): benchmark_model_memory_usage(), Any, Memory profiling utilities for MythosMUD models. This module provides…, Compare memory usage across multiple model classes. Args: model_classes: List…, Print formatted model memory usage results., Print formatted comparison results., Benchmark memory usage for all major models.

### Community 828 - "general_exception_handler"
Cohesion: 0.22
Nodes (10): general_exception_handler(), http_exception_handler(), log_api_requests(), Exception, Request, Handle HTTP exceptions with enhanced logging., Handle general exceptions with enhanced logging., Log API requests with performance metrics. (+2 more)
...
### Community 831 - "_ensure_connection_manager"
Cohesion: 0.27
Nodes (10): _ensure_connection_manager(), get_connection_statistics(), get_player_connections(), get, Request, Get connection information for a player. Returns detailed connection metadata…, Get comprehensive connection statistics. Returns detailed statistics about all…, Ensure connection manager is available. Raises LoggedHTTPException with proper… (+2 more)

### Community 832 - "_collect_python_public_defs_and_tiny"
Cohesion: 0.23
...
### Community 841 - "test_connection_event_helpers.py"
Cohesion: 0.14
...
### Community 845 - "asyncio"
Cohesion: 0.09
Nodes (38): handle_new_game_session(), Any, post, UUID, WebSocket, Resolve player ID from test player_id query parameter. Validates that the…, Resolve player ID from JWT token payload. Validates that the user has a player…, Resolve player ID from token or test player_id parameter. Handles both… (+30 more)
...
Cohesion: 0.04
Nodes (76): CircuitBreaker, CircuitBreakerOpen, CircuitState, Any, Enum, Exception, timedelta, Circuit breaker pattern for NATS message processing. Implements three-state… (+68 more)
...
### Community 861 - "AsyncPersistenceLayer"
Cohesion: 0.02
Nodes (74): AsyncPersistenceLayer, Any, datetime, Player, Profession, UUID, Set the instance manager for instanced room lookup (instance-first)., Ensure room cache is loaded (lazy loading with lock). This method uses a lock… (+66 more)

### Community 862 - "async_load_zone_configurations"
Cohesion: 0.12
Nodes (27): async_load_zone_configurations(), Async helper to load zone configurations from PostgreSQL database., _empty_zone_load_result(), asyncio, MonkeyPatch, Test process_zone_rows() handles empty result., Test process_zone_rows() parses JSON string fields., Test process_subzone_rows() processes subzone rows. (+19 more)

### Community 863 - "handle_explore_command"
Cohesion: 0.27
...
### Community 865 - "FeatureFlagService"
Cohesion: 0.03
...
### Community 866 - "cli.sh"
Cohesion: 0.39
Nodes (6): download(), download_cli(), download_file(), get_latest_version(), handle_rate_limit(), cli.sh script

### Community 867 - "get_logger"
Cohesion: 0.00
Nodes (797): File, JSONResponse, oauth2_scheme, post, Request, Receive and log alert webhooks, webhook(), add_flavor_text_column() (+789 more)
...
### Community 869 - ".handle_player_movement"
Cohesion: 0.17
Nodes (6): Unsubscribe from local channel messages for a specific sub-zone. Args: subzone:…, Track a player's sub-zone subscription for local channels. Args: player_id:…, Get list of players currently in a specific sub-zone. Args: subzone: Sub-zone…, Handle player movement between rooms and update sub-zone subscriptions. Args:…, Clean up sub-zone subscriptions that have no active players., Subscribe to local channel messages for a specific sub-zone. Args: subzone:…

### Community 870 - "_get_lifecycle_manager"
Cohesion: 0.20
...
### Community 871 - "DialogueDefinitionRepository"
Cohesion: 0.06
Nodes (50): In-memory dialogue session service for classic MUD talk (#583). Loads trees by…, Replace or clear the singleton (unit tests only)., reset_dialogue_service_for_tests(), DialogueDefinition, Base, NPC dialogue tree template: id (PK), definition JSONB, optional npc link., _as_dialogue_row(), _definition_dict() (+42 more)
...
### Community 873 - "test_room_subscription_manager.py"
Cohesion: 0.20
...
### Community 890 - "TestGenerateRoomId"
Cohesion: 0.20
...
### Community 891 - "GameMechanicsService"
Cohesion: 0.11
...
### Community 901 - "test_event_bus.py"
Cohesion: 0.09
Nodes (43): MockEventClass, asyncio, Unit tests for event bus. Tests the EventBus class., Test EventBus.publish() queues or processes event., Test EventBus.publish() with no subscribers., Test EventBus.inject() delivers event to subscribers (used by distributed…, Test EventBus.publish() with multiple subscribers., Mock event class for testing. (+35 more)

### Community 902 - "asyncio"
Cohesion: 0.13
...
### Community 904 - "get_npc_instance_service"
Cohesion: 0.02
...
### Community 908 - "._compose_memory_stats"
Cohesion: 0.25
...
### Community 910 - "add_default_combat_data_to_config"
Cohesion: 0.22
...
### Community 915 - "ensure_directory_exists"
Cohesion: 0.25
...
### Community 917 - "HTTPException"
Cohesion: 0.13
Nodes (15): BackgroundTasks, create_player(), get_player(), list_players(), get, HTTPException, post, Update player with background task and enhanced logging. (+7 more)
...
### Community 932 - "test_npc_startup_service.py"
Cohesion: 0.04
Nodes (75): mock_container(), Create mock container., _assign_container_get_instance(), _errors_len(), npc_startup_service(), asyncio, fixture, Unit tests for NPC startup service. Tests the NPCStartupService class. (+67 more)
...
### Community 939 - "mp_regeneration_service"
Cohesion: 0.22
...
### Community 941 - ".__init__"
Cohesion: 0.20
Nodes (3): Initialize system/admin channel strategy. Args: channel_type: Type of…, Initialize unknown channel strategy. Args: channel_type: Unknown channel type, Initialize room-based channel strategy. Args: channel_type: Type of room-based…
...
### Community 945 - "player_participant"
Cohesion: 0.22
Nodes (9): mock_combat(), mock_combat_service(), mock_connection_manager(), player_participant(), fixture, Create a mock ConnectionManager., Create a mock combat service., Create a mock combat instance. (+1 more)

### Community 946 - "test_game_status_effect.py"
Cohesion: 0.10
Nodes (19): Unit tests for StatusEffect model., Test StatusEffect can be created with required fields., Test StatusEffect can have optional source., Test is_active returns True for permanent effects (duration=0)., Test is_active returns True when current_tick < duration., Test is_active returns False when current_tick >= duration., Test StatusEffect validates duration is >= 0., Test StatusEffect validates intensity is >= 1. (+11 more)

### Community 947 - "._generate_invite_code"
Cohesion: 0.25
...
### Community 953 - "_optimize_payload"
Cohesion: 0.25
...
### Community 960 - "_update_delivery_status"
Cohesion: 0.25
Nodes (8): Update final delivery status based on connection results. Args:…, _update_delivery_status(), Test _update_delivery_status() when no connection attempts., Test _update_delivery_status() updates status for success., Test _update_delivery_status() updates status for failure., test_update_delivery_status_failed(), test_update_delivery_status_no_attempts(), test_update_delivery_status_success()
...
### Community 963 - ".check_and_cleanup"
Cohesion: 0.25
...
### Community 987 - "CombatMessagingIntegration"
Cohesion: 0.25
Nodes (5): Combat messaging integration with real-time messaging system. This package…, CombatMessagingIntegration, Combat messaging integration with real-time messaging system. Re-exports from…, Integrates combat messaging with the real-time messaging system. This service…, Return combat messaging integration for room broadcasts (e.g. aggro switches).
...
### Community 992 - "get_skills_catalog"
Cohesion: 0.25
Nodes (9): get_skills_catalog(), get, Request, Return the skills catalog (base values, allow_at_creation). Cthulhu Mythos is…, asyncio, GET /v1/skills without authenticated user returns 401., GET /v1/skills returns SkillListResponse with skills list., test_get_skills_catalog_returns_list() (+1 more)
...
Cohesion: 0.08
Nodes (50): _flee_effect_failure_response(), _flee_effect_invalid_target_response(), _flee_effect_invalid_target_type_response(), _flee_effect_not_in_combat_response(), _flee_effect_room_error_response(), _flee_effect_services_available(), _flee_effect_services_unavailable_response(), _flee_effect_success_response() (+42 more)

### Community 996 - "end_hour"
Cohesion: 0.50
Nodes (4): maximum, minimum, type, end_hour

### Community 997 - "EventPublisher"
Cohesion: 0.18
...
### Community 999 - "test_npc_event_handlers.py"
Cohesion: 0.03
...
### Community 1000 - "test_validate_secure_path_path_traversal_commonpath"
Cohesion: 0.33
...
### Community 1001 - "mock_container_service"
Cohesion: 0.25
...
### Community 1004 - "test_game.py"
Cohesion: 0.32
Nodes (7): mock_connection_manager(), mock_container(), mock_user(), fixture, Unit tests for game API endpoints. Tests game status, broadcasting, and time…, Create a mock connection manager., Create a mock application container.

### Community 1005 - "exits"
Cohesion: 0.50
Nodes (4): type, additionalProperties, type, exits

### Community 1006 - "TestGetMythosTimeEdgeCases"
Cohesion: 0.25
Nodes (5): Test edge cases for get_mythos_time., Test get_mythos_time handles container without holiday_service attribute., Test get_mythos_time logs debug message., Test get_mythos_time with different calendar component values., TestGetMythosTimeEdgeCases
...
### Community 1016 - "test_game_inventory_item.py"
Cohesion: 0.25
Nodes (7): Unit tests for InventoryItem model., Test InventoryItem can be created with required fields., Test InventoryItem defaults quantity to 1., Test InventoryItem validates quantity is >= 1., test_inventory_item_creation(), test_inventory_item_default_quantity(), test_inventory_item_quantity_validation_min()
...
### Community 1031 - "test_admin_shutdown_command.py"
Cohesion: 0.08
Nodes (40): calculate_notification_times(), is_shutdown_pending(), Calculate notification times for countdown. Notifications occur: - Every 10…, Check if server shutdown is currently pending. Args: app: FastAPI application…, _AppWithoutState, _InitiateAppStub, _InitiateStateStub, _PendingCheckAppStub (+32 more)
...
### Community 1037 - "_StubBoundLogger"
Cohesion: 0.29
Nodes (7): _as_bound_logger(), BoundLogger, Minimal stand-in for BoundLogger: only what log_exception_once touches for…, Adapt test double to the function param type (structural use only)., Plain exceptions get _already_logged via __setattr__ fallback; second log is…, _StubBoundLogger, test_log_exception_once_plain_exception_sets_flag_and_skips_repeat()

### Community 1038 - "get_plane_from_room_id"
Cohesion: 0.25
...
### Community 1041 - "rate_overrides.py"
Cohesion: 0.13
...
### Community 1044 - ".on_after_register"
Cohesion: 0.29
Nodes (4): Request, Handle post-registration logic., Handle forgot password logic., Handle username verification logic.

### Community 1045 - ".validate_database_url"
Cohesion: 0.29
...
### Community 1046 - ".validate_equip_requirements"
Cohesion: 0.29
...
### Community 1047 - ".validate_timestamp"
Cohesion: 0.29
...
### Community 1049 - "._handle_npc_death_on_combat_end"
Cohesion: 0.29
Nodes (4): Any, Handle NPC death when combat ends, with defensive exception handling. Args:…, Check if a string is a valid UUID., Initialize the combat handlers. Args: data_provider: NPC combat data provider…
...
### Community 1071 - "chat_logger"
Cohesion: 0.29
Nodes (6): Initialize the rate limiter with configuration-based limits., chat_logger(), fixture, Create a temporary directory for chat logs., Create a ChatLogger instance with temp directory., temp_log_dir()
...
### Community 1078 - "movement_service"
Cohesion: 0.29
...
### Community 1081 - "idle_movement_handler"
Cohesion: 0.29
...
### Community 1089 - "subject_manager"
Cohesion: 0.29
Nodes (7): fixture, Create NATSSubjectManager instance., Create NATSSubjectManager without metrics., Create NATSSubjectManager without cache., subject_manager(), subject_manager_no_cache(), subject_manager_no_metrics()

### Community 1090 - "asyncio"
Cohesion: 0.29
...
### Community 1091 - "test_retry.py"
Cohesion: 0.20
Nodes (9): Unit tests for retry utilities. Tests the retry decorator and retry logic., Test is_transient_error() returns False for non-transient errors., __cause__ ConnectionDoesNotExistError makes the outer wrapper transient., Test retry_with_backoff() succeeds on first attempt., Test retry_with_backoff() retries on failure then succeeds., test_is_transient_error_cause_chain_connection_closed(), test_is_transient_error_non_transient(), test_retry_with_backoff_failure_then_success() (+1 more)

### Community 1092 - "SampleModel"
Cohesion: 0.29
...
### Community 1095 - ".get_combat_stats"
Cohesion: 0.33
...
### Community 1096 - "schemas/auth/__init__.py"
Cohesion: 0.33
...
### Community 1105 - "mock_persistence"
Cohesion: 0.33
...
### Community 1120 - "mock_persistence"
Cohesion: 0.33
Nodes (6): mock_persistence(), mock_request(), mock_user(), fixture, Create a mock request object., Create a mock persistence layer.
...
### Community 1126 - "TestGracefulDegradation"
Cohesion: 0.33
...
### Community 1134 - "register_loot_endpoints"
Cohesion: 0.40
Nodes (4): APIRouter, Register loot-all endpoint to the router., register_loot_endpoints(), Test register_loot_endpoints registers the endpoint.
...
### Community 1144 - ".set_nats_service"
Cohesion: 0.40
Nodes (3): Any, Initialize distributed EventBus. Args: nats_service: NATS service for…, Set NATS service and start the bridge (call after NATS connects).
...
### Community 1168 - "zone_config_loader.py"
Cohesion: 0.13
Nodes (21): parse_zone_special_rules(), process_subzone_rows(), process_zone_rows(), Connection, Record, TypedDict, Zone Configuration Loader Module. This module handles loading zone and sub-zone…, Build and store one subzone configuration from a database row. (+13 more)

### Community 1169 - "zone"
Cohesion: 0.50
Nodes (4): zone, description, pattern, type

### Community 1170 - "_AppStateWithLegacyConfig"
Cohesion: 0.40
...
### Community 1177 - "wearable_service"
Cohesion: 0.40
Nodes (5): mock_persistence(), fixture, Create mock persistence layer., Create WearableContainerService instance., wearable_service()

### Community 1178 - ".begin_mutation"
Cohesion: 0.50
Nodes (3): AbstractContextManager, UUID, Acquire a guarded mutation context for the given player. Args: player_id: The…
...
### Community 1182 - "1. Component Refactoring"
Cohesion: 0.50
...
### Community 1205 - "CombatAttackHandler"
Cohesion: 0.11
...
### Community 1207 - "exits"
Cohesion: 0.50
Nodes (4): additionalProperties, description, type, exits

### Community 1208 - "applies_to"
Cohesion: 0.17
...
### Community 1215 - "_validate_invite_code"
Cohesion: 0.33
Nodes (3): Validate invite code. Returns validated invite or None., _validate_invite_code(), Get all unused invites.
...
### Community 1221 - "test_inventory_mutation_guard_error_handling.py"
Cohesion: 0.13
...
### Community 1223 - "inventory_unequip_command.py"
Cohesion: 0.04
Nodes (81): handle_wearable_container_on_unequip(), Handle wearable container preservation when unequipping a container item., _ensure_shared_services_initialized(), get_shared_services(), Shared service initialization for inventory commands., Clear lazy singletons so each test gets a fresh init path. For unit tests only;…, Resolve async_persistence from the request and construct shared singletons., Get shared service instances, initializing them lazily if needed. This ensures… (+73 more)

### Community 1224 - "ErrorContext"
Cohesion: 0.02
Nodes (101): create_error_context(), Any, Request, Create error context from request and user. Helper function to reduce…, Initialize the Pydantic error handler. Args: context: Optional error context…, ErrorContext, Any, Initialize MythosMUD error. Args: message: Technical error message context:… (+93 more)

### Community 1225 - "is_postgres_url"
Cohesion: 0.33
...
### Community 1226 - "_EventBusPublishPort"
Cohesion: 0.40
...
### Community 1229 - "TestGetContainerService"
Cohesion: 0.50
...
### Community 1231 - ".test_broadcast_message_broadcast_stats_structure"
Cohesion: 0.50
Nodes (3): Test edge cases for broadcast_message., Test broadcast_message with different broadcast_stats structures., TestBroadcastMessageEdgeCases

### Community 1232 - "mock_lifecycle_manager"
Cohesion: 0.50
Nodes (4): mock_lifecycle_manager(), mock_npc(), fixture, Create a mock lifecycle manager.

### Community 1233 - "RoomMapEditorRuntime.tsx"
Cohesion: 0.08
...
### Community 1235 - "._error_callback"
Cohesion: 0.50
...
### Community 1245 - "test_asyncio_run_guardrails.py"
Cohesion: 0.50
...
### Community 1262 - "_parse_equip_selector"
Cohesion: 0.50
Nodes (4): _maybe_extract_equip_slot(), _parse_equip_selector(), If last token is a known slot, return (remaining tokens, slot); else (tokens,…, Parse selector tokens into (index, search_term, target_slot); may raise…

### Community 1263 - "nats_broker"
Cohesion: 0.40
Nodes (5): nats_broker(), nats_config(), fixture, Create a NATSConfig instance., Create a NATSMessageBroker instance.

### Community 1264 - "EmoteService"
Cohesion: 0.08
Nodes (26): EmoteDefinition, _EmoteLoadResult, _EmoteRowData, EmoteService, TypedDict, Async helper to load emotes from PostgreSQL database., Check if a command is an emote alias. Args: command: The command to check…, Get the emote definition for a command. Args: command: The command (emote name… (+18 more)

### Community 1267 - "id"
Cohesion: 0.67
Nodes (3): minLength, type, id

### Community 1268 - "validate_admin_permission"
Cohesion: 0.20
...
### Community 1270 - "position_commands.py"
Cohesion: 0.06
Nodes (51): _broadcast_posture_change(), _build_posture_change_event(), _EventSequence, _format_room_posture_message(), _get_position_command_services(), handle_lie_command(), _handle_position_change(), handle_sit_command() (+43 more)

### Community 1271 - "metadata"
Cohesion: 0.67
...
### Community 1336 - "subscription_manager"
Cohesion: 0.67
...
### Community 1371 - "sub_zone"
Cohesion: 0.50
Nodes (4): sub_zone, description, pattern, type

### Community 1372 - "send_system_message"
Cohesion: 0.14
Nodes (19): Send a system message to a player. Args: websocket: The WebSocket connection…, send_system_message(), Test send_system_message sends system message., test_send_system_message(), mock_websocket(), asyncio, fixture, Unit tests for websocket handler system message functions. Tests the system… (+11 more)
...
### Community 1377 - "fixture"
Cohesion: 0.14
Nodes (14): mock_connection_manager(), mock_container(), mock_container_service(), mock_persistence(), mock_player(), mock_request(), mock_user(), fixture (+6 more)

### Community 1378 - "subscription_manager"
Cohesion: 0.67
Nodes (3): fixture, Create a RoomSubscriptionManager instance., subscription_manager()

### Community 1379 - "mock_websocket"
Cohesion: 0.67
Nodes (3): mock_websocket(), fixture, Create a mock WebSocket.

### Community 1381 - "Result"
Cohesion: 0.13
...
### Community 1387 - "idle_movement.py"
Cohesion: 0.10
Nodes (14): _cfg_bool(), _cfg_float(), _npc_id_str(), _passes_movement_probability(), NPC Idle Movement Handler for MythosMUD. This module provides idle movement…, Determine if an NPC should attempt idle movement. Checks multiple conditions: -…, Get exits from current room that stay within subzone boundaries. Args:…, Calculate weight for an exit based on distance from spawn. Args:… (+6 more)

### Community 1390 - "NPCCombatRewards"
Cohesion: 0.12
...
### Community 1393 - "GameStateProvider"
Cohesion: 0.08
Nodes (28): GameStateProvider, Any, Player, UUID, Game state provision for connection management. This module provides…, Get NPC names for multiple NPCs in a batch operation. Args: npc_ids: List of…, Get player name and add grace period indicators if applicable., Convert player UUIDs to names in room_data. (+20 more)

### Community 1394 - "service.py"
Cohesion: 0.09
Nodes (25): lookup_profile(), normalize_environment_config(), period_label(), Any, datetime, Configuration and normalization for passive lucidity flux., Return a coarse period label used for environment profiles., Normalize environment config to validated structure. (+17 more)

### Community 1395 - "handle_transfer_items_exceptions"
Cohesion: 0.02
Nodes (94): handle_close_container_exceptions(), handle_loot_all_exceptions(), handle_open_container_exceptions(), handle_transfer_items_exceptions(), Any, Exception, Request, UUID (+86 more)

### Community 1397 - "normalize_command"
Cohesion: 0.06
...
### Community 1408 - "OccupantFormatter"
Cohesion: 0.12
...
Cohesion: 0.04
Nodes (78): _find_matching_npcs(), _format_core_attributes(), _format_lifecycle_info(), _format_multiple_npcs_result(), _format_npc_description(), _format_npc_stats_for_admin(), _format_other_stats(), _format_single_npc_result() (+70 more)
...
### Community 1639 - "multiplayer-browser-helpers.d.ts"
Cohesion: 0.50
...
### Community 1762 - "test_zone_config_loader.py"
Cohesion: 0.20
Nodes (13): parse_json_field(), Parse a JSON field from database, handling both dict/list and string formats.…, Unit tests for zone configuration loader. Tests the zone_config_loader module…, Test parse_json_field() returns default when None., Test parse_json_field() parses JSON string., Test parse_json_field() returns dict as-is., Test parse_json_field() returns list as-is., Test parse_json_field() raises error on invalid JSON string. (+5 more)

### Community 1763 - "CharacterSelectionScreen.tsx"
Cohesion: 0.26
Nodes (9): CharacterCard(), CharacterCardDeleteState, CharacterSelectionScreen(), extractCharactersFetchErrorMessage(), extractErrorMessageFromResponseBody(), fetchCharactersList(), formatCharacterDate(), handleRefreshCharactersFailure() (+1 more)
...
### Community 1913 - "test_player_respawn_service.py"
Cohesion: 0.01
Nodes (196): PlayerRespawnedEvent, Event fired when a player respawns after death. This event is triggered when a…, AttributeType, PositionState, StrEnum, Game-related models for MythosMUD. This module contains models specific to the…, Get the modifier for a given attribute (standard D&D-style calculation)., Core attribute types for the character system . (+188 more)

### Community 1914 - "test_spell_repository.py"
Cohesion: 0.17
Nodes (16): Any, Get a spell by ID. Args: spell_id: Spell ID Returns: dict | None: Spell…, Map procedure result row to spell dict., Get all spells from the database. Returns: list[dict]: List of all spell…, _row_to_spell_dict(), _mock_session(), asyncio, fixture (+8 more)

### Community 1919 - "_EventPersistence"
Cohesion: 0.22
...
### Community 1920 - "players/skill.py"
Cohesion: 0.33
Nodes (5): Skill catalog API response schemas. Used by GET /v1/skills (or equivalent) for…, Single skill catalog entry., Response model for skills catalog list., SkillData, SkillListResponse

### Community 1923 - "test_spell_effects_support.py"
Cohesion: 0.39
...
### Community 1924 - "MockPersistence"
Cohesion: 0.10
...
### Community 1931 - "extract_zone_name"
Cohesion: 0.20
...
### Community 1938 - "test_quest_start_by_trigger_then_abandon"
Cohesion: 0.31
...
### Community 1939 - "populate_test_npc_databases.py"
Cohesion: 0.31
...
### Community 1940 - ".get_memory_status_report"
Cohesion: 0.22
...
### Community 1945 - ".optimize_payload"
Cohesion: 0.28
...
### Community 1947 - "test_magic_commands.py"
Cohesion: 0.03
...
### Community 1957 - "test_real_time_helpers.py"
Cohesion: 0.19
Nodes (14): _extract_bearer_token(), _parse_subprotocol_token(), _parse_websocket_token(), Parse token from WebSocket subprotocol header. Example formats: "bearer,…, Parse token from WebSocket subprotocol (preferred) or query params (fallback).…, Extract bearer token from parsed subprotocol parts. If 'bearer' marker is…, Unit tests for real_time API helper functions., test_extract_bearer_token_empty() (+6 more)

### Community 1961 - "load_zone_configurations"
Cohesion: 0.25
...
### Community 1962 - "login_grace_period.py"
Cohesion: 0.11
Nodes (30): _as_grace(), _EffectPersistence, _grace_period_task(), _GraceApp, _GraceAppState, _GraceContainer, _GraceManager, _GracePlayer (+22 more)

### Community 1972 - "rooms/room.py"
Cohesion: 0.13
Nodes (17): BaseModel, Player respawn API response schemas for MythosMUD server. This module provides…, Simplified player data returned in respawn responses., RespawnPlayerData, Rooms domain schemas: room API responses., BaseModel, Room data schema for MythosMUD. This module defines Pydantic models for room…, Room data structure for API responses. This model represents room information… (+9 more)

### Community 1973 - ".auto_progression_enabled"
Cohesion: 0.29
...
### Community 1974 - "command_service"
Cohesion: 0.29
...
### Community 1977 - "event_publisher"
Cohesion: 0.29
...
Cohesion: 0.09
Nodes (32): Config, Item, _is_test_mode(), Reset the configuration cache. In test mode, this is a no-op since get_config()…, Detect if running in test environment. Uses multiple detection methods to…, reset_config(), _apply_path_based_markers(), _create_test_event_loop() (+24 more)
...
### Community 1987 - "._background_audit_cycle"
Cohesion: 0.33
...
### Community 1998 - "add_default_combat_data_to_stats"
Cohesion: 0.33
...
### Community 2005 - "FakeHallucinationService"
Cohesion: 0.12
Nodes (14): FakeHallucinationService, Any, UUID, Generate a room text overlay hallucination. Args: player_id: Player UUID who…, Select which type of fake hallucination to trigger (50/50 chance). Returns:…, Service for generating fake NPC tells and room text overlays. These…, Initialize the fake hallucination service., Generate a fake NPC tell hallucination. Args: player_id: Player UUID who will… (+6 more)

### Community 2009 - "test_websocket_handler_disconnect.py"
Cohesion: 0.33
...
### Community 2012 - "test_websocket_handler_helpers.py"
Cohesion: 0.33
...
### Community 2034 - "_RoomPersistence"
Cohesion: 0.40
...
### Community 2037 - "add_fastapi_users_columns.py"
Cohesion: 0.50
...
### Community 2040 - "add_hashed_password_column.py"
Cohesion: 0.50
...
### Community 2042 - "add_used_by_user_id_column.py"
Cohesion: 0.50
...
### Community 2045 - "rename_invites_columns.py"
Cohesion: 0.50
...
### Community 2047 - "rename_used_to_is_active.py"
Cohesion: 0.50
...
### Community 2049 - "connection_manager_methods.py"
Cohesion: 0.02
Nodes (147): broadcast_global_event_impl(), broadcast_global_impl(), broadcast_room_event_impl(), broadcast_to_room_impl(), canonical_room_id_public_impl(), check_all_connections_health_impl(), check_connection_health_impl(), ConnectionManager (+139 more)

### Community 2058 - "TestErrorHandlers"
Cohesion: 0.10
Nodes (15): asyncio, Test error handler functions., Test mythos_exception_handler., Test mythos_exception_handler with debug enabled., Test general_exception_handler., Test logged_http_exception_handler for 401., Test logged_http_exception_handler for 404., Test logged_http_exception_handler for 422. (+7 more)

### Community 2059 - "_is_npc_follow_value"
Cohesion: 0.50
...
Cohesion: 0.04
Nodes (76): asyncio, Unit tests for wearable container service. Tests the WearableContainerService…, Test handle_unequip_wearable_container returns None when no item_instance_id., Test handle_unequip_wearable_container preserves container., Test get_wearable_containers_for_player returns containers., Test get_wearable_containers_for_player returns empty list when no containers., Test get_wearable_containers_for_player handles errors gracefully., Test add_items_to_wearable_container adds items. (+68 more)

## Knowledge Gaps
- **6145 isolated node(s):** `wsl-bashrc-codacy.sh script`, `uvx`, `jcodemunch-mcp`, `JCODEMUNCH_MAX_FOLDER_FILES`, `@codacy/codacy-mcp` (+6140 more)
...
- **Why does `get_logger()` connect `get_logger` to `EventBus`, `connection_manager_methods.py`, `PlayerNameExtractor`, `lifespan_startup.py`, `test_shutdown_sequence.py`, `BaseEvent`, `test_connection_delegates.py`, `test_combat_service_modules.py`, `container_endpoints_basic.py`, `LucidityService`, `register_user`, `User`, `test_channel_commands.py`, `ContainerData`, `test_look_helpers.py`, `rate_overrides.py`, `admin_shutdown_command.py`, `test_chat_pose_helpers.py`, `ExplorationService`, `test_container_bundles.py`, `TargetMatch`, `PerformanceTracker`, `PlayerService`, `NPCDied`, `pytest.md`, `websocket_initial_state.py`, `api/player_effects.py`, `NATSError`, `config/models/__init__.py`, `NATSConnectionStateMachine`, `test_occupants.py`, `lifespan.py`, `inventory_equip_command.py`, `test_who_commands.py`, `Stats`, `.to_dict`, `test_container_persistence_extended_crud.py`, `ChatPoseManager`, `AliasGraph`, `admin_teleport_commands.py`, `chat_service.py`, `InstanceManager`, `test_look_item.py`, `test_error_handling_middleware.py`, `api/monitoring.py`, `websocket_handler.py`, `combat_service_attack.py`, `test_admin_commands.py`, `test_player_presence_tracker.py`, `EventHandler`, `factory.py`, `RoomRepository`, `BehaviorEngine`, `test_combat_monitoring_service.py`, `rest_countdown_task.py`, `test_look_room.py`, `NPCCombatUUIDMapping`, `test_container_websocket_events.py`, `DatabaseManager`, `npc_combat_integration_service.py`, `test_rest_command.py`, `test_container_persistence_async_helpers.py`, `test_status_commands.py`, `CombatConfiguration`, `FollowService`, `test_combat_validator.py`, `test_lucidity_recovery_commands.py`, `test_channel_broadcasting_strategies.py`, `handle_emote_command`, `NPCDefinition`, `LoggedHTTPException`, `.state`, `build_event`, `test_rescue_service.py`, `resolve_weapon_attack_from_equipped`, `SpellEffectType`, `test_lifecycle_periodic.py`, `zone_config_loader.py`, `item_instance_persistence_async.py`, `test_quest_definition_repository.py`, `persistence/container_persistence.py`, `lucidity_migration.py`, `test_connection_session_management.py`, `migrate_combat_data.py`, `validate_prototypes.py`, `PhantomHostileService`, `quest_commands.py`, `test_aggro_threat.py`, `test_command_helpers.py`, `test_admin_setlucidity_command.py`, `test_go_command.py`, `TargetResolutionService`, `CombatAuditLogger`, `catatonia_check.py`, `CombatInstance`, `lifespan_magic.py`, `MonitoringDashboard`, `CastingStateManager`, `MovementService`, `command_handler_unified.py`, `test_active_lucidity_service.py`, `test_player_disconnect_handlers.py`, `.__post_init__`, `MPRegenerationService`, `test_logout_commands.py`, `apply_communication_dampening`, `inventory_command_helpers.py`, `inventory_unequip_command.py`, `test_party_commands.py`, `test_communication_commands_flows.py`, `talk_command.py`, `ErrorContext`, `map_minimap.py`, `middleware`, `player_inventory_migration.py`, `test_metrics_endpoints.py`, `test_lucidity_event_dispatcher.py`, `ValidationError`, `test_player_occupant_processor.py`, `LogAggregator`, `_handle_admin_set_stat_command`, `NATSMessageBroker`, `player_combat_service_support.py`, `AdminActionsLogger`, `test_map_helpers.py`, `test_look_container_helpers.py`, `test_lifespan_shutdown.py`, `test_goto_helpers.py`, `MessageQueue`, `npc_config_parsing.py`, `server/dependencies.py`, `validate_admin_permission`, `look_command.py`, `position_commands.py`, `PrototypeRegistryError`, `MythosTickScheduler`, `connection_establishment.py`, `test_container_persistence_crud.py`, `PartyService`, `CommandRateLimiter`, `test_chat_validator.py`, `test_chat_nats_publisher.py`, `npc_database.py`, `PayloadOptimizer`, `NPCOccupantProcessor`, `message_handler_factory.py`, `get_session_maker`, `alias_storage.py`, `test_inventory_display_helpers.py`, `handle_read_command`, `admin_summon_command.py`, `player_event_handlers.py`, `command_service.py`, `test_npc_combat_handlers.py`, `session_factory`, `apply_stat_modifications`, `get_username_from_user`, `quest_service.py`, `get_admin_auth_service`, `_ensure_connection_manager`, `game_tick_processing.py`, `test_chat_npc_system.py`, `asyncio`, `MovementMonitor`, `CircuitBreaker`, `extract_player_name`, `test_quest_instance_repository.py`, `AttributeError`, `connection_manager_health_cleanup.py`, `FeatureFlagService`, `DialogueDefinitionRepository`, `inventory_get_command.py`, `idle_movement.py`, `PerformanceMonitor`, `GameStateProvider`, `service.py`, `handle_transfer_items_exceptions`, `test_look_player.py`, `test_player_respawn_service.py`, `NATSSubjectManager`, `combat_attack.py`, `OccupantFormatter`, `get_npc_instance_service`, `TaskRegistry`, `test_lifecycle_respawn.py`, `bundles/game.py`, `player_connection_setup.py`, `CombatPersistenceHandler`, `login_grace_period.py`, `test_game_tick_processing.py`, `server/tests/conftest.py`, `chat_channel_message_senders.py`, `optimized_security_validator.py`, `dialogue_definitions_api.py`, `Any`, `test_lucidity_command_disruption.py`, `CombatService`, `run_flee_effect`, `test_look_npc.py`, `ChatModeration`, `command_result_text`, `add_fastapi_users_columns.py`, `add_hashed_password_column.py`, `add_used_by_user_id_column.py`, `ContainerRepository`, `rename_invites_columns.py`, `rename_used_to_is_active.py`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `PlayerNameExtractor` connect `PlayerNameExtractor` to `is_player_in_login_grace_period`, `PlayerRoomEventHandler`, `player_event_handlers.py`, `NPCOccupantProcessor`, `test_player_occupant_processor.py`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Player` connect `pytest.md` to `get_npc_instance_service`, `test_player_repository.py`, `test_player_death_service.py`, `SpellEffectType`, `LucidityService`, `User`, `get_session_maker`, `test_container_helpers_inventory_display.py`, `websocket_initial_state.py`, `TargetResolutionService`, `player_event_handlers.py`, `InventorySchemaValidationError`, `test_who_commands.py`, `session_factory`, `inventory_equip_command.py`, `quest_service.py`, `test_player_repository_room.py`, `game_tick_processing.py`, `inventory_command_helpers.py`, `inventory_unequip_command.py`, `PlayerCreationService`, `PlayerDeathService`, `test_container_helpers_inventory_ops.py`, `PlayerRepositoryProtocol`, `test_async_persistence_room_cache.py`, `SpellTargetingService`, `get_logger`, `test_container_helpers_inventory_find.py`, `inventory_get_command.py`, `DatabaseManager`, `service.py`, `command_result_text`, `look_command.py`, `coerce_int`, `test_player_respawn_service.py`?**
