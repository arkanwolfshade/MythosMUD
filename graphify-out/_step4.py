...
# Shrink is fuzzy-dedup + skill ID collisions after replacing 16659 re-extracted
# sources; detect reported 0 deletions. force so the AST update is not discarded.
