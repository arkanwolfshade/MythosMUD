...
- **append_rule_c_warning()** (3 connections) — `scripts/ci/quality_fragmentation_trends.py`
...
- [Quality Fragmentation Ci](Quality_Fragmentation_Ci.md) (15 shared connections)
- [Quality Fragmentation Guard](Quality_Fragmentation_Guard.md) (7 shared connections)
- [E 2 E Ai Execution](E_2_E_Ai_Execution.md) (3 shared connections)
