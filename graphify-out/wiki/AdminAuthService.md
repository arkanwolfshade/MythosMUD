...
- **Clean up expired sessions. Returns: Number of sessions cleaned up** (1 connections) — `server/services/admin_auth_service.py`
...
- [.get_active_sessions](get_active_sessions.md) (2 shared connections)
