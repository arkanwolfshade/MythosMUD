...
- **Any** (5 connections) — `scripts/analyze_coverage_gaps.py`
...
- **Path** (3 connections) — `scripts/analyze_coverage_gaps.py`
- **Categorize files into critical below threshold, normal below threshold, and meet** (1 connections) — `scripts/analyze_coverage_gaps.py`
