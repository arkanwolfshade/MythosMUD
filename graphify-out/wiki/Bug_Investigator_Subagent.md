...
- **Bug Investigator Subagent** (13 connections) — `.cursor/agents/bug-investigator.md`
- **Methodology** (6 connections) — `.cursor/agents/bug-investigator.md`
...
- **Evidence Collection** (1 connections) — `.cursor/agents/bug-investigator.md`
...
- **Integration** (1 connections) — `.cursor/agents/bug-investigator.md`
- **Investigation Only** (1 connections) — `.cursor/agents/bug-investigator.md`
...
- **Phase 1: Initial Bug Report Analysis** (1 connections) — `.cursor/agents/bug-investigator.md`
- **Phase 2: System State Investigation** (1 connections) — `.cursor/agents/bug-investigator.md`
- **Phase 3: Code Analysis** (1 connections) — `.cursor/agents/bug-investigator.md`
- **Phase 4: Evidence Collection** (1 connections) — `.cursor/agents/bug-investigator.md`
- **Phase 5: Analysis and Reporting** (1 connections) — `.cursor/agents/bug-investigator.md`
