...
- **mythosTime.ts** (24 connections) — `client/src/types/mythosTime.ts`
...
- **HolidayBanner()** (3 connections) — `client/src/components/MythosTimeHud.tsx`
- **HeaderBarProps** (3 connections) — `client/src/components/ui-v2/HeaderBar.tsx`
...
- [Communication Command Handlers](Communication_Command_Handlers.md) (21 shared connections)
- [Magic System Feature Plan](Magic_System_Feature_Plan.md) (7 shared connections)
