...
- test_combat_instance_clear_queued_actions() `EXTRACTED`
- test_combat_instance_clear_queued_actions_specific_round() `EXTRACTED`
...
- test_combat_cleanup_handler.py `EXTRACTED`
