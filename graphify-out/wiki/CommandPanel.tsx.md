...
- **CommandPanel.tsx** (33 connections) — `client/src/components/panels/CommandPanel.tsx`
...
- **prependChannelShortcut()** (2 connections) — `client/src/components/panels/CommandPanel.tsx`
...
- **LogoutButtonProps** (1 connections) — `client/src/components/ui/LogoutButton.tsx`
