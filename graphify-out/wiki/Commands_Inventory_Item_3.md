...
- **Room with a reverse exit is treated as bidirectional and returns its coordinates** (1 connections) — `server/tests/unit/services/test_ascii_map_renderer_exits.py`
