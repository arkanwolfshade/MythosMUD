...
- **Test get_pattern_info() raises PatternNotFoundError when pattern not found.** (1 connections) — `server/tests/unit/services/nats_subject_manager/test_manager.py`
