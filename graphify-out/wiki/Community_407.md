...
- **messageHandlers.test-utils.ts** (13 connections) — `client/src/components/ui-v2/eventHandlers/__tests__/messageHandlers.test-utils.ts`
...
- **extractChannelFromMessage()** (4 connections) — `client/src/utils/messageTypeUtils.ts`
...
- **isChatContent()** (3 connections) — `client/src/utils/messageTypeUtils.ts`
