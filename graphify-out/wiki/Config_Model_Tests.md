...
- **createInitialState()** (2 connections) — `client/src/stores/connectionStore.ts`
- **generateSessionId()** (2 connections) — `client/src/stores/connectionStore.ts`
...
- **createDefaultGameTerminalState()** (1 connections) — `client/src/components/__tests__/GameTerminalContainer.test.tsx`
- **useGameTerminalMock** (1 connections) — `client/src/components/__tests__/GameTerminalContainer.test.tsx`
- **mockCommandState** (1 connections) — `client/src/hooks/useGameTerminal.test.ts`
- **mockConnectionState** (1 connections) — `client/src/hooks/useGameTerminal.test.ts`
- **mockGameState** (1 connections) — `client/src/hooks/useGameTerminal.test.ts`
- **mockSessionState** (1 connections) — `client/src/hooks/useGameTerminal.test.ts`
- *... and 22 more nodes in this community*

## Relationships

- [Combat Attack Handler](Combat_Attack_Handler.md) (5 shared connections)
- [Admin Teleport FRD](Admin_Teleport_FRD.md) (5 shared connections)
- [Combat NPC Lookup](Combat_NPC_Lookup.md) (3 shared connections)
- [Game Status API](Game_Status_API.md) (3 shared connections)
- [Architecture Implementation Summary](Architecture_Implementation_Summary.md) (3 shared connections)
