...
- **InventoryStack** (8 connections) — `client/src/stores/containerStore.ts`
...
- **createKeyDownHandler()** (3 connections) — `client/src/components/containers/useContainerSplitPane.ts`
