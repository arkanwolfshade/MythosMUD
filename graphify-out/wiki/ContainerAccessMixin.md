...
- **._verify_container_open()** (4 connections) — `server/services/container_service_access.py`
...
- **Access checks for open containers and unlock eligibility.** (1 connections) — `server/services/container_service_access.py`
- **Verify that a container is open by the specified player with the given token.…** (1 connections) — `server/services/container_service_access.py`
...
- [ContainerSessionMixin](ContainerSessionMixin.md) (1 shared connections)
