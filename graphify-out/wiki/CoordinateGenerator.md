...
- **Load rooms and their exits from database. Args: plane: Plane name zone: Zone…** (1 connections) — `server/services/coordinate_generator.py`
...
- **Generate coordinates for rooms in a single subzone. Args: rooms: List of room…** (1 connections) — `server/services/coordinate_generator.py`
- **Calculate next coordinates based on direction. Args: x: Current x coordinate y:…** (1 connections) — `server/services/coordinate_generator.py`
