...
- **DepInfo** (22 connections) — `scripts/utils/dependency_analysis_types.py`
...
- **PriorityItem** (15 connections) — `scripts/utils/dependency_analysis_types.py`
- **AnalysisSnapshot** (12 connections) — `scripts/utils/dependency_analysis_types.py`
- **BreakingChange** (11 connections) — `scripts/utils/dependency_analysis_types.py`
- **RiskAssessment** (10 connections) — `scripts/utils/dependency_analysis_types.py`
...
- **UpdateStrategy** (9 connections) — `scripts/utils/dependency_analysis_types.py`
