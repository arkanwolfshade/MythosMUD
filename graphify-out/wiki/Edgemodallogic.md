...
- **edgeModalLogic.ts** (26 connections) — `client/src/components/map/edgeModalLogic.ts`
...
- **resetEdgeFormFields()** (3 connections) — `client/src/components/map/edgeModalLogic.ts`
...
- **STANDARD_DIRECTIONS** (3 connections) — `client/src/components/map/edgeModalLogic.ts`
- **EdgeModalValidationMessagesProps** (2 connections) — `client/src/components/map/EdgeCreationModalParts.tsx`
- *... and 18 more nodes in this community*

## Relationships

- [Exitedge](Exitedge.md) (16 shared connections)
- [Roommapeditorruntime.hooks](Roommapeditorruntime.hooks.md) (6 shared connections)
