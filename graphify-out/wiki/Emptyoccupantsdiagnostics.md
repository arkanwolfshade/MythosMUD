...
- **GameClientV2RefsBundle** (6 connections) — `client/src/components/ui-v2/hooks/useGameClientV2ContainerRefsAndBootstrap.ts`
...
- [Stateupdateutils](Stateupdateutils.md) (27 shared connections)
- [Playerhandlers](Playerhandlers.md) (26 shared connections)
- [Modalcontainer](Modalcontainer.md) (6 shared connections)
- [Usewebsocketconnectiontestfixtures](Usewebsocketconnectiontestfixtures.md) (5 shared connections)
- [Memorymonitor](Memorymonitor.md) (3 shared connections)
- [Security](Security.md) (3 shared connections)
- [Skillassignmentscreen.helpers](Skillassignmentscreen.helpers.md) (2 shared connections)
- [Panelreducerhandlers](Panelreducerhandlers.md) (1 shared connections)
