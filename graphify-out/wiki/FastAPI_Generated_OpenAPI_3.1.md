...
- **ADR-010 Quest Subsystem** (2 connections) — `docs/architecture/decisions/ADR-010-quest-subsystem.md`
- **FastAPI-Generated OpenAPI 3.1** (1 connections) — `docs/architecture/API_OPENAPI_SPECIFICATION.md`
- **NATSEventBusBridge** (1 connections) — `docs/architecture/DISTRIBUTED_EVENTBUS_NATS.md`
- **In-Process EventBus** (1 connections) — `docs/architecture/decisions/ADR-003-dual-event-systems-eventbus-nats.md`
