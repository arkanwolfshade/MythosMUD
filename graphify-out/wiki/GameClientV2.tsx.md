...
- **deriveLucidityStatusFromPlayer()** (3 connections) — `client/src/types/lucidity.ts`
- **TentacleBackdrop.tsx** (3 connections) — `client/src/components/ui-v2/TentacleBackdrop.tsx`
- **LocationPanelProps** (2 connections) — `client/src/components/ui-v2/panels/LocationPanel.tsx`
- *... and 26 more nodes in this community*

## Relationships

- [Room](Room.md) (24 shared connections)
...
- [health.ts](health.ts.md) (3 shared connections)
...
- [projectorRoom.ts](projectorRoom.ts.md) (1 shared connections)
