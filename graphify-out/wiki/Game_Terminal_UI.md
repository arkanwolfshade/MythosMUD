...
- **Factory method to create an environmental container.          Args:** (1 connections) — `server/models/container.py`
- **Factory method to create a wearable equipment container.          Args:** (1 connections) — `server/models/container.py`
