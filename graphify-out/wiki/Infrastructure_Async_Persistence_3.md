...
- **test_get_players_batch_with_players()** (2 connections) — `server/tests/unit/infrastructure/test_async_persistence_room_cache.py`
...
- [[Async Room Cache Tests]] (1 shared connections)
