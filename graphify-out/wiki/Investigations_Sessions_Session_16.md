...
- **unified_room_schema.json** (8 connections) — `tools/room_toolkit/room_validator/schemas/unified_room_schema.json`
...
- [Critical Coverage Improvement Plan](Critical_Coverage_Improvement_Plan.md) (1 shared connections)
