...
- **When both item_id and prototype_id present, use prototype_id for registry lookup** (1 connections) — `server/tests/unit/game/test_player_schema_converter_weapon.py`
