...
- **CommandPanel.tsx** (32 connections) — `client/src/components/panels/CommandPanel.tsx`
...
- **command-panel.test.tsx** (4 connections) — `client/src/components/__tests__/command-panel.test.tsx`
- **prepareCommandForSubmit()** (4 connections) — `client/src/components/panels/CommandPanel.tsx`
- **command-panel.spec.tsx** (4 connections) — `client/src/components/panels/__tests__/command-panel.spec.tsx`
- **command-panel.test.tsx** (4 connections) — `client/src/components/panels/__tests__/command-panel.test.tsx`
...
- **prependChannelShortcut()** (3 connections) — `client/src/components/panels/CommandPanel.tsx`
- **prependPartyPrefix()** (2 connections) — `client/src/components/panels/CommandPanel.tsx`
...
- **mockConsoleDebug** (1 connections) — `client/src/components/__tests__/CommandPanel.test.tsx`
...
- **STANDALONE_COMMANDS** (1 connections) — `client/src/components/panels/CommandPanel.tsx`
- **CommandPanelProps** (1 connections) — `client/src/components/panels/CommandPanel.tsx`
- **CommandPanelInput()** (1 connections) — `client/src/components/panels/CommandPanel.tsx`
- **CommandPanelHistory()** (1 connections) — `client/src/components/panels/CommandPanel.tsx`
- **CommandPanelFooter()** (1 connections) — `client/src/components/panels/CommandPanel.tsx`
