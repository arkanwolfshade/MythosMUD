...
- **main()** (5 connections) — `scripts/fix_markdown_code_block_style.py`
- **fix_markdown_file()** (5 connections) — `scripts/fix_markdown_multiple_blanks.py`
- **main()** (5 connections) — `scripts/fix_markdown_multiple_blanks.py`
...
- **Path** (4 connections) — `scripts/fix_markdown_common_issues.py`
