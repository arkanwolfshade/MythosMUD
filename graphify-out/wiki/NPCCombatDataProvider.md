...
- [CombatParticipantType](CombatParticipantType.md) (7 shared connections)
- [CombatService](CombatService.md) (4 shared connections)
- [npc_combat_integration_validation_mixin.py](npc_combat_integration_validation_mixin.py.md) (3 shared connections)
