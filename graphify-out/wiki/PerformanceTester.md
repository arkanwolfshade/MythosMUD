...
- **performanceTester.test.ts** (5 connections) — `client/src/utils/__tests__/performanceTester.test.ts`
...
- **PerformanceTestResult** (3 connections) — `client/src/utils/performanceTester.ts`
