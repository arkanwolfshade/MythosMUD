...
- **Update the last_active timestamp to current time.** (1 connections) — `server/models/game.py`
- *... and 17 more nodes in this community*

## Relationships

- [Combat NPC Lookup](Combat_NPC_Lookup.md) (9 shared connections)
- [Test Refactoring Complete](Test_Refactoring_Complete.md) (7 shared connections)
