...
- **Get NPC database URL for the specified environment.      Args:         environme** (1 connections) — `scripts/populate_npc_sample_data.py`
...
- **Populate a PostgreSQL database with sample NPC data.      Args:         database** (1 connections) — `scripts/populate_npc_sample_data.py`
