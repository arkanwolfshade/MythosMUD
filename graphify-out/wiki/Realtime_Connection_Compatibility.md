...
- **Compatibility helpers for connection manager.  This module provides compatibilit** (1 connections) — `server/realtime/connection_compatibility.py`
- **Create getter, setter, and deleter functions for a property.      Args:** (1 connections) — `server/realtime/connection_compatibility.py`
...
- **Test attach_compatibility_properties() attaches max_connection_attempts property** (1 connections) — `server/tests/unit/realtime/test_connection_compatibility.py`
