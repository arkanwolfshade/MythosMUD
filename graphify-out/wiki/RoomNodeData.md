...
- **saveRoomUpdates()** (2 connections) — `client/src/components/map/utils/saveMapChanges.ts`
- **SaveMapChangesOptions** (1 connections) — `client/src/components/map/utils/saveMapChanges.ts`
- **TODO: Implement room property save functionality when API endpoints are…** (1 connections) — `client/src/components/map/utils/saveMapChanges.ts`
- **TODO: Implement edge save functionality when API endpoints are available** (1 connections) — `client/src/components/map/utils/saveMapChanges.ts`

## Relationships

- [map/types.ts](map-types.ts.md) (13 shared connections)
- [edgeModalLogic.ts](edgeModalLogic.ts.md) (12 shared connections)
- [RoomMapEditorRuntime.hooks.ts](RoomMapEditorRuntime.hooks.ts.md) (11 shared connections)
