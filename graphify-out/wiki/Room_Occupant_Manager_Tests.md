...
- **designTokens.ts** (22 connections) — `client/src/components/ui/designTokens.ts`
- **designTokens.test.ts** (13 connections) — `client/src/components/ui/__tests__/designTokens.test.ts`
- **buildClasses** (4 connections) — `client/src/components/ui/designTokens.ts`
...
- [Rooms List SQL Bug](Rooms_List_SQL_Bug.md) (4 shared connections)
