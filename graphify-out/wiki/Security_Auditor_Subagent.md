...
- **Security Auditor Subagent** (12 connections) — `.cursor/agents/security-auditor.md`
...
- **Authentication & Authorization** (1 connections) — `.cursor/agents/security-auditor.md`
- **Authentication Security Review** (1 connections) — `.cursor/agents/security-auditor.md`
- **COPPA Compliance** (1 connections) — `.cursor/agents/security-auditor.md`
