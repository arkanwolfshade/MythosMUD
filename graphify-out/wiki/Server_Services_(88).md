...
- **Test _cleanup_async_state handles AttributeError from lock.locked().** (2 connections) — `server/tests/unit/services/test_inventory_mutation_guard_error_handling.py`
