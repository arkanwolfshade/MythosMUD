...
- **usePerformanceMonitor()** (3 connections) — `client/src/hooks/usePerformanceMonitor.ts`
- **PerformanceMetrics** (2 connections) — `client/src/hooks/usePerformanceMonitor.ts`
