...
- **MythosMUD Code Quality AI Skill** (3 connections) — `.claude/skills/mythosmud-code-quality-ai/SKILL.md`
- **MythosMUD Pre-Commit Checklist Skill** (2 connections) — `.claude/skills/mythosmud-pre-commit-checklist/SKILL.md`
- **Lizard Complexity Config** (2 connections) — `.codacy/tools-configs/lizard.yaml`
...
- **Definition of Done** (1 connections) — `.claude/skills/mythosmud-pre-commit-checklist/SKILL.md`
- **Full Pipeline (Optional)** (1 connections) — `.claude/skills/mythosmud-pre-commit-checklist/SKILL.md`
- **Order** (1 connections) — `.claude/skills/mythosmud-pre-commit-checklist/SKILL.md`
- **Reference** (1 connections) — `.claude/skills/mythosmud-pre-commit-checklist/SKILL.md`
- **Codacy Runtime Config** (1 connections) — `.codacy/codacy.yaml`
