...
- **isValidPlayer()** (2 connections) — `client/src/components/ui-v2/eventHandlers/roomHandlers.ts`
- **buildGameStateResult()** (2 connections) — `client/src/components/ui-v2/eventHandlers/roomHandlers.ts`
- **logGameStateOccupantDebug()** (2 connections) — `client/src/components/ui-v2/eventHandlers/roomHandlers.ts`
