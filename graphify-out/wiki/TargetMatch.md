...
- [spell_effects_heal.py](spell_effects_heal.py.md) (39 shared connections)
- [SpellRegistry](SpellRegistry.md) (39 shared connections)
- [test_spell_effects.py](test_spell_effects.py.md) (20 shared connections)
...
- [game.py](game.py.md) (12 shared connections)
- [get_logger](get_logger.md) (9 shared connections)
- [_MagicServiceCore](_MagicServiceCore.md) (8 shared connections)
- [.resolve_spell_target](resolve_spell_target.md) (7 shared connections)
- [TauntCommandHandler](TauntCommandHandler.md) (7 shared connections)
