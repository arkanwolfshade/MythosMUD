...
- **Get a player's current pose. Args: player_id: ID of the player pose_manager:…** (1 connections) — `server/game/chat_pose_helpers.py`
- **Unit tests for chat pose helpers.** (1 connections) — `server/tests/unit/game/test_chat_pose_helpers.py`

## Relationships

- [Chat Service & Channels](Chat_Service_&_Channels.md) (13 shared connections)
