...
- **_get_viewer_phantom_names()** (7 connections) — `server/commands/look_room.py`
...
- [Look Command](Look_Command.md) (7 shared connections)
- [Test Look Npc Helpers](Test_Look_Npc_Helpers.md) (4 shared connections)
- [Player Occupant Processor](Player_Occupant_Processor.md) (4 shared connections)
- [Test Room Renderer](Test_Room_Renderer.md) (4 shared connections)
...
- [Test Look Npc](Test_Look_Npc.md) (1 shared connections)
