...
- **test_validate_codacy_coverage_gate.py** (11 connections) — `server/tests/unit/test_validate_codacy_coverage_gate.py`
- **Path** (7 connections)
- **_CodacyGateModule** (4 connections) — `server/tests/unit/test_validate_codacy_coverage_gate.py`
- **test_validate_python_gate_fails_when_report_has_no_classes()** (3 connections) — `server/tests/unit/test_validate_codacy_coverage_gate.py`
- **test_validate_python_gate_passes_with_unprefixed_filenames()** (3 connections) — `server/tests/unit/test_validate_codacy_coverage_gate.py`
...
- **`coverage xml --cov=server` writes `<source>server</source>` and lists…** (1 connections) — `server/tests/unit/test_validate_codacy_coverage_gate.py`
- **An empty/malformed Cobertura report (no <class> elements at all) must still be…** (1 connections) — `server/tests/unit/test_validate_codacy_coverage_gate.py`
