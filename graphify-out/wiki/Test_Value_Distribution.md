...
- [Cursor Plans Combat](Cursor_Plans_Combat.md) (13 shared connections)
- [Combat Aggro Threat](Combat_Aggro_Threat.md) (7 shared connections)
- [Persistence Item Instance](Persistence_Item_Instance.md) (7 shared connections)
- [App Lifespan Management](App_Lifespan_Management.md) (5 shared connections)
- [Phantom Hostile Requirements](Phantom_Hostile_Requirements.md) (5 shared connections)
