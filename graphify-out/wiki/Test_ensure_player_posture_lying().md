# Test ensure player posture lying()
...
- **Test _ensure_player_posture_lying() does nothing when already lying.** (1 connections) — `server/tests/unit/services/test_player_death_service.py`
