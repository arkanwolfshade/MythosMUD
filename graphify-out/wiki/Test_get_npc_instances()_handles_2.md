# Test get npc instances() handles
...
- **Test get_npc_instances() handles NPC without get_stats method.** (1 connections) — `server/tests/unit/services/test_npc_instance_service.py`
