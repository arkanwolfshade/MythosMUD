# Test unsubscribe from subzone unsubscribes
...
- **Test unsubscribe_from_subzone unsubscribes from subzone.** (1 connections) — `server/tests/unit/realtime/test_nats_message_handler.py`
