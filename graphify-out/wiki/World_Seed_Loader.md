...
- **Popen** (2 connections)
- **Validate DATABASE_URL and required files exist.** (1 connections) — `scripts/load_world_seed.py`
- **Print current table counts, handling missing tables gracefully.** (1 connections) — `scripts/load_world_seed.py`
