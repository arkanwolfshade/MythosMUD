...
- **Typed stand-in for ConnectionManager; MagicMock attributes are Any.** (1 connections) — `server/tests/unit/realtime/test_connection_establishment.py`

## Relationships

- [test_connection_establishment.py](test_connection_establishment.py.md) (3 shared connections)
- [_as_mgr](_as_mgr.md) (2 shared connections)
