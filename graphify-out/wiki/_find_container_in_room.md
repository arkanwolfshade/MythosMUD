...
- **Find a container in room containers by name or container_id. Args: containers:…** (1 connections) — `server/commands/look_container.py`
- **Test _find_container_in_room() with instance number out of range.** (1 connections) — `server/tests/unit/commands/test_look_container_helpers.py`
- **Test _find_container_in_room() with instance number zero.** (1 connections) — `server/tests/unit/commands/test_look_container_helpers.py`
...
- **Test _find_container_in_room() with instance number.** (1 connections) — `server/tests/unit/commands/test_look_container_helpers.py`
- **Test _find_container_in_room() with empty list.** (1 connections) — `server/tests/unit/commands/test_look_container_helpers.py`
- **Test _find_container_in_room() with no matching containers.** (1 connections) — `server/tests/unit/commands/test_look_container_helpers.py`
- **Test _find_container_in_room() with multiple matches (ambiguous).** (1 connections) — `server/tests/unit/commands/test_look_container_helpers.py`
- **Test finding container in room by name.** (1 connections) — `server/tests/unit/commands/test_look_container.py`
- *... and 5 more nodes in this community*

## Relationships

- [test_look_container_helpers.py](test_look_container_helpers.py.md) (10 shared connections)
- [test_look_container.py](test_look_container.py.md) (7 shared connections)
