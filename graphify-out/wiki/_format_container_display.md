...
- **Test _format_container_display() with target_type container.** (1 connections) — `server/tests/unit/commands/test_look_container_helpers.py`
...
- [test_look_container.py](test_look_container.py.md) (9 shared connections)
...
- [_format_container_contents](_format_container_contents.md) (1 shared connections)
