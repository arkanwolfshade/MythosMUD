...
- [test_occupant_formatter.py](test_occupant_formatter.py.md) (4 shared connections)
- [._is_valid_name_for_occupant](_is_valid_name_for_occupant.md) (2 shared connections)
