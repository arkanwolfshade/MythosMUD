...
- **test_get_spawn_rule_not_found()** (4 connections) — `server/tests/unit/services/test_npc_service.py`
...
- [test_npc_service.py](test_npc_service.py.md) (10 shared connections)
