...
- **add_hashed_password_column.py** (5 connections) — `server/scripts/add_hashed_password_column.py`
...
- **Apply the migration to add hashed_password column. Args: database_url:…** (1 connections) — `server/scripts/add_hashed_password_column.py`
