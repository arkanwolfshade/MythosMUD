...
- **ensurePlayableConnection()** (32 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
- **multiplayer-ready.ts** (25 connections) — `client/tests/e2e/runtime/fixtures/multiplayer-ready.ts`
