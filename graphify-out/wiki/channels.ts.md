...
- **DEFAULT_CHANNEL** (11 connections) — `client/src/config/channels.ts`
...
- **CHAT_CHANNEL_OPTIONS** (6 connections) — `client/src/config/channels.ts`
