...
- **OccupantsPanel.tsx** (6 connections) — `client/src/components/ui-v2/panels/OccupantsPanel.tsx`
...
- **panelLayout.ts** (5 connections) — `client/src/components/ui-v2/utils/panelLayout.ts`
- **createDefaultPanelLayout()** (5 connections) — `client/src/components/ui-v2/utils/panelLayout.ts`
...
- [game terminal lucidity](game_terminal_lucidity.md) (26 shared connections)
- [PanelSystem PanelManager panelLayoutClam](PanelSystem_PanelManager_panelLayoutClam.md) (22 shared connections)
- [Game Terminal UI](Game_Terminal_UI.md) (10 shared connections)
- [panels chat ChatPanelRuntimeViewParts](panels_chat_ChatPanelRuntimeViewParts.md) (8 shared connections)
