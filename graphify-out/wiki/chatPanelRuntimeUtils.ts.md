...
- **buildChatSearchHighlightHtml()** (5 connections) — `client/src/components/panels/chatPanelRuntimeUtils.ts`
- **escapeForChatHighlight()** (5 connections) — `client/src/components/panels/chatPanelRuntimeUtils.ts`
