...
- **.claude/hooks/record_edited_file.py** (9 connections) — `.claude/hooks/record_edited_file.py`
- **_is_test_file()** (6 connections) — `.claude/hooks/record_edited_file.py`
- **main()** (6 connections) — `.claude/hooks/record_edited_file.py`
...
- **Return True if the file is a test file and should NOT trigger the test agent.…** (1 connections) — `.claude/hooks/record_edited_file.py`
