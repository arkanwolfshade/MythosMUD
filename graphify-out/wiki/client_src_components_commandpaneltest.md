# client src components commandpaneltest
...
- **CommandPanelTestLayoutProps** (2 connections) — `client/src/components/CommandPanelTest.layout.tsx`
- **CommandControlsProps** (2 connections) — `client/src/components/CommandPanelTest.types.ts`
- **appendCommands()** (2 connections) — `client/src/components/CommandPanelTest.tsx`
- **CommandCategories()** (2 connections) — `client/src/components/CommandPanelTest.categories.tsx`
- **CommandControls()** (2 connections) — `client/src/components/CommandPanelTest.controls.tsx`
- **CommandStats()** (2 connections) — `client/src/components/CommandPanelTest.stats.tsx`
- *... and 18 more nodes in this community*

## Relationships

- [client src components chatpaneltest](client_src_components_chatpaneltest.md) (14 shared connections)
- [client src components containers backpacktab](client_src_components_containers_backpacktab.md) (4 shared connections)
- [client src components ui designtokens](client_src_components_ui_designtokens.md) (2 shared connections)
