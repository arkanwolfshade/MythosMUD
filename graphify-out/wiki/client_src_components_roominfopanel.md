# client src components roominfopanel
...
- **__tests__/RoomInfoPanel.test.tsx** (4 connections) — `client/src/components/__tests__/RoomInfoPanel.test.tsx`
- **components/RoomInfoPanel.test.tsx** (3 connections) — `client/src/components/RoomInfoPanel.test.tsx`
...
- [client src components gameterminal](client_src_components_gameterminal.md) (2 shared connections)
- [client src components gameterminalpresentation](client_src_components_gameterminalpresentation.md) (2 shared connections)
- [client src components gameterminal gameterminalprops](client_src_components_gameterminal_gameterminalprops.md) (2 shared connections)
