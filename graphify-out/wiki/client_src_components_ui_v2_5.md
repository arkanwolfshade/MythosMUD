...
- **resolvePreservedOccupantArrays()** (4 connections) — `client/src/components/ui-v2/eventLog/projectorRoom.ts`
- *... and 22 more nodes in this community*

## Relationships

- [client src components gameterminal gameterminalprops](client_src_components_gameterminal_gameterminalprops.md) (28 shared connections)
- [client src components ui v2](client_src_components_ui_v2.md) (9 shared connections)
- [client src components panels chatpanel](client_src_components_panels_chatpanel.md) (2 shared connections)
