# client tests e2e runtime character

> 67 nodes

## Key Concepts

- **fixtures/auth.ts** (91 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
- **loginPlayer()** (37 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
...
- **reopenPlayerPageIfClosed()** (11 connections) — `client/tests/e2e/runtime/fixtures/multiplayer-contexts.ts`
...
- **executeCommandTrusted()** (7 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
...
- **assertNoRestDisconnectPollution()** (5 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
...
- [client tests e2e runtime accessibility](client_tests_e2e_runtime_accessibility.md) (80 shared connections)
- [client src utils deathvoidlocation](client_src_utils_deathvoidlocation.md) (28 shared connections)
- [client tests e2e runtime character](client_tests_e2e_runtime_character.md) (18 shared connections)
- [client tests e2e runtime communication](client_tests_e2e_runtime_communication.md) (16 shared connections)
- [client tests e2e runtime fixtures](client_tests_e2e_runtime_fixtures.md) (16 shared connections)
- [client src test e2e bootstrap](client_src_test_e2e_bootstrap.md) (5 shared connections)
- [client tests e2e di migration](client_tests_e2e_di_migration.md) (4 shared connections)
