...
- **command_handler_unified.py** (51 connections) — `server/command_handler_unified.py`
...
- [catatonia_check.py](catatonia_check.py.md) (19 shared connections)
...
- [process_command_with_validation](process_command_with_validation.md) (4 shared connections)
