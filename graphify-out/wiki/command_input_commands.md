...
- **test_npc_base_from_dict()** (3 connections) — `server/tests/unit/npc/test_npc_base.py`
...
- **test_npc_base_to_dict_and_context()** (2 connections) — `server/tests/unit/npc/test_npc_base.py`
