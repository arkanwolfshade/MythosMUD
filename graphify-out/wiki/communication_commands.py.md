...
- **PlayerWithPose** (5 connections) — `server/commands/communication_commands_support.py`
...
- **Communication commands for MythosMUD. Handlers delegate heavy logic to…** (1 connections) — `server/commands/communication_commands.py`
- *... and 21 more nodes in this community*

## Relationships

- [AliasStorage](AliasStorage.md) (13 shared connections)
- [test_communication_commands_channels.py](test_communication_commands_channels.py.md) (13 shared connections)
- [communication_commands_flows.py](communication_commands_flows.py.md) (12 shared connections)
- [handle_whisper_command](handle_whisper_command.md) (12 shared connections)
