...
- **test_find_item_in_container_by_index_and_name()** (2 connections) — `server/tests/unit/commands/test_container_helpers_inventory_ops.py`
...
- [test_container_helpers_inventory_ops.py](test_container_helpers_inventory_ops.py.md) (37 shared connections)
