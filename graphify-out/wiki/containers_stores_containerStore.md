...
- **InventoryStack** (5 connections) — `client/src/stores/containerStore.ts`
- **isOpenContainerApiResponse()** (3 connections) — `client/src/utils/apiTypeGuards.ts`
- **formatWeaponStats()** (2 connections) — `client/src/components/containers/ContainerSplitPane.tsx`
- **ContainerSplitPaneProps** (2 connections) — `client/src/components/containers/ContainerSplitPane.tsx`
