...
- **sub_zone** (5 connections) — `schemas/room_schema.json`
...
- [tools room toolkit room validator](tools_room_toolkit_room_validator.md) (2 shared connections)
...
- [schemas unified room schema](schemas_unified_room_schema.md) (1 shared connections)
