# docs architecture decisions adr 011
...
- **ADR-012-python-statemachine-backend.md** (3 connections) — `docs/architecture/decisions/ADR-012-python-statemachine-backend.md`
