# docs archive nats remediation summary

> 20 nodes

## Key Concepts

- **NATS Anti-Patterns Remediation Summary** (13 connections) — `docs/archive/NATS_REMEDIATION_SUMMARY_2026-01-13.md`
...
- [docs archive nats anti patterns](docs_archive_nats_anti_patterns.md) (1 shared connections)
- [docs archive nats complete remediation](docs_archive_nats_complete_remediation.md) (1 shared connections)
