...
- **__filename** (1 connections) — `client/src/test/e2e-bootstrap.ts`
- **__dirname** (1 connections) — `client/src/test/e2e-bootstrap.ts`
- **E2E_BOOTSTRAP_LOG_DIR** (1 connections) — `client/src/test/e2e-bootstrap.ts`
- *... and 1 more nodes in this community*

## Relationships

- [quest e2e spec](quest_e2e_spec.md) (4 shared connections)
- [e2e fixtures multiplayer](e2e_fixtures_multiplayer.md) (3 shared connections)
- [e2e combat spec](e2e_combat_spec.md) (1 shared connections)
