...
- **waitForMessage()** (49 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
- **collect-n-quest.spec.ts** (28 connections) — `client/tests/e2e/runtime/quest/collect-n-quest.spec.ts`
- **getMessages()** (24 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
- **executeCommandWithoutRecovery()** (13 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
...
- **escapeRegExp()** (1 connections) — `client/tests/e2e/runtime/muting/muting-system-emotes.spec.ts`
- **waitForDisconnectBannerClear()** (1 connections) — `client/tests/e2e/runtime/muting/muting-system-emotes.spec.ts`
- **getIthaquaMuteTargetName()** (1 connections) — `client/tests/e2e/runtime/muting/muting-system-emotes.spec.ts`
...
- `client/tests/e2e/runtime/muting/muting-system-emotes.spec.ts`
