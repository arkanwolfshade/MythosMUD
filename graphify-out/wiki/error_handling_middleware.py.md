...
- **Error handling middleware for FastAPI integration. This module provides…** (1 connections) — `server/middleware/error_handling_middleware.py`
...
- **Narrowing for dynamic request.state.user shapes that expose .id (non-Mapping).** (1 connections) — `server/middleware/error_handling_middleware.py`
...
- [._handle_exception](_handle_exception.md) (1 shared connections)
