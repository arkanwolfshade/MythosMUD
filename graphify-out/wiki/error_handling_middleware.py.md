...
- **ErrorHandlingMiddleware** (13 connections) — `server/middleware/error_handling_middleware.py`
...
- **register_error_handlers()** (8 connections) — `server/middleware/error_handling_middleware.py`
