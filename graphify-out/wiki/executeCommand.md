...
- **executeCommand()** (68 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
- **player.ts** (32 connections) — `client/tests/e2e/runtime/fixtures/player.ts`
- **combat-messages-game-info.spec.ts** (31 connections) — `client/tests/e2e/runtime/combat/combat-messages-game-info.spec.ts`
- **whisper-movement.spec.ts** (23 connections) — `client/tests/e2e/runtime/communication/whisper-movement.spec.ts`
- **ensureStanding()** (18 connections) — `client/tests/e2e/runtime/fixtures/player.ts`
...
- **DEFAULT_SPAWN_LOOK_CUE** (4 connections) — `client/tests/e2e/runtime/fixtures/test-data.ts`
...
- [multiplayer.ts](multiplayer.ts.md) (105 shared connections)
- [fixtures/auth.ts](fixtures-auth.ts.md) (24 shared connections)
