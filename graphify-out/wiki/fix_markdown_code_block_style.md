...
- **Try to detect the language of a code block from its content.     Returns empty s** (1 connections) — `scripts/fix_markdown_code_block_style.py`
- **Convert indented code blocks to fenced code blocks.      Returns:         (new_c** (1 connections) — `scripts/fix_markdown_code_block_style.py`
