...
- **Fix MD051: Fix invalid link fragments by generating proper anchors.      Scans f** (1 connections) — `scripts/fix_markdown_common_issues.py`
- **Fix common markdown issues in a file.      Returns: (changed, list of fixes appl** (1 connections) — `scripts/fix_markdown_common_issues.py`
