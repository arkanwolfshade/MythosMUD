...
- **loginPlayer()** (42 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
- **test-data.ts** (26 connections) — `client/tests/e2e/runtime/fixtures/test-data.ts`
- **waitForPlayableSession()** (16 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
- **TEST_TIMEOUTS** (14 connections) — `client/tests/e2e/runtime/fixtures/test-data.ts`
