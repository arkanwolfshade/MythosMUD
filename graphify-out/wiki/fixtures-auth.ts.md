...
- **fixtures/auth.ts** (77 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
- **loginPlayer()** (31 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
- **test-data.ts** (22 connections) — `client/tests/e2e/runtime/fixtures/test-data.ts`
- **waitForPlayableSession()** (14 connections) — `client/tests/e2e/runtime/fixtures/auth.ts`
