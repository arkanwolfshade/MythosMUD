...
- **__init__.py** (6 connections) — `server/tests/fixtures/shared/__init__.py`
...
- **stub_persistence()** (3 connections) — `server/tests/fixtures/shared/__init__.py`
- **fake_clock()** (2 connections) — `server/tests/fixtures/shared/__init__.py`
