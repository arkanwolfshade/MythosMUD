...
- **Validate app state has required components for status effect processing.…** (1 connections) — `server/app/game_tick_status_effects.py`
- **Process a damage over time effect. Returns: True if effect was applied, False…** (1 connections) — `server/app/game_tick_status_effects.py`
- **Process a heal over time effect. Returns: True if effect was applied, False…** (1 connections) — `server/app/game_tick_status_effects.py`

## Relationships

- [test_game_tick_processing.py](test_game_tick_processing.py.md) (18 shared connections)
- [game_tick_death.py](game_tick_death.py.md) (13 shared connections)
