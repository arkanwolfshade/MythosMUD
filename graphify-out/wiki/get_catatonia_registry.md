...
- **TestGetCatatoniaRegistry** (4 connections) — `server/tests/unit/infrastructure/test_dependencies.py`
...
- **Get a CatatoniaRegistry instance with dependency injection. Args: request: The…** (1 connections) — `server/dependencies.py`
