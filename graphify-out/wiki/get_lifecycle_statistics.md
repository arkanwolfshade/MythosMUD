...
- **Get overall lifecycle statistics. Returns: Dictionary containing lifecycle…** (1 connections) — `server/npc/lifecycle_manager.py`
...
- **Return (total_spawns, total_despawns, total_errors) across all lifecycle…** (1 connections) — `server/npc/lifecycle_manager.py`
