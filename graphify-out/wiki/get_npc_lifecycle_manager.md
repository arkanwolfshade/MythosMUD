...
- **TestGetNPCLifecycleManager** (4 connections) — `server/tests/unit/infrastructure/test_dependencies.py`
...
- **Get an NPCLifecycleManager instance with dependency injection. Args: request:…** (1 connections) — `server/dependencies.py`
