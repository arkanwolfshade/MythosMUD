...
- **get_spell_targeting_service()** (7 connections) — `server/dependencies.py`
- **TestGetSpellTargetingService** (4 connections) — `server/tests/unit/infrastructure/test_dependencies.py`
...
- **Get a SpellTargetingService instance with dependency injection. Args: request:…** (1 connections) — `server/dependencies.py`
