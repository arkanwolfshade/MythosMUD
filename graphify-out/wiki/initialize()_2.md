...
- **Unsubscribe all handlers for a specific service.          Args:             serv** (1 connections) — `server/events/event_bus.py`
- **Shutdown the pure asyncio event bus with proper grace period coordination.** (1 connections) — `server/events/event_bus.py`
