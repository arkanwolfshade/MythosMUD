...
- **True if the first bytes look like binary or UTF-16 BOM, not plain UTF-8 JSON tex** (1 connections) — `scripts/jackson_linter.py`
...
- **Discover JSON files under cwd, validate syntax, return exit code (0 ok, 1 failur** (1 connections) — `scripts/jackson_linter.py`
