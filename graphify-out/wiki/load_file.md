...
- [validate_calendar.py](validate_calendar.py.md) (3 shared connections)
- [test_calendar_schemas.py](test_calendar_schemas.py.md) (2 shared connections)
- [HolidayCollection](HolidayCollection.md) (1 shared connections)
- [ScheduleCollection](ScheduleCollection.md) (1 shared connections)
