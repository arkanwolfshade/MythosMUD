...
- **Find f-string logging violations in a Python file using AST parsing.      This m** (1 connections) — `scripts/check_logging_patterns.py`
- **Format violation report for display.      Args:         violations: List of (fil** (1 connections) — `scripts/check_logging_patterns.py`
