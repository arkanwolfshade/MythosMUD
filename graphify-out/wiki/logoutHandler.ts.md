...
- **secureTokenStorage** (15 connections) — `client/src/utils/security.ts`
...
- **mockLogoutHandler** (1 connections) — `client/src/__tests__/App.logout.test.tsx`
- **fetchSpy** (1 connections) — `client/src/__tests__/LogoutFlow.integration.test.tsx`
- **mockLogoutHandler** (1 connections) — `client/src/__tests__/LogoutFlow.integration.test.tsx`
...
- [CatalogPage.tsx](CatalogPage.tsx.md) (1 shared connections)
