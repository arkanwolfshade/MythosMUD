...
- **statusParser.ts** (12 connections) — `client/src/utils/statusParser.ts`
...
- **extractChannelFromMessage()** (5 connections) — `client/src/utils/messageTypeUtils.ts`
- **convertToPlayerInterface()** (5 connections) — `client/src/utils/statusParser.ts`
...
- **isChatContent()** (4 connections) — `client/src/utils/messageTypeUtils.ts`
