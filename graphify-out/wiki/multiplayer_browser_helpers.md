...
- **isValidElement()** (2 connections) — `client/tests/e2e/runtime/fixtures/multiplayer-browser-helpers.js`
...
- [e2e fixtures multiplayer](e2e_fixtures_multiplayer.md) (1 shared connections)
