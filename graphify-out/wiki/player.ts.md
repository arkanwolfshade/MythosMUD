...
- **player.ts** (48 connections) — `client/tests/e2e/runtime/fixtures/player.ts`
...
- **ensurePlayableAlive()** (22 connections) — `client/tests/e2e/runtime/fixtures/player.ts`
- **despawnSanitariumCultists()** (11 connections) — `client/tests/e2e/runtime/fixtures/player.ts`
...
- **isPlayerDead()** (5 connections) — `client/tests/e2e/runtime/fixtures/player.ts`
- **locationIndicatesDeathVoid()** (4 connections) — `client/src/utils/deathVoidLocation.ts`
- **requiredAliveButDeadMessage()** (4 connections) — `client/src/utils/deathVoidLocation.ts`
...
- **deathVoidLocation.ts** (4 connections) — `client/src/utils/deathVoidLocation.ts`
