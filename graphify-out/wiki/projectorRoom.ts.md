...
- **appendMessage()** (5 connections) — `client/src/components/ui-v2/eventLog/projectorMessageUtils.ts`
- **buildChatMessage()** (5 connections) — `client/src/components/ui-v2/eventLog/projectorMessageUtils.ts`
...
- **appendPostureGameInfoMessage()** (4 connections) — `client/src/components/ui-v2/eventLog/projectorHandlersState.ts`
...
- [ui-v2/types.ts](ui-v2-types.ts.md) (31 shared connections)
- [HeaderBar.tsx](HeaderBar.tsx.md) (5 shared connections)
