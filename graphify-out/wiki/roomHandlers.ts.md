...
- **roomHandlers.ts** (43 connections) — `client/src/components/ui-v2/eventHandlers/roomHandlers.ts`
- **roomHandlers.test.ts** (12 connections) — `client/src/components/ui-v2/eventHandlers/__tests__/roomHandlers.test.ts`
- **handleRoomUpdate()** (9 connections) — `client/src/components/ui-v2/eventHandlers/roomHandlers.ts`
