...
- **roomHandlers.ts** (37 connections) — `client/src/components/ui-v2/eventHandlers/roomHandlers.ts`
...
- **gameClientLogout.ts** (4 connections) — `client/src/components/ui-v2/hooks/gameClientLogout.ts`
...
- **mergeTopLevelOccupants()** (3 connections) — `client/src/components/ui-v2/eventHandlers/roomHandlers.ts`
...
- **resolveOccupantsForRoomUpdate()** (3 connections) — `client/src/components/ui-v2/eventHandlers/roomHandlers.ts`
...
- [useWebSocketConnection.ts](useWebSocketConnection.ts.md) (4 shared connections)
- [useGameConnectionRefactored.ts](useGameConnectionRefactored.ts.md) (4 shared connections)
...
- [deleteCharacterFlow.ts](deleteCharacterFlow.ts.md) (2 shared connections)
