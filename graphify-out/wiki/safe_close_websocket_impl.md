...
- **connection_websocket_close.py** (7 connections) — `server/realtime/connection_websocket_close.py`
...
- [test_connection_disconnection_websockets.py](test_connection_disconnection_websockets.py.md) (2 shared connections)
