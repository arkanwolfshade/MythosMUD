...
- **⚠️ VIOLATION = COMPLETE FAILURE** (1 connections) — `e2e-tests/scenarios/scenario-25-container-wearable-management.md`
...
- **Test Configuration** (1 connections) — `e2e-tests/scenarios/scenario-25-container-wearable-management.md`
- **Why Playwright MCP is Required** (1 connections) — `e2e-tests/scenarios/scenario-25-container-wearable-management.md`
...
- **STEP 4 of 8: Open Wearable Container via Backpack Tab** (1 connections) — `e2e-tests/scenarios/scenario-25-container-wearable-management.md`
- **✅ Step 4 Completion Checklist** (1 connections) — `e2e-tests/scenarios/scenario-25-container-wearable-management.md`
- **STEP 5 of 8: Transfer Items to Wearable Container** (1 connections) — `e2e-tests/scenarios/scenario-25-container-wearable-management.md`
