...
- **_determine_database_init_flags()** (4 connections) — `scripts/init_npc_database.py`
- **get_npc_database_url()** (3 connections) — `scripts/init_npc_database.py`
