...
- **get_skill_service()** (7 connections) — `server/dependencies.py`
...
- [TestGetPlayerService](TestGetPlayerService.md) (5 shared connections)
...
- [TestGetCatatoniaRegistry](TestGetCatatoniaRegistry.md) (3 shared connections)
