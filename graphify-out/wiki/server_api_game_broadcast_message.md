# server api game broadcast message
...
- **TestGetGameStatus** (4 connections) — `server/tests/unit/api/test_game.py`
...
- [claude rules fastapi](claude_rules_fastapi.md) (14 shared connections)
