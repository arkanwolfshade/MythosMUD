# server commands admin permission utils
...
- [server commands admin teleport commands](server_commands_admin_teleport_commands.md) (5 shared connections)
...
- [server commands goto helpers](server_commands_goto_helpers.md) (3 shared connections)
