# server commands debrief command
...
- [server models lucidity](server_models_lucidity.md) (8 shared connections)
- [server commands admin commands](server_commands_admin_commands.md) (4 shared connections)
- [server services active lucidity service](server_services_active_lucidity_service.md) (4 shared connections)
- [claude rules sqlalchemy](claude_rules_sqlalchemy.md) (3 shared connections)
- [server commands lucidity recovery commands](server_commands_lucidity_recovery_commands.md) (3 shared connections)
...
- [server models lucidity lucidityactioncode](server_models_lucidity_lucidityactioncode.md) (1 shared connections)
