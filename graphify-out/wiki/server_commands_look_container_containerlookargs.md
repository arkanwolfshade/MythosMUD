...
- **_format_container_display()** (20 connections) — `server/commands/look_container.py`
...
- [server commands look container](server_commands_look_container.md) (49 shared connections)
