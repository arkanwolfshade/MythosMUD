...
- **Test getting NPC room ID from current_room_id.** (2 connections) — `server/tests/unit/commands/test_look_npc.py`
...
- [server commands look npc](server_commands_look_npc.md) (8 shared connections)
...
- [server commands look room](server_commands_look_room.md) (2 shared connections)
- [server commands look npc rationale](server_commands_look_npc_rationale.md) (1 shared connections)
