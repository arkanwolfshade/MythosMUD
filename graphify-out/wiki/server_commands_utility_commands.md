# server commands utility commands
...
- [server commands logout commands](server_commands_logout_commands.md) (3 shared connections)
- [server commands status commands](server_commands_status_commands.md) (3 shared connections)
...
- [server commands time commands handle](server_commands_time_commands_handle.md) (1 shared connections)
