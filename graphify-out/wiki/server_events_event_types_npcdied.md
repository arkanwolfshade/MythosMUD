# server events event types npcdied
...
- [claude rules asyncio](claude_rules_asyncio.md) (45 shared connections)
- [server app lifespan startup](server_app_lifespan_startup.md) (20 shared connections)
- [server config npc config](server_config_npc_config.md) (11 shared connections)
- [moduletype](moduletype.md) (6 shared connections)
- [server npc npc utils](server_npc_npc_utils.md) (5 shared connections)
- [jsondict](jsondict.md) (5 shared connections)
- [server npc npc base npcbase](server_npc_npc_base_npcbase.md) (4 shared connections)
...
- [server npc lifecycle manager npclifecyclemanager](server_npc_lifecycle_manager_npclifecyclemanager.md) (2 shared connections)
