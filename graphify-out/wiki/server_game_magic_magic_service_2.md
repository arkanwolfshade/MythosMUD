...
- **UUID** (12 connections)
- **Any** (11 connections)
- **MagicServiceCompletionMixin** (10 connections) — `server/game/magic/magic_service_completion.py`
- **SpellCostsService** (10 connections) — `server/game/magic/spell_costs.py`
