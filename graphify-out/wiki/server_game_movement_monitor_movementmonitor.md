# server game movement monitor movementmonitor
...
- [server api monitoring](server_api_monitoring.md) (5 shared connections)
- [server game movement monitor rationale](server_game_movement_monitor_rationale.md) (3 shared connections)
