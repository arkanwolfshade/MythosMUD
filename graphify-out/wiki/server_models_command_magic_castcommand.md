# server models command magic castcommand
...
- [claude rules pydantic](claude_rules_pydantic.md) (21 shared connections)
- [server tests unit structured logging](server_tests_unit_structured_logging.md) (2 shared connections)
- [server models command base basecommand](server_models_command_base_basecommand.md) (1 shared connections)
