# server persistence repositories profession repository
...
- **repo()** (3 connections) — `server/tests/unit/persistence/repositories/test_profession_repository.py`
- **test_get_all_professions_db_error()** (3 connections) — `server/tests/unit/persistence/repositories/test_profession_repository.py`
- **test_get_profession_by_id_not_found()** (3 connections) — `server/tests/unit/persistence/repositories/test_profession_repository.py`
...
- [server models profession profession](server_models_profession_profession.md) (1 shared connections)
