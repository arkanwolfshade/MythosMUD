...
- **test_create_player_name_exists()** (4 connections) — `server/tests/unit/game/test_player_service.py`
...
- [server exceptions rationale 179](server_exceptions_rationale_179.md) (4 shared connections)
- [computed field](computed_field.md) (4 shared connections)
