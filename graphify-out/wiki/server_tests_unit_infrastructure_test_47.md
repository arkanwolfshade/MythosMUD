...
- **Unit tests for async persistence layer: load_room_cache_async, query_rooms,…** (1 connections) — `server/tests/unit/infrastructure/test_async_persistence_room_cache.py`
- **Test _generate_room_id_from_zone_data when room ID needs generation.** (1 connections) — `server/tests/unit/infrastructure/test_async_persistence_room_cache.py`

## Relationships

- [server tests unit infrastructure test](server_tests_unit_infrastructure_test.md) (23 shared connections)
