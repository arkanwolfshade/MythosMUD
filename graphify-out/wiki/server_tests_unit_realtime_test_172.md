...
- **Test _validate_chat_message_fields raises TypeError for invalid sender_name…** (4 connections) — `server/tests/unit/realtime/test_nats_message_handler_chat.py`
