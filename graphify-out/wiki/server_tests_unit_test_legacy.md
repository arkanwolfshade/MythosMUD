...
- **Test error handler functions.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
- **Test mythos_exception_handler.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
- **Test mythos_exception_handler with debug enabled.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
- **Test general_exception_handler.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
- **Test logged_http_exception_handler for 401.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
- **Test logged_http_exception_handler for 404.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
- **Test logged_http_exception_handler for 422.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
- **Test logged_http_exception_handler for 429.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
- **Test http_exception_handler for 401.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
- *... and 3 more nodes in this community*

## Relationships

- [server error handlers pydantic error](server_error_handlers_pydantic_error.md) (17 shared connections)
- [server api character creation apply](server_api_character_creation_apply.md) (7 shared connections)
