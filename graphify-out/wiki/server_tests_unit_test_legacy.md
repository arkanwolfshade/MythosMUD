...
- **Test mythos_exception_handler sets request_id in context.** (1 connections) — `server/tests/unit/test_legacy_error_handlers.py`
...
- [server error types errorseverity](server_error_types_errorseverity.md) (16 shared connections)
