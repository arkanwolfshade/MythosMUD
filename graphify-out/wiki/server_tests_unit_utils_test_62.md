...
- **Extract sub-zone from room ID. Room ID format:…** (2 connections) — `server/utils/room_utils.py`
...
- [server realtime nats message handler](server_realtime_nats_message_handler.md) (1 shared connections)
- [server services chat channel logger](server_services_chat_channel_logger.md) (1 shared connections)
