...
- **_steal_life_resolve_target_dp()** (9 connections) — `server/game/magic/spell_effects_heal.py`
...
- **NpcIntegrationStringIdPort** (5 connections) — `server/game/magic/spell_effect_types.py`
...
- [Spell](Spell.md) (24 shared connections)
...
- [spell_effects_status.py](spell_effects_status.py.md) (4 shared connections)
...
- [test_spell.py](test_spell.py.md) (3 shared connections)
