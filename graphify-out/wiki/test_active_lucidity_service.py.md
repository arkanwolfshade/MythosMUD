...
- **test_perform_recovery_action_sets_cooldown()** (3 connections) — `server/tests/unit/services/test_active_lucidity_service.py`
- **test_perform_recovery_action_string_player_id()** (3 connections) — `server/tests/unit/services/test_active_lucidity_service.py`
- *... and 28 more nodes in this community*

## Relationships

- [NPCCombatLucidity](NPCCombatLucidity.md) (4 shared connections)
- [active_lucidity_service](active_lucidity_service.md) (3 shared connections)
...
- [UnknownLucidityActionError](UnknownLucidityActionError.md) (2 shared connections)
