...
- **get_current_lcd()** (11 connections) — `server/commands/admin_setlucidity_command.py`
...
- [admin_hallucinate_command.py](admin_hallucinate_command.py.md) (11 shared connections)
