...
- **test_hash_password_empty_string()** (3 connections) — `server/tests/unit/auth/test_argon2_utils.py`
- **test_hash_password_hashing_error()** (3 connections) — `server/tests/unit/auth/test_argon2_utils.py`
- **test_hash_password_invalid_type()** (3 connections) — `server/tests/unit/auth/test_argon2_utils.py`
- **test_hash_password_non_string_type()** (3 connections) — `server/tests/unit/auth/test_argon2_utils.py`
- **test_hash_password_success()** (3 connections) — `server/tests/unit/auth/test_argon2_utils.py`
- **test_hash_password_type_error()** (3 connections) — `server/tests/unit/auth/test_argon2_utils.py`
