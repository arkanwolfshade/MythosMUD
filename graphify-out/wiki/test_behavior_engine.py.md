...
- **Test _evaluate_boolean_condition() handles 'true' literal.** (1 connections) — `server/tests/unit/npc/test_behavior_engine.py`
...
- [test_evaluate_equality_not_equality](test_evaluate_equality_not_equality.md) (1 shared connections)
- [test_evaluate_equality_invalid_format](test_evaluate_equality_invalid_format.md) (1 shared connections)
- [test_evaluate_inequality_true](test_evaluate_inequality_true.md) (1 shared connections)
