...
- **Unit tests for chat message senders.** (1 connections) — `server/tests/unit/game/test_chat_message_senders.py`
- **MagicMock attributes are Any; getattr+cast is the typed access path.** (1 connections) — `server/tests/unit/game/test_chat_message_senders.py`

## Relationships

- [chat_service.py](chat_service.py.md) (32 shared connections)
