...
- **Test _publish_player_dp_update_event_impl handles no NATS service.** (1 connections) — `server/tests/unit/services/test_combat_persistence_handler_events.py`
- **Test _publish_player_dp_update_event_impl with all optional parameters.** (1 connections) — `server/tests/unit/services/test_combat_persistence_handler_events.py`
- **Test _publish_player_dp_update_event_impl handles event bus publish error.** (1 connections) — `server/tests/unit/services/test_combat_persistence_handler_events.py`
