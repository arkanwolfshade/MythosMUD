...
- **test_punch_command_target_max_length()** (3 connections) — `server/tests/unit/models/test_command_combat.py`
- **test_punch_command_target_min_length()** (3 connections) — `server/tests/unit/models/test_command_combat.py`
...
- **test_strike_command_target_max_length()** (3 connections) — `server/tests/unit/models/test_command_combat.py`
- **test_strike_command_target_min_length()** (3 connections) — `server/tests/unit/models/test_command_combat.py`
- **test_strike_command_validate_target_calls_validator()** (3 connections) — `server/tests/unit/models/test_command_combat.py`
- **test_strike_command_validate_target_none()** (3 connections) — `server/tests/unit/models/test_command_combat.py`
