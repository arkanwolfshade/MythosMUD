...
- **test_command_communication.py** (50 connections) — `server/tests/unit/models/test_command_communication.py`
- **command_communication.py** (20 connections) — `server/models/command_communication.py`
...
- **GlobalCommand** (12 connections) — `server/models/command_communication.py`
...
- **field_validator** (10 connections)
