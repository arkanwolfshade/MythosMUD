...
- **test_create_following_command()** (3 connections) — `server/tests/unit/utils/test_command_factories_exploration.py`
- **test_create_following_command_with_args()** (3 connections) — `server/tests/unit/utils/test_command_factories_exploration.py`
...
- **test_create_go_command_no_args()** (3 connections) — `server/tests/unit/utils/test_command_factories_exploration.py`
- **test_create_ground_command()** (3 connections) — `server/tests/unit/utils/test_command_factories_exploration.py`
- **test_create_ground_command_empty_target()** (3 connections) — `server/tests/unit/utils/test_command_factories_exploration.py`
...
- [BaseCommand](BaseCommand.md) (24 shared connections)
