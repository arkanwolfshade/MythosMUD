...
- **test_create_alias_command_no_args()** (3 connections) — `server/tests/unit/utils/test_command_factories_utility.py`
...
- **test_create_aliases_command_with_args()** (3 connections) — `server/tests/unit/utils/test_command_factories_utility.py`
