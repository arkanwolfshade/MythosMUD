...
- **test_command_magic.py** (31 connections) — `server/tests/unit/models/test_command_magic.py`
...
- **command_magic.py** (12 connections) — `server/models/command_magic.py`
- **SpellsCommand** (8 connections) — `server/models/command_magic.py`
- **StopCommand** (8 connections) — `server/models/command_magic.py`
- **TeachCommand** (8 connections) — `server/models/command_magic.py`
