...
- **test_get_command_processor()** (3 connections) — `server/tests/unit/utils/test_command_processor.py`
...
- [test_command_parser.py](test_command_parser.py.md) (4 shared connections)
