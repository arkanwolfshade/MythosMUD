...
- **test_normalize_inventory_slots()** (2 connections) — `server/tests/unit/commands/test_equipment_helpers.py`
...
- [test_inventory_helpers.py](test_inventory_helpers.py.md) (14 shared connections)
- [inventory_equip_command.py](inventory_equip_command.py.md) (10 shared connections)
- [inventory_unequip_command.py](inventory_unequip_command.py.md) (6 shared connections)
- [equipment_service.py](equipment_service.py.md) (1 shared connections)
