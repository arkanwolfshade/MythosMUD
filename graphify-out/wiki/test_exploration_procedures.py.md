...
- **test_exploration_procedures.py** (12 connections) — `server/tests/integration/test_exploration_procedures.py`
...
- [session_factory](session_factory.md) (10 shared connections)
