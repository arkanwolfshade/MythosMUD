...
- **test_send_initial_game_state_no_player()** (3 connections) — `server/tests/unit/realtime/integration/test_game_state_provider.py`
- **test_send_initial_game_state_send_fails()** (3 connections) — `server/tests/unit/realtime/integration/test_game_state_provider.py`
