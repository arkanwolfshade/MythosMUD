...
- **UUID** (2 connections)
- **Resolve room container / wearable container and transfer into inventory.** (1 connections) — `server/commands/inventory_get_command.py`
- **Get an item from a container into inventory.** (1 connections) — `server/commands/inventory_get_command.py`
