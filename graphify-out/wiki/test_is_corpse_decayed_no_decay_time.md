# test_is_corpse_decayed_no_decay_time
...
- **Test is_corpse_decayed() returns False when no decay time.** (1 connections) — `server/tests/unit/services/test_corpse_lifecycle_service.py`
