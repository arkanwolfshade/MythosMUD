...
- **Test _sync_player_position() does nothing when position is None.** (1 connections) — `server/tests/unit/commands/test_logout_commands_helpers.py`
- **Test _sync_player_position() does nothing when position matches.** (1 connections) — `server/tests/unit/commands/test_logout_commands_helpers.py`
- **Test _get_player_position_from_connection_manager() returns position.** (1 connections) — `server/tests/unit/commands/test_logout_commands_helpers.py`
...
- **Test _get_player_position_from_connection_manager() returns None when no…** (1 connections) — `server/tests/unit/commands/test_logout_commands_helpers.py`
...
- **Test _sync_player_position() updates player stats.** (1 connections) — `server/tests/unit/commands/test_logout_commands_helpers.py`
- **Test _get_player_position_from_connection_manager retrieves position by…** (1 connections) — `server/tests/unit/commands/test_logout_commands.py`
- **Test _get_player_position_from_connection_manager retrieves position by display…** (1 connections) — `server/tests/unit/commands/test_logout_commands.py`
- **Test _get_player_position_from_connection_manager returns None when player not…** (1 connections) — `server/tests/unit/commands/test_logout_commands.py`
...
- [_clear_corrupted_cache_entry](_clear_corrupted_cache_entry.md) (4 shared connections)
