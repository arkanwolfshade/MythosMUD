...
- **test_global_message_handler_factory()** (2 connections) — `server/tests/unit/realtime/test_message_handler_factory.py`
...
- [MessageHandler](MessageHandler.md) (13 shared connections)
