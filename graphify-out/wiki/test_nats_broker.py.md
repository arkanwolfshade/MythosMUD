...
- **test_request_success()** (3 connections) — `server/tests/unit/infrastructure/test_nats_broker.py`
- **test_request_timeout()** (3 connections) — `server/tests/unit/infrastructure/test_nats_broker.py`
- **test_subscribe_failure()** (3 connections) — `server/tests/unit/infrastructure/test_nats_broker.py`
- **test_subscribe_message_wrapper_calls_handler()** (3 connections) — `server/tests/unit/infrastructure/test_nats_broker.py`
