...
- **test_npc_combat_handlers.py** (21 connections) — `server/tests/unit/services/test_npc_combat_handlers.py`
...
- **Test _handle_npc_death_on_combat_end handles errors gracefully.** (1 connections) — `server/tests/unit/services/test_npc_combat_handlers.py`
- **Test handle_npc_death handles NPC death.** (1 connections) — `server/tests/unit/services/test_npc_combat_handlers.py`
