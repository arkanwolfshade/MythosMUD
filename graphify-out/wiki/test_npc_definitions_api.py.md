...
- **test_update_npc_definition_not_found()** (7 connections) — `server/tests/unit/api/test_npc_definitions_api.py`
...
- **test_delete_npc_definition_not_found()** (6 connections) — `server/tests/unit/api/test_npc_definitions_api.py`
- *... and 32 more nodes in this community*

## Relationships

- [test_admin_auth_service.py](test_admin_auth_service.py.md) (30 shared connections)
- [LoggedHTTPException](LoggedHTTPException.md) (10 shared connections)
- [pytest.md](pytest.md.md) (9 shared connections)
- [test_npc_instances_api.py](test_npc_instances_api.py.md) (6 shared connections)
...
- [definition.py](definition.py.md) (2 shared connections)
