...
- **Test remove_npc() removes optional NPC.** (1 connections) — `server/tests/unit/npc/test_population_stats.py`
- **Test remove_npc() decrements count when multiple exist.** (1 connections) — `server/tests/unit/npc/test_population_stats.py`
- **Test remove_npc() handles removal when NPC not found.** (1 connections) — `server/tests/unit/npc/test_population_stats.py`
