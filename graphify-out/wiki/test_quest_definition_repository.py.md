...
- **mock_quest_definition()** (3 connections) — `server/tests/unit/persistence/test_quest_definition_repository.py`
- **fixture** (2 connections)
- **Unit tests for QuestDefinitionRepository. Tests get_by_id, get_by_name, and…** (1 connections) — `server/tests/unit/persistence/test_quest_definition_repository.py`
