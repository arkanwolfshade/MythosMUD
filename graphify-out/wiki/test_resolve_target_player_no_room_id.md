# test_resolve_target_player_no_room_id
...
- **Test resolve_target() when player has no current_room_id.** (1 connections) — `server/tests/unit/services/test_target_resolution_service.py`
