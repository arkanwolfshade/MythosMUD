...
- [test_validate_room_exists_without_cache](test_validate_room_exists_without_cache.md) (1 shared connections)
- [test_validate_exit_exists_success](test_validate_exit_exists_success.md) (1 shared connections)
