...
- **test_update_room_position_room_missing()** (4 connections) — `server/tests/unit/api/test_rooms_api.py`
- **AsyncSession** (4 connections)
- **test_get_room_not_found()** (3 connections) — `server/tests/unit/api/test_rooms_api.py`
