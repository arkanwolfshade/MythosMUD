# test_search_players_in_room_empty_list
...
- **Test _search_players_in_room() with empty player list.** (1 connections) — `server/tests/unit/services/test_target_resolution_service.py`
