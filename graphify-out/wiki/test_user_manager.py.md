...
- **test_is_admin_cached()** (2 connections) — `server/tests/unit/services/test_user_manager.py`
- **test_is_admin_no_persistence()** (2 connections) — `server/tests/unit/services/test_user_manager.py`
- **test_is_admin_not_cached()** (2 connections) — `server/tests/unit/services/test_user_manager.py`
