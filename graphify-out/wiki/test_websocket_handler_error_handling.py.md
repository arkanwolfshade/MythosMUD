...
- **Unit tests for websocket handler error handling. Tests the error handling…** (1 connections) — `server/tests/unit/realtime/test_websocket_handler_error_handling.py`
