...
- **test_send_error_response_websocket_disconnect()** (3 connections) — `server/tests/unit/realtime/test_websocket_handler_validation_errors.py`
...
- [.state](state.md) (9 shared connections)
