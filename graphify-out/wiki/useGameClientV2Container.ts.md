...
- **SendMessageFn** (5 connections) — `client/src/utils/clientErrorReporter.ts`
- *... and 29 more nodes in this community*

## Relationships

- [eventHandlers/types.ts](eventHandlers-types.ts.md) (43 shared connections)
...
- [GameEvent](GameEvent.md) (1 shared connections)
