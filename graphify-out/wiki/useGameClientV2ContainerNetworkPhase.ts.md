...
- **useGameClientV2Container.ts** (20 connections) — `client/src/components/ui-v2/hooks/useGameClientV2Container.ts`
...
- **gameClientV2ContainerBuildReturn.ts** (15 connections) — `client/src/components/ui-v2/hooks/gameClientV2ContainerBuildReturn.ts`
- **useGameClientV2ContainerState.ts** (15 connections) — `client/src/components/ui-v2/hooks/useGameClientV2ContainerState.ts`
- **GameClientV2MergedSlice** (14 connections) — `client/src/components/ui-v2/hooks/gameClientV2ContainerTypes.ts`
...
- **ActiveEffectDisplay** (10 connections) — `client/src/components/ui-v2/utils/stateUpdateUtils.ts`
...
- **GameClientV2ContainerPublicApi** (6 connections) — `client/src/components/ui-v2/hooks/gameClientV2ContainerBuildReturn.ts`
...
- **useGameClientV2ContainerConnectionEffects.test.ts** (6 connections) — `client/src/components/ui-v2/hooks/__tests__/useGameClientV2ContainerConnectionEffects.test.ts`
- *... and 40 more nodes in this community*

## Relationships

- [ui-v2/types.ts](ui-v2-types.ts.md) (39 shared connections)
- [HeaderBar.tsx](HeaderBar.tsx.md) (7 shared connections)
...
- [health.ts](health.ts.md) (4 shared connections)
