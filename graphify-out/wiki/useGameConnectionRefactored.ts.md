...
- **useGameConnection()** (11 connections) — `client/src/hooks/useGameConnectionRefactored.ts`
...
- **UseGameConnectionOptions** (2 connections) — `client/src/hooks/useGameConnectionRefactored.ts`
...
- **__tests__/useConnectionStateMachine.test.ts** (2 connections) — `client/src/hooks/__tests__/useConnectionStateMachine.test.ts`
- **useSessionManagement.test.ts** (2 connections) — `client/src/hooks/__tests__/useSessionManagement.test.ts`
- **hooks/useConnectionStateMachine.test.ts** (2 connections) — `client/src/hooks/useConnectionStateMachine.test.ts`
...
- **SessionManagementOptions** (1 connections) — `client/src/hooks/useSessionManagement.ts`
- **SessionManagementResult** (1 connections) — `client/src/hooks/useSessionManagement.ts`
