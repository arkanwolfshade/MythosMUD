...
- **useAuthSessionRestore.ts** (14 connections) — `client/src/mythosApp/useAuthSessionRestore.ts`
...
- **useAuthSessionRestore()** (5 connections) — `client/src/mythosApp/useAuthSessionRestore.ts`
...
- [useMythosAppActions.ts](useMythosAppActions.ts.md) (33 shared connections)
- [CharacterNameScreen.tsx](CharacterNameScreen.tsx.md) (11 shared connections)
- [security.ts](security.ts.md) (10 shared connections)
- [submitAuth.ts](submitAuth.ts.md) (5 shared connections)
...
- [HeaderBar.tsx](HeaderBar.tsx.md) (2 shared connections)
...
- [apiTypeGuards.ts](apiTypeGuards.ts.md) (1 shared connections)
