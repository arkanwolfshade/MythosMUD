...
- **useRespawnHandlers.ts** (28 connections) — `client/src/components/ui-v2/hooks/useRespawnHandlers.ts`
...
- **RespawnApiResponse** (2 connections) — `client/src/utils/apiTypeGuards.ts`
...
- **applyDeathRespawnSuccess()** (2 connections) — `client/src/components/ui-v2/hooks/useRespawnHandlers.ts`
- **applyDeliriumRespawnSuccess()** (2 connections) — `client/src/components/ui-v2/hooks/useRespawnHandlers.ts`
- *... and 7 more nodes in this community*

## Relationships

- [ui-v2/types.ts](ui-v2-types.ts.md) (24 shared connections)
