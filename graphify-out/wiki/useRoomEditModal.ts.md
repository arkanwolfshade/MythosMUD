...
- **RoomEditModalForm.tsx** (10 connections) — `client/src/components/map/RoomEditModalForm.tsx`
...
- **validateDescription()** (1 connections) — `client/src/components/map/useRoomEditModal.ts`
- **validateName()** (1 connections) — `client/src/components/map/useRoomEditModal.ts`
...
- [RoomMapEditorRuntime.hooks.ts](RoomMapEditorRuntime.hooks.ts.md) (2 shared connections)
