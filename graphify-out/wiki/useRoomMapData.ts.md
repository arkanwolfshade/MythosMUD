...
- **RoomDetailsPanelProps** (3 connections) — `client/src/components/map/RoomDetailsPanel.tsx`
...
- **UseRoomMapDataResult** (2 connections) — `client/src/components/map/hooks/useRoomMapData.ts`
...
- **RoomAdminActions()** (1 connections) — `client/src/components/map/RoomDetailsPanel.tsx`
- **RoomExitsList()** (1 connections) — `client/src/components/map/RoomDetailsPanel.tsx`
- **RoomLocationFields()** (1 connections) — `client/src/components/map/RoomDetailsPanel.tsx`
...
- [mapUtils.ts](mapUtils.ts.md) (18 shared connections)
- [RoomMapEditorRuntime.hooks.ts](RoomMapEditorRuntime.hooks.ts.md) (6 shared connections)
