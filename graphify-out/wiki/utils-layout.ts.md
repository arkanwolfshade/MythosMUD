...
- **utils/layout.ts** (48 connections) — `client/src/components/map/utils/layout.ts`
- **applyForceLayout()** (8 connections) — `client/src/components/map/utils/layout.ts`
- **applyForceLayout.test.ts** (8 connections) — `client/src/components/map/utils/__tests__/applyForceLayout.test.ts`
- **calculateGridPosition.test.ts** (8 connections) — `client/src/components/map/utils/__tests__/calculateGridPosition.test.ts`
...
- [mapUtils.ts](mapUtils.ts.md) (20 shared connections)
