...
- **repelEdgeFromBlockingNode()** (3 connections) — `client/src/components/map/utils/layout.ts`
...
- **buildSimulationEdgeList()** (2 connections) — `client/src/components/map/utils/layout.ts`
- **edgeEndpointsSegment()** (2 connections) — `client/src/components/map/utils/layout.ts`
