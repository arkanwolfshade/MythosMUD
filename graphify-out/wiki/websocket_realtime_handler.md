...
- **IntersectionNodeProps** (1 connections) — `client/src/components/map/nodes/IntersectionNode.tsx`

## Relationships

- [map useMapEditing saveMapChanges](map_useMapEditing_saveMapChanges.md) (18 shared connections)
