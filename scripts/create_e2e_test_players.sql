...
SELECT gen_random_uuid(),
    u.id,
    'ArkanWolfshade',
    '{"health": 100, "lucidity": 100, "strength": 12, "dexterity": 14, "constitution": 50, "intelligence": 16, "wisdom": 8, "charisma": 10, "occult_knowledge": 0, "fear": 0, "corruption": 0, "cult_affiliation": 0, "current_dp": 100, "max_health": 100, "max_lucidity": 100}'::jsonb,
    '[]'::jsonb,
    '[]'::jsonb,
...
SELECT gen_random_uuid(),
    u.id,
    'Ithaqua',
    '{"health": 100, "lucidity": 100, "strength": 50, "dexterity": 12, "constitution": 14, "intelligence": 50, "wisdom": 16, "charisma": 8, "occult_knowledge": 0, "fear": 0, "corruption": 0, "cult_affiliation": 0, "current_dp": 100, "max_health": 100, "max_lucidity": 100}'::jsonb,
    '[]'::jsonb,
    '[]'::jsonb,
    'earth_arkhamcity_sanitarium_room_foyer_001',
    0,
