...
result = subprocess.run(
    [
        ...
        "--length",
        "55",
        # lizard --exclude takes glob patterns matched against the whole path, not bare
        # directory names: "graphify-out" never matched "server/graphify-out/.venv/...", so the
        # vendored virtualenv was being analysed and lizard reported numpy's complexity as ours.
        "--exclude",
        "*/tests/*",
        "--exclude",
        "*/scripts/*",
