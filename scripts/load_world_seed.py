        ...
        try:
            ...
            for i, statement in enumerate(statements, 1):
                ...
                try:
                    ...
                    if "duplicate key" in error_msg or "already exists" in error_msg or "violates unique constraint" in error_msg:
                        skipped_count += 1
                    else:
                        error_count += 1
            ...
            if error_count == 0:
                ...
                print(f"  [WARNING] Completed with {error_count} errors ({inserted_count} inserted, {skipped_count} skipped)")
        except Exception as e:
            print(f"  [ERROR] - {e}")
            import traceback
            traceback.print_exc()
