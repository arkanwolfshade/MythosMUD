...
def handle_open_container_exceptions(
    ...
    context = create_error_context(request, current_user, container_id=str(container_id), operation="open_container")
...
def handle_transfer_items_exceptions(
    ...
    context = create_error_context(request, current_user, container_id=str(container_id), operation="transfer_items")
...
def handle_close_container_exceptions(
    ...
    context = create_error_context(request, current_user, container_id=str(container_id), operation="close_container")
