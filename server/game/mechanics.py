...
class GameMechanicsService:
    ...
    def apply_sanity_loss(self, player_id: str, amount: int, source: str = "unknown") -> tuple[bool, str]:
        ...
        logger.info("Sanity loss applied", player_id=player_id, player_name=player.name, amount=amount, source=source)
    ...
    def apply_fear(self, player_id: str, amount: int, source: str = "unknown") -> tuple[bool, str]:
        ...
        logger.info("Fear applied", player_id=player_id, player_name=player.name, amount=amount, source=source)
    ...
    def apply_corruption(self, player_id: str, amount: int, source: str = "unknown") -> tuple[bool, str]:
        ...
        logger.info("Corruption applied", player_id=player_id, player_name=player.name, amount=amount, source=source)
    ...
    def gain_occult_knowledge(self, player_id: str, amount: int, source: str = "unknown") -> tuple[bool, str]:
        ...
        logger.info(
            "Occult knowledge gained", player_id=player_id, player_name=player.name, amount=amount, source=source
        )
    ...
    def heal_player(self, player_id: str, amount: int) -> tuple[bool, str]:
        ...
        logger.info("Player healed", player_id=player_id, player_name=player.name, amount=amount)
    ...
    def damage_player(self, player_id: str, amount: int, damage_type: str = "physical") -> tuple[bool, str]:
        ...
        logger.info(
            "Player damaged", player_id=player_id, player_name=player.name, amount=amount, damage_type=damage_type
        )
