...
class MetricsSummaryResponse(BaseModel):
    ...
    summary: dict[str, Any] = Field(..., description="High-level health indicators and summary metrics")
...
class DLQMessagesResponse(BaseModel):
    ...
    messages: list[dict[str, Any]] = Field(default_factory=list, description="List of DLQ messages")
...
class DLQReplayResponse(BaseModel):
    ...
    details: dict[str, Any] | None = Field(default=None, description="Additional replay details")
