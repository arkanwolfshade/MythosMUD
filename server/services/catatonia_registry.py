...
class CatatoniaRegistry(CatatoniaObserverProtocol):
    ...
    def on_sanitarium_failover(self, *, player_id: uuid.UUID | str, current_lcd: int) -> None:
        ...
        except Exception as exc:  # noqa: B904  # pragma: no cover - defensive logging  # pylint: disable=broad-exception-caught  # noqa: B904  # Reason: Failover callback errors unpredictable, must handle gracefully
            # Structlog handles UUID objects automatically, no need to convert to string
