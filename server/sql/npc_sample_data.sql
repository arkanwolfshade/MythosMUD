...
VALUES (
        ...
        'shopkeeper',
        'merchant',
        'earth_arkham_city_merchant_room_peabody_ave_001',
        1,
        1,
        1.0,
    ...
    (
        ...
        'shopkeeper',
        'downtown',
        'earth_arkham_city_downtown_room_derby_st_001',
        0,
        1,
        0.8,
...
VALUES (
        ...
        'quest_giver',
        'campus',
        'earth_arkham_city_campus_room_boundary_st_001',
        1,
        1,
        1.0,
    ...
    (
        ...
        'quest_giver',
        'sanitarium',
        'earth_arkham_city_sanitarium_room_doctors_office_001',
        0,
        1,
        0.9,
...
VALUES (
        ...
        'passive_mob',
        'downtown',
        'earth_arkham_city_downtown_room_derby_st_002',
        0,
        2,
        0.6,
    ...
    (
        ...
        'passive_mob',
        'sanitarium',
        'earth_arkham_city_sanitarium_room_foyer_001',
        0,
        3,
        0.7,
    ...
    (
        ...
        'passive_mob',
        'northside',
        'earth_arkham_city_northside_room_high_ln_001',
        0,
        1,
        0.5,
...
VALUES (
        ...
        'aggressive_mob',
        'downtown',
        'earth_arkham_city_downtown_room_derby_st_003',
        0,
        2,
        0.3,
    ...
    (
        ...
        'aggressive_mob',
        'northside',
        'earth_arkham_city_northside_room_high_ln_002',
        0,
        1,
        0.2,
