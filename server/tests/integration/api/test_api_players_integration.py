...
class TestPlayerAPIIntegration:
    ...
    - Uses shared fixtures from conftest.py (container_test_client_class)
    ...
    def test_list_players_success(self, container_test_client_class, mock_persistence_for_api):
    ...
    def test_get_player_success(self, container_test_client_class, mock_persistence_for_api, sample_player_data):
    ...
    def test_delete_player_success(self, container_test_client_class, mock_persistence_for_api, sample_player_data):
        ...
        # Act
        response = container_test_client_class.delete(f"/api/players/{player_id}")
    ...
    def test_validate_stats_success(self, container_test_client_class):
        """Test successful stats validation via API."""
        # Act
        response = container_test_client_class.post("/api/players/validate-stats")

        # Assert
        assert response.status_code in [422, 401]  # 422=validation error, 401=auth required

    def test_get_available_classes_success(self, container_test_client_class):
        """Test successful class listing via API."""
        # Act
        response = container_test_client_class.get("/api/players/available-classes")

        # Assert
        assert response.status_code in [200, 401]

    def test_get_class_description_success(self, container_test_client_class):
        """Test successful class description retrieval via API."""
        # Act
        response = container_test_client_class.get("/api/players/class-description/investigator")

        # Assert
        assert response.status_code == 404  # Endpoint doesn't exist

    def test_create_character_with_stats_success(self, container_test_client_class):
        """Test successful character creation with stats via API."""
        # Act
        response = container_test_client_class.post("/api/players/create-character-with-stats")
    ...
    def test_room_endpoint_dependency_injection(self, container_test_client_class, mock_persistence_for_api):
        ...
        # Act
        response = container_test_client_class.get("/rooms/test_room")
