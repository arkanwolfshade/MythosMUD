...
class MockPlayer:
    def __init__(self, name, current_room_id="earth_arkham_city_northside_Derby_High"):
        self.name = name
...
class MockPlayerManager:
    def __init__(self):
        self.players = {"cmduser": MockPlayer("cmduser", "earth_arkham_city_northside_Derby_High")}
    ...
    def create_player(self, name, starting_room_id="earth_arkham_city_northside_Derby_High"):
