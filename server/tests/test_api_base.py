...
class TestAPIRouter:
    ...
    def test_api_router_is_router_instance(self):
        """Test that api_router is an instance of APIRouter."""
        assert isinstance(api_router, APIRouter)

    def test_api_router_has_no_routes_by_default(self):
...
class TestCurrentUserDependency:
    ...
    def test_current_user_dependency_creation(self):
        """Test that CurrentUser is created as a dependency."""
        assert hasattr(CurrentUser, "dependency")
        assert CurrentUser.dependency == get_current_user

    def test_current_user_dependency_function(self):
        """Test that CurrentUser points to the correct function."""
        assert CurrentUser.dependency == get_current_user

    def test_current_user_is_dependency_instance(self):
...
class TestAPIIntegration:
    ...
    def test_api_router_can_be_used_in_app(self):
    ...
    def test_api_router_prefix_integration(self):
    ...
    def test_current_user_dependency_integration(self):
        ...
        @app.get("/test")
        async def test_route(user=CurrentUser):
            return {"message": "test"}
    ...
    def test_current_user_dependency_structure(self):
