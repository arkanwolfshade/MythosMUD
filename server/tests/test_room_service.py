...
class TestRoomService:
    ...
    def test_get_room_success(self):
        ...
        self.mock_persistence.get_room.return_value = mock_room_data

        # Test room retrieval
        result = self.room_service.get_room("test_room_001")

        assert result == mock_room_data
        self.mock_persistence.get_room.assert_called_once_with("test_room_001")
    ...
    def test_get_adjacent_rooms_success(self):
        ...
        result = self.room_service.get_adjacent_rooms("test_room_001")
    ...
    def test_get_adjacent_rooms_missing_adjacent(self):
    ...
    def test_get_local_chat_scope_success(self):
        ...
        result = self.room_service.get_local_chat_scope("test_room_001")
    ...
    def test_get_local_chat_scope_no_adjacent(self):
        ...
        # Mock the persistence layer
        self.mock_persistence.get_room.return_value = source_room_data
