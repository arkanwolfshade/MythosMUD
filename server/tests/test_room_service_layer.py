...
class TestRoomServiceLayer:
    ...
    def test_get_room_success(self):
        ...
        # Get room
        result = self.room_service.get_room("test_room_1")
        ...
        self.mock_persistence.get_room.assert_called_once_with("test_room_1")

    def test_get_room_with_dict_response(self):
        ...
        self.mock_persistence.get_room.return_value = mock_room_dict
    ...
    def test_get_room_not_found(self):
        ...
        result = self.room_service.get_room("nonexistent_room")

        # Verify result
        assert result is None
        self.mock_persistence.get_room.assert_called_once_with("nonexistent_room")
    ...
    def test_get_adjacent_rooms_success(self):
        ...
        self.mock_persistence.get_room.side_effect = mock_get_room

        # Get adjacent rooms
        result = self.room_service.get_adjacent_rooms("test_room_1")
        ...
        # Verify persistence calls
        assert self.mock_persistence.get_room.call_count == 4  # source + 3 adjacent

    def test_get_adjacent_rooms_source_not_found(self):
        """Test adjacent rooms retrieval when source room doesn't exist."""
        self.mock_persistence.get_room.return_value = None

        # Get adjacent rooms for non-existent room
        result = self.room_service.get_adjacent_rooms("nonexistent_room")
    ...
    def test_get_adjacent_rooms_missing_adjacent_room(self):
        ...
        # Verify persistence calls
        assert self.mock_persistence.get_room.call_count == 3  # source + 2 adjacent

    def test_get_local_chat_scope_success(self):
        ...
        result = self.room_service.get_local_chat_scope("test_room_1")
        ...
        # Verify persistence calls
        assert self.mock_persistence.get_room.call_count == 4  # source + source (for adjacent) + 2 adjacent

    def test_get_local_chat_scope_source_not_found(self):
        """Test local chat scope retrieval when source room doesn't exist."""
        self.mock_persistence.get_room.return_value = None

        # Get local chat scope for non-existent room
        result = self.room_service.get_local_chat_scope("nonexistent_room")
    ...
    def test_get_local_chat_scope_no_exits(self):
        ...
        self.mock_persistence.get_room.return_value = mock_source_room
        ...
        # Verify persistence calls
        assert self.mock_persistence.get_room.call_count == 2  # source + source (for adjacent)

    def test_get_local_chat_scope_with_none_exits(self):
        ...
        # Verify persistence calls
        assert self.mock_persistence.get_room.call_count == 4  # source + source (for adjacent) + 2 valid adjacent

    def test_validate_room_exists_success(self):
        ...
        result = self.room_service.validate_room_exists("test_room")

        # Verify result
        assert result is True
        self.mock_persistence.get_room.assert_called_once_with("test_room")

    def test_validate_room_exists_not_found(self):
        """Test room existence validation when room doesn't exist."""
        self.mock_persistence.get_room.return_value = None

        # Validate room exists
        result = self.room_service.validate_room_exists("nonexistent_room")

        # Verify result
        assert result is False
        self.mock_persistence.get_room.assert_called_once_with("nonexistent_room")

    def test_validate_exit_exists_success(self):
        ...
        result = self.room_service.validate_exit_exists("test_room_1", "test_room_2")

        # Verify result
        assert result is True
        self.mock_persistence.get_room.assert_called_once_with("test_room_1")

    def test_validate_exit_exists_no_exit(self):
        ...
        # Validate exit exists
        result = self.room_service.validate_exit_exists("test_room_1", "test_room_4")

        # Verify result
        assert result is False
        self.mock_persistence.get_room.assert_called_once_with("test_room_1")

    def test_validate_exit_exists_room_not_found(self):
        """Test exit validation when source room doesn't exist."""
        self.mock_persistence.get_room.return_value = None

        # Validate exit exists
        result = self.room_service.validate_exit_exists("nonexistent_room", "test_room_2")

        # Verify result
        assert result is False
        self.mock_persistence.get_room.assert_called_once_with("nonexistent_room")

    def test_get_room_occupants_success(self):
        ...
        # Get room occupants
        result = self.room_service.get_room_occupants("test_room")
    ...
    def test_get_room_occupants_dict_response(self):
    ...
    def test_get_room_occupants_room_not_found(self):
        """Test room occupants retrieval when room doesn't exist."""
        self.mock_persistence.get_room.return_value = None

        # Get room occupants
        result = self.room_service.get_room_occupants("nonexistent_room")

        # Verify result
        assert result == []
        self.mock_persistence.get_room.assert_called_once_with("nonexistent_room")

    def test_validate_player_in_room_success(self):
        ...
        result = self.room_service.validate_player_in_room("player1", "test_room")
    ...
    def test_validate_player_in_room_dict_response(self):
    ...
    def test_validate_player_in_room_not_found(self):
        """Test player room validation when room doesn't exist."""
        self.mock_persistence.get_room.return_value = None

        # Validate player in room
        result = self.room_service.validate_player_in_room("player1", "nonexistent_room")

        # Verify result
        assert result is False
        self.mock_persistence.get_room.assert_called_once_with("nonexistent_room")

    def test_get_room_exits_success(self):
        ...
        # Get room exits
        result = self.room_service.get_room_exits("test_room")

        # Verify result
        assert result == {"north": "test_room_2", "south": "test_room_3"}
        self.mock_persistence.get_room.assert_called_once_with("test_room")

    def test_get_room_exits_room_not_found(self):
        """Test room exits retrieval when room doesn't exist."""
        self.mock_persistence.get_room.return_value = None

        # Get room exits
        result = self.room_service.get_room_exits("nonexistent_room")
    ...
    def test_get_room_info_success(self):
        ...
        result = self.room_service.get_room_info("test_room")
    ...
    def test_get_room_info_room_not_found(self):
        """Test comprehensive room info retrieval when room doesn't exist."""
        self.mock_persistence.get_room.return_value = None

        # Get comprehensive room info
        result = self.room_service.get_room_info("nonexistent_room")
