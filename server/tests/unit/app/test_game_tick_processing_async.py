...
@pytest.mark.asyncio
async def test_process_damage_over_time_effect_no_damage(mock_app, mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_process_damage_over_time_effect_no_remaining(mock_app, mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_process_damage_over_time_effect_success(mock_app, mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_process_heal_over_time_effect_no_healing(mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_process_heal_over_time_effect_no_remaining(mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_process_heal_over_time_effect_success(mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_process_single_effect_damage_over_time(mock_app, mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_process_single_effect_heal_over_time(mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_process_single_effect_expired(mock_app, mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_update_player_status_effects_no_changes(mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_update_player_status_effects_changes(mock_container, mock_player):
...
@pytest.mark.asyncio
async def test_process_status_effects_no_container(mock_app):
...
@pytest.mark.asyncio
async def test_process_status_effects_no_online_players(mock_app, mock_container):
...
@pytest.mark.asyncio
async def test_process_combat_tick_no_service(mock_app):
...
@pytest.mark.asyncio
async def test_process_combat_tick_success(mock_app):
