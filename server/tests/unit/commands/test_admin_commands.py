...
class TestAdminPermissionValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_admin_permission_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_validate_admin_permission_failure(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_validate_admin_permission_no_player(self) -> None:
...
class TestOnlinePlayerLookup:
    ...
    @pytest.mark.asyncio
    async def test_get_online_player_by_display_name_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_online_player_by_display_name_not_found(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_online_player_by_display_name_case_insensitive(self) -> None:
...
class TestAdminTimeCommand:
    ...
    async def test_handle_admin_time_command(self, monkeypatch):
        ...
        class FakeChronicle:
            ...
            def get_calendar_components(self, _mythos_dt=None):
        ...
        monkeypatch.setattr(admin_commands, "get_mythos_chronicle", FakeChronicle)
...
class TestTeleportEffectMessages:
    ...
    def test_create_teleport_effect_message_arrival(self) -> None:
    ...
    def test_create_teleport_effect_message_departure(self) -> None:
    ...
    def test_create_teleport_effect_message_invalid_type(self) -> None:
...
class TestTeleportCommand:
    ...
    @pytest.mark.asyncio
    async def test_handle_teleport_command_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_teleport_command_not_admin(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_teleport_command_player_not_found(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_teleport_command_missing_target(self) -> None:
...
class TestGotoCommand:
    ...
    @pytest.mark.asyncio
    async def test_handle_goto_command_not_admin(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_goto_command_player_not_found(self) -> None:
...
class TestTeleportConfirmation:
    ...
    @pytest.mark.asyncio
    async def test_confirm_teleport_command_not_admin(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_confirm_teleport_command_player_not_found(self) -> None:
...
class TestTeleportLogging:
    ...
    @pytest.mark.asyncio
    async def test_teleport_action_logged(self) -> None:
...
class TestTeleportVisualEffects:
    ...
    @pytest.mark.asyncio
    async def test_teleport_visual_effects_broadcast(self) -> None:
