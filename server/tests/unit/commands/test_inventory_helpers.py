...
from server.commands.inventory_display_helpers import format_metadata
...
def test_match_room_drop_by_name_empty_search():
    ...
    result = match_room_drop_by_name([{"item_name": "sword"}], "")
    assert result is None
...
def test_match_room_drop_by_name_exact_match():
    ...
    result = match_room_drop_by_name(drops, "sword")
    assert result == 0
...
def test_match_room_drop_by_name_prefix_match():
    ...
    drops = [{"item_name": "sword"}, {"item_name": "shield"}]
    result = match_room_drop_by_name(drops, "sw")
    assert result == 0
...
def test_match_room_drop_by_name_substring_match():
    ...
    drops = [{"item_name": "sword"}, {"item_name": "shield"}]
    result = match_room_drop_by_name(drops, "ord")
    assert result == 0
...
def test_match_room_drop_by_name_item_id_match():
    ...
    result = match_room_drop_by_name(drops, "item_123")
    assert result == 0
...
def test_match_room_drop_by_name_prototype_id_match():
    ...
    result = match_room_drop_by_name(drops, "proto_456")
    assert result == 0
...
def test_match_room_drop_by_name_no_match():
    ...
    result = match_room_drop_by_name(drops, "nonexistent")
    assert result is None
...
def test_match_inventory_item_by_name_prefix_match():
    ...
    inventory = [{"item_name": "potion"}, {"item_name": "scroll"}]
    result = match_inventory_item_by_name(inventory, "pot")
    assert result == 0


def test_match_inventory_item_by_name_substring_match():
    """Test match_inventory_item_by_name with substring match."""
    inventory = [{"item_name": "potion"}, {"item_name": "scroll"}]
    result = match_inventory_item_by_name(inventory, "tion")
    assert result == 0
...
def test_match_inventory_item_by_name_no_match():
    ...
    result = match_inventory_item_by_name(inventory, "nonexistent")
    assert result is None
...
def test_match_equipped_item_by_name_prefix_match():
    ...
    result = match_equipped_item_by_name(equipped, "sw")
    assert result == "main_hand"
...
def test_match_equipped_item_by_name_substring_match():
    ...
    equipped = {"main_hand": {"item_name": "sword"}}
    result = match_equipped_item_by_name(equipped, "ord")
    assert result == "main_hand"
...
def test_match_equipped_item_by_name_item_id_match():
    ...
    result = match_equipped_item_by_name(equipped, "item_123")
    assert result == "main_hand"
...
def test_match_equipped_item_by_name_no_match():
    ...
    equipped = {"main_hand": {"item_name": "sword"}}
    result = match_equipped_item_by_name(equipped, "nonexistent")
    assert result is None
...
def test_match_equipped_item_by_name_empty_search():
    ...
    equipped = {"main_hand": {"item_name": "sword"}}
    result = match_equipped_item_by_name(equipped, "")
    assert result is None


def test_format_metadata_none():
    """Test _format_metadata with None."""
    result = format_metadata(None)
    assert result == ""


def test_format_metadata_empty():
    """Test format_metadata with empty dict."""
    result = format_metadata({})
    assert result == ""


def test_format_metadata_simple():
    """Test format_metadata with simple metadata."""
    metadata = {"key": "value"}
...
def test_format_metadata_complex():
    """Test format_metadata with complex metadata."""
