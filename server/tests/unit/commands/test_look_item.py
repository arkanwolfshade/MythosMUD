...
class TestFindItemInRoomDrops:
    ...
    def test_find_item_in_room_drops_by_name(self):
    ...
    def test_find_item_in_room_drops_by_prototype_id(self):
    ...
    def test_find_item_in_room_drops_by_item_id(self):
    ...
    def test_find_item_in_room_drops_none_values(self):
...
class TestFindItemInInventory:
    ...
    def test_find_item_in_inventory_multiple_matches(self):
        """Test when multiple items match (returns None for ambiguity)."""
        inventory = [
            {"item_name": "sword", "item_id": "item-1"},
            {"item_name": "sword", "item_id": "item-2"},
...
class TestFindItemInEquipped:
    ...
    def test_find_item_in_equipped_by_name(self):
    ...
    def test_find_item_in_equipped_by_prototype_id(self):
    ...
    def test_find_item_in_equipped_not_found(self):
        """Test when equipped item is not found."""
        equipped = {"hand": {"item_name": "sword", "item_id": "item-1"}}
        result = _find_item_in_equipped(equipped, "axe")
        assert result is None

    def test_find_item_in_equipped_with_instance_number(self):
    ...
    def test_find_item_in_equipped_multiple_matches(self):
...
class TestGetItemDescriptionFromPrototype:
    ...
    def test_get_item_description_from_prototype_success(self):
    ...
    def test_get_item_description_from_prototype_no_registry(self):
        """Test when prototype registry is None."""
        item_found = {"item_name": "sword", "prototype_id": "proto-123"}
        result = _get_item_description_from_prototype(item_found, None)
        assert result is None

    def test_get_item_description_from_prototype_no_prototype_id(self):
    ...
    def test_get_item_description_from_prototype_prototype_not_found(self):
    ...
    def test_get_item_description_from_prototype_uses_fallback_name(self):
    ...
    def test_get_item_description_from_prototype_attribute_error(self):
    ...
    def test_get_item_description_from_prototype_uses_item_id_as_prototype_id(self):
...
class TestCheckItemInLocation:
    ...
    def test_check_item_in_location_with_description(self):
    ...
    def test_check_item_in_location_with_location_name(self):
    ...
    def test_check_item_in_location_no_item(self):
        """Test when item is None."""
        result = _check_item_in_location(None, MagicMock())
        assert result is None

    def test_check_item_in_location_no_prototype_fallback(self):
    ...
    def test_check_item_in_location_no_prototype_with_location(self):
    ...
    def test_check_item_in_location_no_name_fallback(self):
    ...
    def test_check_item_in_location_empty_dict(self):
...
class TestCheckEquippedItem:
    ...
    def test_check_equipped_item_found(self):
    ...
    def test_check_equipped_item_not_found(self):
        """Test when equipped item is not found."""
        mock_player = MagicMock()
    ...
    def test_check_equipped_item_no_get_equipped_items_method(self):
...
class TestHandleItemLook:
    ...
    @pytest.mark.asyncio
    async def test_handle_item_look_in_room_drops(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_item_look_in_inventory(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_item_look_in_equipped(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_item_look_not_found(self):
        """Test when item is not found."""
        room_drops = []
        mock_player = MagicMock()
        mock_player.get_inventory.return_value = []
    ...
    @pytest.mark.asyncio
    async def test_handle_item_look_skips_equipped_when_look_in(self):
...
class TestTryLookupItemImplicit:
    ...
    @pytest.mark.asyncio
    async def test_try_lookup_item_implicit_in_room_drops(self):
    ...
    @pytest.mark.asyncio
    async def test_try_lookup_item_implicit_in_inventory(self):
    ...
    @pytest.mark.asyncio
    async def test_try_lookup_item_implicit_in_equipped(self):
    ...
    @pytest.mark.asyncio
    async def test_try_lookup_item_implicit_not_found(self):
