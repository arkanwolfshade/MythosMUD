...
class TestFeatureFlagSystem:
    ...
    def test_combat_configuration_validation(self):
        ...
        config = GameConfig(
            aliases_dir="data/aliases", combat_tick_interval=5, combat_timeout_seconds=120, combat_xp_multiplier=2.0
        )
    ...
    def test_combat_configuration_invalid_timeout(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            GameConfig(aliases_dir="data/aliases", combat_timeout_seconds=30)
    ...
    def test_combat_configuration_invalid_xp_multiplier(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            GameConfig(aliases_dir="data/aliases", combat_xp_multiplier=0.5)
