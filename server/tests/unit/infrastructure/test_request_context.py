...
class TestWebSocketRequestContext:
    ...
    def test_initialization_with_app_state(self):
    ...
    def test_set_alias_storage(self):
    ...
    def test_set_app_state_services(self):
    ...
    def test_set_app_state_services_with_none(self):
    ...
    def test_get_alias_storage(self):
    ...
    def test_get_alias_storage_not_set(self):
