...
@pytest.mark.asyncio
async def test_containers_table_exists(async_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_containers_table_schema(async_session: AsyncSession):
    ...
    columns = {row[0]: {"type": row[1], "nullable": row[2] == "YES", "default": row[3]} for row in result.fetchall()}
...
@pytest.mark.asyncio
async def test_containers_table_indexes(async_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_containers_table_constraints(async_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_containers_table_insert_environment(async_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_containers_table_insert_corpse(async_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_containers_table_insert_equipment(async_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_containers_table_jsonb_items(async_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_containers_table_defaults(async_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_containers_table_constraint_violations(async_session: AsyncSession):
