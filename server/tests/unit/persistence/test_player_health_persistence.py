...
class TestPlayerHealthPersistence:
    ...
    def test_damage_player_method_exists(self):
    ...
    def test_heal_player_method_exists(self):
    ...
    def test_async_damage_player_method_exists(self):
    ...
    def test_async_heal_player_method_exists(self):
    ...
    def test_damage_player_updates_health(self, test_player):
    ...
    def test_heal_player_updates_health(self, test_player):
    ...
    def test_damage_player_handles_negative_values(self, test_player):
    ...
    def test_heal_player_handles_negative_values(self, test_player):
    ...
    def test_damage_player_caps_at_zero(self, test_player):
    ...
    def test_heal_player_caps_at_max_health(self, test_player):
    ...
    @pytest.mark.asyncio
    async def test_async_damage_player_updates_health(self, test_player):
    ...
    @pytest.mark.asyncio
    async def test_async_heal_player_updates_health(self, test_player):
