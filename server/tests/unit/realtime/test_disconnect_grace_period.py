...
@pytest.mark.asyncio
async def test_start_grace_period_creates_task(mock_manager):  # pylint: disable=redefined-outer-name
    """Test start_grace_period() creates and stores a grace period task."""
    player_id = uuid.uuid4()
    mock_player = MagicMock()
    mock_player.current_room_id = "room_123"
    # Accessing protected member is necessary to mock the method used by disconnect_grace_period implementation
    mock_manager._get_player.return_value = mock_player  # pylint: disable=protected-access
...
@pytest.mark.asyncio
async def test_start_grace_period_already_in_grace_period(mock_manager):  # pylint: disable=redefined-outer-name
...
@pytest.mark.asyncio
async def test_start_grace_period_timer_expires(mock_manager):  # pylint: disable=redefined-outer-name
...
@pytest.mark.asyncio
async def test_start_grace_period_reconnection_cancels(mock_manager):  # pylint: disable=redefined-outer-name
...
@pytest.mark.asyncio
async def test_cancel_grace_period_not_in_grace_period(mock_manager):  # pylint: disable=redefined-outer-name
...
@pytest.mark.asyncio
async def test_cancel_grace_period_cancels_task(mock_manager):  # pylint: disable=redefined-outer-name
...
def test_is_player_in_grace_period_true(mock_manager):  # pylint: disable=redefined-outer-name
...
def test_is_player_in_grace_period_false(mock_manager):  # pylint: disable=redefined-outer-name
...
@pytest.mark.asyncio
async def test_grace_period_handles_player_not_found(mock_manager):  # pylint: disable=redefined-outer-name
    """Test grace period handles case where player is not found during cleanup."""
    player_id = uuid.uuid4()
    # Accessing protected member is necessary to mock the method used by disconnect_grace_period implementation
    mock_manager._get_player.return_value = None  # pylint: disable=protected-access  # Player not found
...
@pytest.mark.asyncio
async def test_grace_period_handles_errors_gracefully(mock_manager):  # pylint: disable=redefined-outer-name
    """Test grace period handles errors during cleanup gracefully."""
    player_id = uuid.uuid4()
    mock_player = MagicMock()
    mock_player.current_room_id = "room_123"
    # Accessing protected member is necessary to mock the method used by disconnect_grace_period implementation
    mock_manager._get_player.side_effect = Exception("Database error")  # pylint: disable=protected-access
