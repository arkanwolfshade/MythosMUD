...
def test_is_player_in_grace_period_true(mock_name_extractor, mock_logger):  # pylint: disable=redefined-outer-name  # Reason: Fixture parameter names match fixture function names, pytest standard pattern
...
def test_is_player_in_grace_period_false(mock_name_extractor, mock_logger):  # pylint: disable=redefined-outer-name  # Reason: Fixture parameter names match fixture function names, pytest standard pattern
...
def test_is_player_in_grace_period_no_connection_manager(mock_name_extractor, mock_logger):  # pylint: disable=redefined-outer-name  # Reason: Fixture parameter names match fixture function names, pytest standard pattern
...
def test_is_player_in_grace_period_string_id(mock_name_extractor, mock_logger):  # pylint: disable=redefined-outer-name  # Reason: Fixture parameter names match fixture function names, pytest standard pattern
