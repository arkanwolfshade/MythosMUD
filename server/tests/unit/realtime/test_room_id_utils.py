...
def test_get_canonical_room_id():
...
def test_get_canonical_room_id_no_manager():
...
def test_check_normalized_ids_match_none():
...
def test_check_normalized_room_matches():
...
def test_check_fallback_room_matches():
