...
class TestAliasStorage:
    ...
    def test_get_alias_file_path(self) -> None:
    ...
    def test_load_alias_data_new_file(self) -> None:
    ...
    def test_load_alias_data_existing_file(self) -> None:
    ...
    def test_load_alias_data_invalid_json(self) -> None:
    ...
    def test_save_alias_data_success(self) -> None:
    ...
    def test_save_alias_data_failure(self) -> None:
    ...
    def test_get_player_aliases_invalid_data(self) -> None:
    ...
    def test_save_player_aliases(self) -> None:
    ...
    def test_add_alias_existing(self) -> None:
    ...
    def test_remove_alias_existing(self) -> None:
    ...
    def test_get_alias_nonexistent(self) -> None:
    ...
    def test_get_alias_count(self) -> None:
    ...
    def test_get_alias_count_empty(self) -> None:
    ...
    def test_validate_alias_command_valid(self) -> None:
    ...
    def test_validate_alias_command_invalid(self) -> None:
    ...
    def test_create_alias_valid(self) -> None:
    ...
    def test_list_alias_files_empty(self) -> None:
        """Test listing alias files when directory is empty."""
        files = self.storage.list_alias_files()

        assert files == []

    def test_delete_player_aliases(self) -> None:
    ...
    def test_delete_player_aliases_nonexistent(self) -> None:
    ...
    def test_backup_aliases(self) -> None:
    ...
    def test_backup_aliases_nonexistent_player(self) -> None:
    ...
    def test_load_alias_data_schema_invalid_returns_default(self) -> None:
    ...
    def test_save_alias_data_schema_invalid_aborts_write(self) -> None:
