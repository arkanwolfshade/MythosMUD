...
class TestNormalizeCommand:
    ...
    def test_normalize_command_with_slash_prefix(self) -> None:
    ...
    def test_normalize_command_without_slash(self) -> None:
        """Test that commands without slash are returned with whitespace stripped."""
        assert normalize_command("look") == "look"
        assert normalize_command("go north") == "go north"
        assert normalize_command("  look  ") == "look"

    def test_normalize_command_empty_string(self) -> None:
        """Test that empty string is returned as is."""
        assert normalize_command("") == ""

    def test_normalize_command_none(self) -> None:
        """Test that None is returned as is."""
        assert normalize_command(cast(Any, None)) is None

    def test_normalize_command_with_whitespace(self) -> None:
...
class TestIsSuspiciousInput:
    ...
    def test_is_suspicious_input_shell_injection(self) -> None:
    ...
    def test_is_suspicious_input_safe_creative_text(self) -> None:
    ...
    def test_is_suspicious_input_legitimate_special_chars(self) -> None:
...
class TestCleanCommandInput:
    ...
    def test_clean_command_input_unicode_normalization(self) -> None:
    ...
    def test_clean_command_input_ansi_removal(self) -> None:
    ...
    def test_clean_command_input_whitespace_normalization(self) -> None:
        """Test that whitespace is normalized."""
        assert clean_command_input("look   north") == "look north"
        assert clean_command_input("  look  ") == "look"
        assert clean_command_input("look\t\tnorth") == "look north"

    def test_clean_command_input_control_char_removal(self) -> None:
    ...
    def test_clean_command_input_preserves_valid_text(self) -> None:
...
class TestValidateCommandLength:
    ...
    def test_validate_command_length_within_limits(self) -> None:
    ...
    def test_validate_command_length_at_limit(self) -> None:
        """Test that commands at exact limit pass validation."""
        assert validate_command_length("a" * 1000) is True

    def test_validate_command_length_exceeds_limit(self) -> None:
    ...
    def test_validate_command_length_custom_max_length(self) -> None:
...
class TestCommandValidatorValidateCommandContent:
    ...
    def test_validate_command_content_null_bytes(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_rm_rf(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_command_substitution(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_backtick(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_pipe_shell(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_device_redirect(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_stderr_redirect(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_chained_rm(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_pipe_bash(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_pipe_zsh(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_exec(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_eval(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_import_os(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_dunder_import(self) -> None:
    ...
    def test_validate_command_content_dangerous_pattern_subprocess(self) -> None:
    ...
    def test_validate_command_content_excessive_length(self) -> None:
    ...
    def test_validate_command_content_non_printable_chars(self) -> None:
    ...
    def test_validate_command_content_allows_tabs_and_newlines(self) -> None:
    ...
    def test_validate_command_content_error_message_accuracy(self) -> None:
...
class TestCommandValidatorValidateExpandedCommand:
    ...
    def test_validate_expanded_command_valid(self) -> None:
    ...
    def test_validate_expanded_command_exceeds_max_length(self) -> None:
    ...
    def test_validate_expanded_command_dangerous_pattern(self) -> None:
    ...
    def test_validate_expanded_command_null_bytes(self) -> None:
...
class TestCommandValidatorValidateAliasDefinition:
    ...
    def test_validate_alias_definition_valid(self) -> None:
    ...
    def test_validate_alias_definition_exceeds_max_length(self) -> None:
    ...
    def test_validate_alias_definition_dangerous_pattern(self) -> None:
    ...
    def test_validate_alias_definition_null_bytes(self) -> None:
...
class TestCommandValidatorIsSecuritySensitive:
    ...
    def test_is_security_sensitive_admin_commands(self) -> None:
    ...
    def test_is_security_sensitive_non_admin_commands(self) -> None:
...
class TestCommandValidatorSanitizeForLogging:
    ...
    def test_sanitize_for_logging_secret_masking(self) -> None:
    ...
    def test_sanitize_for_logging_key_masking(self) -> None:
    ...
    def test_sanitize_for_logging_truncation(self) -> None:
    ...
    def test_sanitize_for_logging_control_char_removal(self) -> None:
    ...
    def test_sanitize_for_logging_custom_max_length(self) -> None:
...
class TestCommandValidatorExtractCommandName:
    ...
    def test_extract_command_name_with_args(self) -> None:
    ...
    def test_extract_command_name_with_pipes(self) -> None:
    ...
    def test_extract_command_name_with_semicolons(self) -> None:
    ...
    def test_extract_command_name_mixed_separators(self) -> None:
...
class TestCommandValidatorIsValidCommandName:
    ...
    def test_is_valid_command_name_valid_names(self) -> None:
    ...
    def test_is_valid_command_name_invalid_start_digit(self) -> None:
    ...
    def test_is_valid_command_name_invalid_special_chars(self) -> None:
    ...
    def test_is_valid_command_name_too_long(self) -> None:
    ...
    def test_is_valid_command_name_empty(self) -> None:
        """Test that empty names fail validation."""
        assert CommandValidator.is_valid_command_name("") is False
        assert CommandValidator.is_valid_command_name(cast(Any, None)) is False

    def test_is_valid_command_name_edge_cases(self) -> None:
...
class TestCommandValidatorIntegration:
    ...
    def test_validation_workflow_safe_command(self) -> None:
        ...
        # Validate content
        is_valid, content_error_msg = CommandValidator.validate_command_content(cleaned)
        assert is_valid is True
        assert content_error_msg is None

    def test_validation_workflow_dangerous_command(self) -> None:
    ...
    def test_validation_workflow_with_unicode(self) -> None:
    ...
    def test_security_sensitive_command_workflow(self) -> None:
        """Test workflow for security-sensitive commands."""
        admin_cmd = "admin status"

        # Should pass validation
        is_valid, _ = CommandValidator.validate_command_content(admin_cmd)
        assert is_valid is True
