...
class TestMovementPersistence:
    ...
    async def test_move_player_persists_to_database(self) -> None:
        ...
        mock_persistence.get_room_by_id = Mock(side_effect=lambda room_id: room_1 if room_id == "room_1" else room_2)
    ...
    async def test_move_player_handles_player_not_found_by_id(self) -> None:
        ...
        mock_persistence.get_room_by_id = Mock(side_effect=lambda room_id: room_a if room_id == "room_a" else room_b)
        mock_persistence.save_player = AsyncMock()
